VERSION 5.00
Begin VB.Form F1010361 
   BackColor       =   &H8000000A&
   Caption         =   "íIégópèÛãµï\é¶(ÉeÉXÉgóp)Å@F101036  2010.12.14 16:00"
   ClientHeight    =   9828
   ClientLeft      =   2136
   ClientTop       =   2832
   ClientWidth     =   15240
   ...
   Begin VB.ComboBox CmbSoko_No 
      Height          =   360
      IMEMode         =   3  'µÃå≈íË
      ItemData        =   "F1010361.frx":0000
      Left            =   840
      List            =   "F1010361.frx":0002
      TabIndex        =   0
      Top             =   210
      Width           =   2850
   End
...
Dim com     As Integer
    ...
    Select Case Index
        ...
        Case 0                  'ï€ë∂
            ...
            ans = MsgBox("ê›íËì‡óeÇï€ë∂ÇµÇ‹Ç∑Ç©ÅH", vbYesNo, "ämîFì¸óÕ")
            If ans = vbYes Then
                If Update_Proc() Then
                    Unload Me
                End If
        ...
        Case 6                  '<<óÒ
            ...
            If Upd_Flg Then
                ...
                ans = MsgBox("ïœçXÇµÇΩì‡óeÇÕÅAîjä¸Ç≥ÇπÇ‹Ç∑ÅBóÒÇÃêÿë÷Ç¶ÇçsÇ¢Ç‹Ç∑Ç©ÅH", vbYesNo, "ämîFì¸óÕ")
                If ans = vbNo Then
                    Exit Sub
                End If
        ...
        Case 8                  'ëSégóp
            ...
            ans = MsgBox("óÒì‡ÇÃëSîÕàÕÇégópâ¬î\Ç∆ÇµÇ‹Ç∑Ç©ÅH", vbYesNo, "ämîFì¸óÕ")
            If ans = vbYes Then
        ...
        Case 9                  'óÒçÌèú
            ...
            ans = MsgBox("óÒì‡ÇÃëSîÕàÕÇégópïsâ¬Ç∆ÇµÇ‹Ç∑Ç©ÅH", vbYesNo, "ämîFì¸óÕ")
            If ans = vbYes Then
                For Ren = LBound(Tana_Tbl, 1) To UBound(Tana_Tbl, 1)
                    For Dan = LBound(Tana_Tbl, 2) To UBound(Tana_Tbl, 2)
...
'í[ññî‘çÜéÊÇËçûÇ›
    ...
    End If
                                ...
                                'ëqå…èÓïÒÇÉRÉìÉ{Ç…ÉZÉbÉgÇ∑ÇÈ
    If Soko_Tbl_Set() Then
        Unload Me
    End If

                                'íIçÌèúç›å…ÇÃà⁄ìÆêÊ
    lblIdo_Soko.Caption = "íIçÌèúç›å…ÇÃà⁄ìÆêÊÅF" & StrConv(To_Ido_Soko, vbWide)
...
Dim i As Integer
    ...
    F1010361.MousePointer = vbHourglass

    Call Ctrl_Lock(F1010361)
...
Dim i As Integer
    ...
    Call Ctrl_UnLock(F1010361)


    F1010361.MousePointer = vbDefault
...
'                    Wk_Text = "Åõ"
                    ...
                    If Trim(Tana_Tbl(Now_Ren, Now_Dan).Tana_Use) = "." Then
                        Wk_Text = Trim(Tana_Tbl(Now_Ren, Now_Dan).Tana_Use)
                    Else
                        Wk_Text = Format(Tana_Tbl(Now_Ren, Now_Dan).Tana_Use, "#0")
                    End If
...
'------------------------------------   ëqå…ñºèÃÅï∫∞ƒﬁÇÉRÉìÉ{Ç…ÉZÉbÉgÇ∑ÇÈ
Dim sts As Integer
Dim com As Integer
    ...
    Do
        ...
        Select Case sts
            ...
            Case BtErrEOF
                Exit Do
            Case Else
                Call File_Error(sts, com, "ëqå…É}ÉXÉ^")
                Exit Function
        End Select
...
Dim com     As Integer
    ...
    Select Case sts
        ...
        Case BtErrKeyNotFound
            MsgBox "ëŒè€ëqå…ÇÃì‡óeÇ™ïœçXÇ≥ÇÍÇ‹ÇµÇΩÅB"
            Exit Function
        Case Else
...
'íIÉtÉ@ÉCÉãÇì«Ç›çûÇ›ç≈ëÂílÅ^ç≈èâílÇÃî‰är
    ...
    Do
        ...
        Select Case sts
            ...
            Case BtErrEOF
                Exit Do
            Case Else
                Call File_Error(sts, com, "íIÉ}ÉXÉ^")
                Exit Function
            ...
            Select Case sts
                ...
                Case BtNoErr
                    ...
                    If IsNumeric(StrConv(TANAREC.Tana_Use, vbUnicode)) Then
                        ...
                        Tana_Tbl(Ren, Dan).Tana_Use = StrConv(TANAREC.Tana_Use, vbUnicode)
                    Else
    ...
    lblRetu.Caption = StrConv(SOKOREC.RETU_START, vbUnicode) & "Å`" & StrConv(SOKOREC.RETU_END, vbUnicode)

    lblRen.Caption = StrConv(SOKOREC.REN_START, vbUnicode) & "Å`" & StrConv(SOKOREC.REN_END, vbUnicode)
