...
Begin VB.Form F1011201 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(28)=   "Column(4).DropDownList=1"
      Splits(0)._ColumnProps(29)=   "Column(5).Width=2725"
      Splits(0)._ColumnProps(30)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(31)=   "Column(5)._WidthInPix=2593"
      Splits(0)._ColumnProps(32)=   "Column(5)._ColStyle=516"
      Splits(0)._ColumnProps(33)=   "Column(5).Button=1"
      Splits(0)._ColumnProps(34)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(35)=   "Column(5).DropDownList=1"
      Splits(0)._ColumnProps(36)=   "Column(6).Width=2752"
      Splits(0)._ColumnProps(37)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(38)=   "Column(6)._WidthInPix=2619"
      Splits(0)._ColumnProps(39)=   "Column(6)._ColStyle=516"
      Splits(0)._ColumnProps(40)=   "Column(6).Button=1"
      Splits(0)._ColumnProps(41)=   "Column(6).Order=7"
      Splits(0)._ColumnProps(42)=   "Column(6).DropDownList=1"
      Splits(0)._ColumnProps(43)=   "Column(7).Width=900"
      Splits(0)._ColumnProps(44)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(45)=   "Column(7)._WidthInPix=767"
      Splits(0)._ColumnProps(46)=   "Column(7)._ColStyle=512"
      Splits(0)._ColumnProps(47)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(48)=   "Column(8).Width=5583"
      Splits(0)._ColumnProps(49)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(50)=   "Column(8)._WidthInPix=5450"
      Splits(0)._ColumnProps(51)=   "Column(8)._ColStyle=8704"
      Splits(0)._ColumnProps(52)=   "Column(8).AllowFocus=0"
      Splits(0)._ColumnProps(53)=   "Column(8).Order=9"
      Splits(0)._ColumnProps(54)=   "Column(9).Width=1879"
      Splits(0)._ColumnProps(55)=   "Column(9).DividerColor=0"
      Splits(0)._ColumnProps(56)=   "Column(9)._WidthInPix=1746"
      Splits(0)._ColumnProps(57)=   "Column(9)._ColStyle=516"
      Splits(0)._ColumnProps(58)=   "Column(9).Button=1"
      Splits(0)._ColumnProps(59)=   "Column(9).Order=10"
      Splits(0)._ColumnProps(60)=   "Column(10).Width=1879"
      Splits(0)._ColumnProps(61)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(62)=   "Column(10)._WidthInPix=1746"
      Splits(0)._ColumnProps(63)=   "Column(10)._ColStyle=512"
      ...
      _StyleDefs(85)  =   "Splits(0).Columns(7).Style:id=58,.parent=67,.alignment=0,.locked=0,.bold=0"
...
'Private Const LAST_UPDATE_DAY$ = "[F101120] 2018.04.11 15:15"
Private Const LAST_UPDATE_DAY$ = "[F101120] 2018.11.06 17:15"
...
'    If YOIN.Count(1) > 0 Then          2018.04.09
'        Command1(1).Enabled = True     2018.04.09
'                                       2018.04.09
'    Else                               2018.04.09
'        Command1(1).Enabled = False    2018.04.09
'        Command1(0).SetFocus           2018.04.09
'        Exit Sub                       2018.04.09
'    End If                             2018.04.09
...
Dim wkVariant   As Variant
    ...
    F1011201.Caption = F1011201.Caption & " " & LAST_UPDATE_DAY
    ...
    Else
        ...
        Select Case ColIndex
            ...
            Case colYOIN_CODE
                ...
                YOIN(i, colYOIN_CODE) = StrConv(YOIN(i, colYOIN_CODE), vbUpperCase)         '2018.04.09
                ...
                For j = 1 To YOIN.Count(1)
                
                    If i = j Then
                    Else
                        If Trim(YOIN(i, colYOIN_CODE)) = Trim(YOIN(j, colYOIN_CODE)) Then
                            MsgBox "[" & Format(i, "0") & "]行目 入力した項目はエラーです。(詳細要因　登録済みです)"
                            TDBGrid1.SetFocus
                            Exit Sub
                        End If
                    End If
...
'    Command1(1).Enabled = True     2018.04.07
...
Dim i   As Integer
    ...
    F1011201.MousePointer = vbHourglass

    Call Ctrl_Lock(F1011201)
...
Dim i   As Integer
    ...
    Call Ctrl_UnLock(F1011201)


    F1011201.MousePointer = vbDefault
