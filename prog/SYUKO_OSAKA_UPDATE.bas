Attribute VB_Name = "SYUKO_OSAKA_UPDATE"
Option Explicit


Public Function Syuko_OSAKA_Update_Proc(JGYOBU As String, _
                                    NAIGAI As String, _
                                    HIN_GAI As String, _
            ...
            Case BtErrFILE_INUSE, BtErrRECORD_INUSE
                ...
                If RETRY_SU <> 0 Then
                    ...
                    If RETRY_CNT > RETRY_SU Then
                        ...
                        Syuko_OSAKA_Update_Proc = SYS_CANCEL
                        Exit Function
...
'                    DoEvents
            ...
            Case Else
                ...
                Syuko_OSAKA_Update_Proc = SYS_ERR
                Exit Function
        End Select
    Loop
'============================================================
    ...
    Else
        If SUMI_JITU_QTY = 0 And MI_JITU_QTY = 0 Then
            ...
            If Left(YOIN, 1) = ACT_DENPYO_ID Or _
                ...
                Left(YOIN, 1) = ACT_SYUKA_HYO_OSAKA Or _
...
'        DoEvents
        ...
        Do
            sts = BTRV(com + BtSNoWait, Y_SYU_H_POS, Y_SYU_HREC, Len(Y_SYU_HREC), K6_Y_SYU_H, Len(K6_Y_SYU_H), 6)
            Select Case sts
                Case BtNoErr
                    
                                        
                    If StrConv(Y_SYU_HREC.SYU_NO, vbUnicode) <> ID_NO Then
                        sts = BtErrEOF
                    End If
