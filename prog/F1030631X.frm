...
Begin VB.Form F1030631X 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(0)=   "Columns.Count=40"
      ...
      Splits(0)._ColumnProps(165)=   "Column(37).Width=3810"
      Splits(0)._ColumnProps(166)=   "Column(37).DividerColor=0"
      Splits(0)._ColumnProps(167)=   "Column(37)._WidthInPix=3704"
      Splits(0)._ColumnProps(168)=   "Column(37).Order=38"
      Splits(0)._ColumnProps(169)=   "Column(38).Width=3810"
      Splits(0)._ColumnProps(170)=   "Column(38).DividerColor=0"
      Splits(0)._ColumnProps(171)=   "Column(38)._WidthInPix=3704"
      Splits(0)._ColumnProps(172)=   "Column(38).Order=39"
      Splits(0)._ColumnProps(173)=   "Column(39).Width=3810"
      Splits(0)._ColumnProps(174)=   "Column(39).DividerColor=0"
      Splits(0)._ColumnProps(175)=   "Column(39)._WidthInPix=3704"
      Splits(0)._ColumnProps(176)=   "Column(39).Order=40"
      Splits.Count    =   1
      ...
      _StyleDefs(196) =   "Named:id=29:Normal"
      _StyleDefs(197) =   ":id=29,.parent=0"
      _StyleDefs(198) =   "Named:id=30:Heading"
      _StyleDefs(199) =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(200) =   ":id=30,.wraptext=-1"
      _StyleDefs(201) =   "Named:id=31:Footing"
      _StyleDefs(202) =   ":id=31,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(203) =   "Named:id=32:Selected"
      _StyleDefs(204) =   ":id=32,.parent=29,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(205) =   "Named:id=33:Caption"
      _StyleDefs(206) =   ":id=33,.parent=30,.alignment=2"
      _StyleDefs(207) =   "Named:id=34:HighlightRow"
      _StyleDefs(208) =   ":id=34,.parent=29,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
      _StyleDefs(209) =   "Named:id=35:EvenRow"
      _StyleDefs(210) =   ":id=35,.parent=29,.bgcolor=&HFFFF00&"
      _StyleDefs(211) =   "Named:id=36:OddRow"
      _StyleDefs(212) =   ":id=36,.parent=29"
      _StyleDefs(213) =   "Named:id=89:RecordSelector"
      _StyleDefs(214) =   ":id=89,.parent=30"
      _StyleDefs(215) =   "Named:id=92:FilterBar"
      _StyleDefs(216) =   ":id=92,.parent=29"
   End
...
Private Const Max_Col% = 39                 '最大列数       2011.04.23  -->2014.05.19 37
...
Private Const ColTEI_LABELID% = 38
Private Const ColKONPO_ID% = 39
...
Private Const LAST_UPDATE_DAY$ = "[F103063] 2014.12.15 11:00"
...
'        End
    ...
    For i = 0 To UBound(JGYOBU_T)
        ...
        If JGYOBU_T(i).CODE = Last_JGYOBU Then
            F1030631X.Caption = "出荷問い合わせ(問合せ№)（" + RTrim(JGYOBU_T(i).NAME) + ") " & LAST_UPDATE_DAY
...
Call LOG_OUT(LOG_F, F1030631X.Caption & "START")           '2014.07.22
...
Call LOG_OUT(LOG_F, F1030631X.Caption & "END")           '2014.07.22


    Set F1030631X = Nothing
...
Dim i As Integer
    ...
    Next i
                                    '事業部切り替え
    F1030631X.Caption = "出荷問い合わせ(問合せ№)（" + RTrim(JGYOBU_T(Index).NAME) + ") " & LAST_UPDATE_DAY
...
'----------------------------------------------------------------------------
    ...
    F1030631X.MousePointer = vbHourglass

    Call Ctrl_Lock(F1030631X)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(F1030631X)


    F1030631X.MousePointer = vbDefault
...
'    SYUKA(Row, ColHIN_NO) = Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 12) & " " & Trim(StrConv(ITEMREC.HIN_NAME, vbUnicode))     '2014.10.17
    ...
    Select Case sts
        ...
        Case BtErrKeyNotFound
            ...
            Call UniCode_Conv(Y_SYU_TEI_REC.KONPO_ID, "")
    ...
    SYUKA(Row, ColTEI_LABELID) = StrConv(Y_SYU_TEI_REC.TEI_LABELID, vbUnicode)
    SYUKA(Row, ColKONPO_ID) = StrConv(Y_SYU_TEI_REC.KONPO_ID, vbUnicode)
...
'    End If
    ...
    Select Case sts
        ...
        Case BtErrKeyNotFound
            ...
            Call UniCode_Conv(Y_SYU_TEI_REC.KEN_NO, "")
            Call UniCode_Conv(Y_SYU_TEI_REC.HIN_NO, "")
    ...
    Write #FileNo, "*" & Trim(StrConv(Y_SYU_TEI_REC.KEN_NO, vbUnicode)) & "*",
    Write #FileNo, "*" & Trim(StrConv(Y_SYU_TEI_REC.HIN_NO, vbUnicode)) & "*",
    
    Write #FileNo, "*" & Trim(StrConv(Y_SYU_TEI_REC.TEI_LABELID, vbUnicode)) & "*",
    Write #FileNo, "*" & Trim(StrConv(Y_SYU_TEI_REC.KONPO_ID, vbUnicode)) & "*"
