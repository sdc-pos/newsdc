...
'---------------------------------------------------------
'                                   'データ出力共通定義
'Private Const SYS_INI = "SYS"          '2016.02.15
Private Const SYS_INI = "F105030"       '2016.02.15
...
Call LOG_OUT(LOG_F, "Start=" & Format(Now, "HH:MM:SS"))
...
Call LOG_OUT(LOG_F, "End=" & Format(Now, "HH:MM:SS"))
