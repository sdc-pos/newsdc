VERSION 5.00
Begin VB.Form CONV_ITEM41 
   BackColor       =   &H00C0C0C0&
   Caption         =   "データ抽出処理（CONV_ITEM4 2010.08)"
   ClientHeight    =   7230
   ClientLeft      =   2325
   ClientTop       =   2625
   ClientWidth     =   10095
   ...
   Begin VB.Label Label4 
      Caption         =   "指定日付内で変更が有り過去データと紙／プラが異なる分をログ出力"
      Height          =   375
      Left            =   45
      TabIndex        =   16
      Top             =   300
...
'
'
'                    If Not IsNumeric(StrConv(SAVE_ITEMREC.L_TANA1, vbUnicode)) Then
'                        Skip_F = True
'                    End If
'
'                    If Not IsNumeric(StrConv(SAVE_ITEMREC.L_TANA2, vbUnicode)) Then
'                        Skip_F = True
'                    End If
'
'
'                    If Not IsNumeric(StrConv(SAVE_ITEMREC.L_TANA3, vbUnicode)) Then
'                        Skip_F = True
'                    End If
'
'
