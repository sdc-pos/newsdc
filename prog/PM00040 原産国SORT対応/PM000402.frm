...
Private Const Last_Update_Day$ = "(PM00040 2013.02.20 08:00)"
...
Start_PRoc:
    ...
    Select Case sts
        Case BtNoErr
            ...
            End If
                                            '棚番(1)
            Text1(ptxL_TANA1).Text = Trim(StrConv(ITEMREC.L_TANA1, vbUnicode))
                                            '棚番(2)
            Text1(ptxL_TANA2).Text = Trim(StrConv(ITEMREC.L_TANA2, vbUnicode))
                                            '紙
...
End Sub
Private Function GENSANKOKU_SET_Proc(TORI_GENSAKOKU As String) As Integer
'----------------------------------------------------------------------------
'                   原産国マスタをコンボにセットする。
'----------------------------------------------------------------------------
...
Dim i       As Integer
    ...
    Else
        ...
        Call UniCode_Conv(K0_GENSAN.GENSANKOKU, TORI_GENSAKOKU)
        ...
        Select Case sts
            ...
            Case BtErrKeyNotFound
                ...
                Call UniCode_Conv(GENSANREC.GENSANKOKU, TORI_GENSAKOKU)
