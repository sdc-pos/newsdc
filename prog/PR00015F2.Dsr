VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} PR00015F2 
   ClientHeight    =   9990
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   18120
   ...
   _ExtentX        =   31962
   _ExtentY        =   17621
   SectionData     =   "PR00015F2.dsx":0000
End
Attribute VB_Name = "PR00015F2"
...
Dim YMD         As String * 8
    ...
    Call UniCode_Conv(K0_P_tmpSHURIAGE.KEIJYO_YM, Mid(PR000151.Text1(ptxKEIJYO_YM).Text, 1, 4) & _
                                                    Mid(PR000151.Text1(ptxKEIJYO_YM).Text, 6, 2))
