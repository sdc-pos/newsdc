...
Begin VB.Form F9000911 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(2).Caption=   "伝票№"
      Columns(2).DataField=   ""
      Columns(2)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(3)._VlistStyle=   0
      Columns(3)._MaxComboItems=   5
      Columns(3).Caption=   "収支"
      Columns(3).DataField=   ""
      ...
      Columns(5).Caption=   "品　名"
      Columns(5).DataField=   ""
      Columns(5)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(6)._VlistStyle=   0
      Columns(6)._MaxComboItems=   5
      Columns(6).Caption=   "受入数量"
      Columns(6).DataField=   ""
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "棚番１"
      Columns(7).DataField=   ""
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "棚番２"
      Columns(8).DataField=   ""
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "棚番３"
      Columns(9).DataField=   ""
      Columns(9)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(10)._VlistStyle=   0
      Columns(10)._MaxComboItems=   5
      Columns(10).Caption=   "受入日時"
      Columns(10).DataField=   ""
      Columns(10)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(11)._VlistStyle=   0
      Columns(11)._MaxComboItems=   5
      Columns(11).Caption=   "受入担当者"
...
Private Const ptxKAN_MAISU% = 3         '検品枚数
Private Const ptxDEN_MAISU% = 4         '伝票枚数


Private Const Text_Max% = 4             '画面項目別最大ｲﾝﾃﾞｯｸｽ
...
Private Const ColSYUKA_YMD% = 0         '出荷予定日
Private Const ColID_NO% = 1             'ID№
Private Const ColDEN_NO% = 2            '伝票№
Private Const ColSYUKO_SYUSI& = 3       '出庫収支
Private Const ColHIN_GAI% = 4           '品番（外部）
Private Const ColHIN_NAME% = 5          '品名
Private Const ColYOTEI_QTY% = 6         '出荷予定数

Private Const ColTANABAN1% = 7          '棚番１
Private Const ColTANABAN2% = 8          '棚番２
Private Const ColTANABAN3% = 9          '棚番３


Private Const ColKENPIN_Date% = 10      '検品日
Private Const ColKENPIN_TANTO% = 11     '検品担当者

Private Const ColMUKE_CODE% = 12        '向け先
