...
'----------------------------------------------------------------------------
    ...
    PR000161.MousePointer = vbHourglass

    Call Ctrl_Lock(PR000161)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(PR000161)


    PR000161.MousePointer = vbDefault
...
Dim sts As Integer
    ...
    End If
    Set PR000161 = Nothing
    Set PR000162 = Nothing
    Set PR00016F1 = Nothing
...
Dim i                   As Integer
    ...
    Call UniCode_Conv(K1_P_SHURIAGE.G_SYUSHI, "")                               '収支単位
    Call UniCode_Conv(K1_P_SHURIAGE.TOKUI_CODE, "")                             '得意先
...
Dim i                       As Integer
    ...
    Do
        ...
        If Not SKIP_Flg Then
            ...
            Call UniCode_Conv(K1_P_SHURI_SUM.TOKUI_CODE, "")
            ...
            sts = BTRV(upd_com, P_SHURI_SUM_POS, P_SHURI_SUM_REC, Len(P_SHURI_SUM_REC), K1_P_SHURI_SUM, Len(K1_P_SHURI_SUM), 1)
            Select Case sts
                Case BtNoErr
                Case Else
            ...
            '---    合計レコード集計
            Call UniCode_Conv(K1_P_SHURI_SUM.G_SYUSHI, "zzz")
            Call UniCode_Conv(K1_P_SHURI_SUM.TOKUI_CODE, "")
            ...
            If upd_com = BtOpInsert Then
                ...
                Call UniCode_Conv(P_SHURI_SUM_REC.G_SYUSHI, "zzz")
                Call UniCode_Conv(P_SHURI_SUM_REC.TOKUI_CODE, "")
...
Dim rpt             As New PR00016F1
Dim f               As New PR000162
