...
Dim wkBikou         As String
    ...
    Select Case sts
        Case BtNoErr
        Case BtErrKeyNotFound
            Call UniCode_Conv(P_COMPO_O_REC.CLASS_CODE, "")     '商品化ｸﾗｽ
            Call UniCode_Conv(P_COMPO_O_REC.F_CLASS_CODE, "")   '付加ｸﾗｽ
            Call UniCode_Conv(P_COMPO_O_REC.N_CLASS_CODE, "")   '内職ｸﾗｽ
