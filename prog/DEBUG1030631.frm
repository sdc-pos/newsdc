...
Begin VB.Form DEBUG1030631 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(35).Caption=   "出庫表印刷(Y_SYU)"
      ...
      Columns(40).Caption=   "取り込み(Y_SYU_H)"
      ...
      Columns(41).Caption=   "ラベル発行(Y_SYU_H)"
      ...
      Columns(42).Caption=   "検品日時(Y_SYU_H)"
      ...
      Columns(43).Caption=   "強制完了(Y_SYU_H)"
      ...
      Columns(44).Caption=   "ｷｬﾝｾﾙF(Y_SYU_H)"
      ...
      Columns(45).Caption=   "追加日時(_Y_SYU_H)"
      ...
      Columns(46).Caption=   "更新日時(_Y_SYU_H)"
      ...
      Columns(47).Caption=   "検品日時(Y_SYU_TEI)"
      ...
      Columns(48).Caption=   "梱包日時(_Y_SYU_TEI)"
      ...
      Columns(49).Caption=   "ｷｬﾝｾﾙF(Y_SYU_TEI)"
      ...
      Columns(50).Caption=   "追加日時(Y_SYU_TEI)"
      ...
      Columns(51).Caption=   "更新日時(Y_SYU_TEI)"
      ...
      Splits(0)._ColumnProps(0)=   "Columns.Count=52"
      ...
      Splits(0)._ColumnProps(158)=   "Column(35).Order=36"
      Splits(0)._ColumnProps(159)=   "Column(36).Width=3810"
      Splits(0)._ColumnProps(160)=   "Column(36).DividerColor=0"
      Splits(0)._ColumnProps(161)=   "Column(36)._WidthInPix=3704"
      Splits(0)._ColumnProps(162)=   "Column(36).Order=37"
      Splits(0)._ColumnProps(163)=   "Column(37).Width=3810"
      Splits(0)._ColumnProps(164)=   "Column(37).DividerColor=0"
      Splits(0)._ColumnProps(165)=   "Column(37)._WidthInPix=3704"
      Splits(0)._ColumnProps(166)=   "Column(37).Order=38"
      Splits(0)._ColumnProps(167)=   "Column(38).Width=3810"
      Splits(0)._ColumnProps(168)=   "Column(38).DividerColor=0"
      Splits(0)._ColumnProps(169)=   "Column(38)._WidthInPix=3704"
      Splits(0)._ColumnProps(170)=   "Column(38).Order=39"
      Splits(0)._ColumnProps(171)=   "Column(39).Width=3810"
      Splits(0)._ColumnProps(172)=   "Column(39).DividerColor=0"
      Splits(0)._ColumnProps(173)=   "Column(39)._WidthInPix=3704"
      Splits(0)._ColumnProps(174)=   "Column(39).Order=40"
      Splits(0)._ColumnProps(175)=   "Column(40).Width=3810"
      Splits(0)._ColumnProps(176)=   "Column(40).DividerColor=0"
      Splits(0)._ColumnProps(177)=   "Column(40)._WidthInPix=3704"
      Splits(0)._ColumnProps(178)=   "Column(40).Order=41"
      Splits(0)._ColumnProps(179)=   "Column(41).Width=3810"
      Splits(0)._ColumnProps(180)=   "Column(41).DividerColor=0"
      Splits(0)._ColumnProps(181)=   "Column(41)._WidthInPix=3704"
      Splits(0)._ColumnProps(182)=   "Column(41).Order=42"
      Splits(0)._ColumnProps(183)=   "Column(42).Width=3810"
      Splits(0)._ColumnProps(184)=   "Column(42).DividerColor=0"
      Splits(0)._ColumnProps(185)=   "Column(42)._WidthInPix=3704"
      Splits(0)._ColumnProps(186)=   "Column(42).Order=43"
      Splits(0)._ColumnProps(187)=   "Column(43).Width=3810"
      Splits(0)._ColumnProps(188)=   "Column(43).DividerColor=0"
      Splits(0)._ColumnProps(189)=   "Column(43)._WidthInPix=3704"
      Splits(0)._ColumnProps(190)=   "Column(43).Order=44"
      Splits(0)._ColumnProps(191)=   "Column(44).Width=3810"
      Splits(0)._ColumnProps(192)=   "Column(44).DividerColor=0"
      Splits(0)._ColumnProps(193)=   "Column(44)._WidthInPix=3704"
      Splits(0)._ColumnProps(194)=   "Column(44).Order=45"
      Splits(0)._ColumnProps(195)=   "Column(45).Width=3810"
      Splits(0)._ColumnProps(196)=   "Column(45).DividerColor=0"
      Splits(0)._ColumnProps(197)=   "Column(45)._WidthInPix=3704"
      Splits(0)._ColumnProps(198)=   "Column(45).Order=46"
      Splits(0)._ColumnProps(199)=   "Column(46).Width=3810"
      Splits(0)._ColumnProps(200)=   "Column(46).DividerColor=0"
      Splits(0)._ColumnProps(201)=   "Column(46)._WidthInPix=3704"
      Splits(0)._ColumnProps(202)=   "Column(46).Order=47"
      Splits(0)._ColumnProps(203)=   "Column(47).Width=3810"
      Splits(0)._ColumnProps(204)=   "Column(47).DividerColor=0"
      Splits(0)._ColumnProps(205)=   "Column(47)._WidthInPix=3704"
      Splits(0)._ColumnProps(206)=   "Column(47).Order=48"
      Splits(0)._ColumnProps(207)=   "Column(48).Width=4763"
      Splits(0)._ColumnProps(208)=   "Column(48).DividerColor=0"
      Splits(0)._ColumnProps(209)=   "Column(48)._WidthInPix=4657"
      Splits(0)._ColumnProps(210)=   "Column(48).Order=49"
      Splits(0)._ColumnProps(211)=   "Column(49).Width=3810"
      Splits(0)._ColumnProps(212)=   "Column(49).DividerColor=0"
      Splits(0)._ColumnProps(213)=   "Column(49)._WidthInPix=3704"
      Splits(0)._ColumnProps(214)=   "Column(49).Order=50"
      Splits(0)._ColumnProps(215)=   "Column(50).Width=3810"
      Splits(0)._ColumnProps(216)=   "Column(50).DividerColor=0"
      Splits(0)._ColumnProps(217)=   "Column(50)._WidthInPix=3704"
      Splits(0)._ColumnProps(218)=   "Column(50).Order=51"
      Splits(0)._ColumnProps(219)=   "Column(51).Width=3810"
      Splits(0)._ColumnProps(220)=   "Column(51).DividerColor=0"
      Splits(0)._ColumnProps(221)=   "Column(51)._WidthInPix=3704"
      Splits(0)._ColumnProps(222)=   "Column(51).Order=52"
      Splits.Count    =   1
      ...
      _StyleDefs(188) =   "Splits(0).Columns(38).Style:id=190,.parent=53"
      _StyleDefs(189) =   "Splits(0).Columns(38).HeadingStyle:id=187,.parent=54"
      _StyleDefs(190) =   "Splits(0).Columns(38).FooterStyle:id=188,.parent=55"
      _StyleDefs(191) =   "Splits(0).Columns(38).EditorStyle:id=189,.parent=57"
      _StyleDefs(192) =   "Splits(0).Columns(39).Style:id=194,.parent=53"
      _StyleDefs(193) =   "Splits(0).Columns(39).HeadingStyle:id=191,.parent=54"
      _StyleDefs(194) =   "Splits(0).Columns(39).FooterStyle:id=192,.parent=55"
      _StyleDefs(195) =   "Splits(0).Columns(39).EditorStyle:id=193,.parent=57"
      _StyleDefs(196) =   "Splits(0).Columns(40).Style:id=198,.parent=53"
      _StyleDefs(197) =   "Splits(0).Columns(40).HeadingStyle:id=195,.parent=54"
      _StyleDefs(198) =   "Splits(0).Columns(40).FooterStyle:id=196,.parent=55"
      _StyleDefs(199) =   "Splits(0).Columns(40).EditorStyle:id=197,.parent=57"
      _StyleDefs(200) =   "Splits(0).Columns(41).Style:id=202,.parent=53"
      _StyleDefs(201) =   "Splits(0).Columns(41).HeadingStyle:id=199,.parent=54"
      _StyleDefs(202) =   "Splits(0).Columns(41).FooterStyle:id=200,.parent=55"
      _StyleDefs(203) =   "Splits(0).Columns(41).EditorStyle:id=201,.parent=57"
      _StyleDefs(204) =   "Splits(0).Columns(42).Style:id=206,.parent=53"
      _StyleDefs(205) =   "Splits(0).Columns(42).HeadingStyle:id=203,.parent=54"
      _StyleDefs(206) =   "Splits(0).Columns(42).FooterStyle:id=204,.parent=55"
      _StyleDefs(207) =   "Splits(0).Columns(42).EditorStyle:id=205,.parent=57"
      _StyleDefs(208) =   "Splits(0).Columns(43).Style:id=210,.parent=53"
      _StyleDefs(209) =   "Splits(0).Columns(43).HeadingStyle:id=207,.parent=54"
      _StyleDefs(210) =   "Splits(0).Columns(43).FooterStyle:id=208,.parent=55"
      _StyleDefs(211) =   "Splits(0).Columns(43).EditorStyle:id=209,.parent=57"
      _StyleDefs(212) =   "Splits(0).Columns(44).Style:id=214,.parent=53"
      _StyleDefs(213) =   "Splits(0).Columns(44).HeadingStyle:id=211,.parent=54"
      _StyleDefs(214) =   "Splits(0).Columns(44).FooterStyle:id=212,.parent=55"
      _StyleDefs(215) =   "Splits(0).Columns(44).EditorStyle:id=213,.parent=57"
      _StyleDefs(216) =   "Splits(0).Columns(45).Style:id=218,.parent=53"
      _StyleDefs(217) =   "Splits(0).Columns(45).HeadingStyle:id=215,.parent=54"
      _StyleDefs(218) =   "Splits(0).Columns(45).FooterStyle:id=216,.parent=55"
      _StyleDefs(219) =   "Splits(0).Columns(45).EditorStyle:id=217,.parent=57"
      _StyleDefs(220) =   "Splits(0).Columns(46).Style:id=222,.parent=53"
      _StyleDefs(221) =   "Splits(0).Columns(46).HeadingStyle:id=219,.parent=54"
      _StyleDefs(222) =   "Splits(0).Columns(46).FooterStyle:id=220,.parent=55"
      _StyleDefs(223) =   "Splits(0).Columns(46).EditorStyle:id=221,.parent=57"
      _StyleDefs(224) =   "Splits(0).Columns(47).Style:id=226,.parent=53"
      _StyleDefs(225) =   "Splits(0).Columns(47).HeadingStyle:id=223,.parent=54"
      _StyleDefs(226) =   "Splits(0).Columns(47).FooterStyle:id=224,.parent=55"
      _StyleDefs(227) =   "Splits(0).Columns(47).EditorStyle:id=225,.parent=57"
      _StyleDefs(228) =   "Splits(0).Columns(48).Style:id=230,.parent=53"
      _StyleDefs(229) =   "Splits(0).Columns(48).HeadingStyle:id=227,.parent=54"
      _StyleDefs(230) =   "Splits(0).Columns(48).FooterStyle:id=228,.parent=55"
      _StyleDefs(231) =   "Splits(0).Columns(48).EditorStyle:id=229,.parent=57"
      _StyleDefs(232) =   "Splits(0).Columns(49).Style:id=234,.parent=53"
      _StyleDefs(233) =   "Splits(0).Columns(49).HeadingStyle:id=231,.parent=54"
      _StyleDefs(234) =   "Splits(0).Columns(49).FooterStyle:id=232,.parent=55"
      _StyleDefs(235) =   "Splits(0).Columns(49).EditorStyle:id=233,.parent=57"
      _StyleDefs(236) =   "Splits(0).Columns(50).Style:id=238,.parent=53"
      _StyleDefs(237) =   "Splits(0).Columns(50).HeadingStyle:id=235,.parent=54"
      _StyleDefs(238) =   "Splits(0).Columns(50).FooterStyle:id=236,.parent=55"
      _StyleDefs(239) =   "Splits(0).Columns(50).EditorStyle:id=237,.parent=57"
      _StyleDefs(240) =   "Splits(0).Columns(51).Style:id=242,.parent=53"
      _StyleDefs(241) =   "Splits(0).Columns(51).HeadingStyle:id=239,.parent=54"
      _StyleDefs(242) =   "Splits(0).Columns(51).FooterStyle:id=240,.parent=55"
      _StyleDefs(243) =   "Splits(0).Columns(51).EditorStyle:id=241,.parent=57"
      _StyleDefs(244) =   "Named:id=29:Normal"
      _StyleDefs(245) =   ":id=29,.parent=0"
      _StyleDefs(246) =   "Named:id=30:Heading"
      _StyleDefs(247) =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(248) =   ":id=30,.wraptext=-1"
      _StyleDefs(249) =   "Named:id=31:Footing"
      _StyleDefs(250) =   ":id=31,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(251) =   "Named:id=32:Selected"
      _StyleDefs(252) =   ":id=32,.parent=29,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(253) =   "Named:id=33:Caption"
      _StyleDefs(254) =   ":id=33,.parent=30,.alignment=2"
      _StyleDefs(255) =   "Named:id=34:HighlightRow"
      _StyleDefs(256) =   ":id=34,.parent=29,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
      _StyleDefs(257) =   "Named:id=35:EvenRow"
      _StyleDefs(258) =   ":id=35,.parent=29,.bgcolor=&HFFFF00&"
      _StyleDefs(259) =   "Named:id=36:OddRow"
      _StyleDefs(260) =   ":id=36,.parent=29"
      _StyleDefs(261) =   "Named:id=89:RecordSelector"
      _StyleDefs(262) =   ":id=89,.parent=30"
      _StyleDefs(263) =   "Named:id=92:FilterBar"
      _StyleDefs(264) =   ":id=92,.parent=29"
   End
   ...
   End
End
Attribute VB_Name = "DEBUG1030631"
...
Private Const Max_Col% = 34                 '最大列数       2011.04.23
...
Private Const LAST_UPDATE_DAY$ = "[F103063] 2013.03.26 XX:XX Demo"
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   DEBUG
        Case 0
            ...
            If GetIni(App.EXEName, "DEBUG_SYU", App.EXEName, c) Then
                MsgBox "DEBUG_Y_SYU 設定なし"
                Unload Me
            End If
            Kill (Trim(c))
                        
            If DEBUG_SYU_Open(BtOpenNomal) Then
                Unload Me
            End If
                        
                        
            If GetIni(App.EXEName, "DEBUG_SYU_H", App.EXEName, c) Then
                MsgBox "DEBUG_Y_SYU 設定なし"
                Unload Me
            End If
            Kill (Trim(c))
            ...
            If DEBUG_SYU_H_Open(BtOpenNomal) Then
                Unload Me
            End If
                        
                        
            If GetIni(App.EXEName, "DEBUG_SYU_TEI", App.EXEName, c) Then
                MsgBox "DEBUG_Y_SYU 設定なし"
                Unload Me
            End If
            Kill (Trim(c))
            ...
            If DEBUG_SYU_TEI_Open(BtOpenNomal) Then
                Unload Me
            End If
            ...
            For i = 1 To SYUKA.UpperBound(1)
                ...
                sts = BTRV(BtOpInsert, DEBUG_SYU_POS, Y_SYUREC, Len(DEBUG_SYUREC), K0_DEBUG_SYU, Len(K0_DEBUG_SYU), 0)
                ...
                sts = BTRV(BtOpInsert, DEBUG_SYU_H_POS, Y_SYU_HREC, Len(DEBUG_SYU_HREC), K0_DEBUG_SYU_H, Len(K0_DEBUG_SYU_H), 0)
                ...
                sts = BTRV(BtOpInsert, DEBUG_SYU_TEI_POS, Y_SYU_TEI_REC, Len(DEBUG_SYU_TEI_REC), K0_DEBUG_SYU_TEI, Len(K0_DEBUG_SYU_TEI), 0)
...
Dim UNSOU_KAISHA    As Variant
    ...
    For i = 0 To UBound(JGYOBU_T)
        ...
        If JGYOBU_T(i).CODE = Last_JGYOBU Then
            DEBUG1030631.Caption = "出荷問い合わせ(問合せ№)（" + RTrim(JGYOBU_T(i).NAME) + ") " & LAST_UPDATE_DAY
...
'>>>>>>>>>>>>>>>>>>>>>  DEBUG
    ...
    If Y_SYU_TEI_Open(BtOpenNomal) Then
        Unload Me
    End If
    If DEL_SYU_TEI_Open(BtOpenNomal) Then
        Unload Me
    End If
'>>>>>>>>>>>>>>>>>>>>>  DEBUG
...
Dim i As Integer
    ...
    Next i
                                    '事業部切り替え
    DEBUG1030631.Caption = "出荷問い合わせ(問合せ№)（" + RTrim(JGYOBU_T(Index).NAME) + ") " & LAST_UPDATE_DAY
...
'----------------------------------------------------------------------------
    ...
    DEBUG1030631.MousePointer = vbHourglass

    Call Ctrl_Lock(DEBUG1030631)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(DEBUG1030631)


    DEBUG1030631.MousePointer = vbDefault
