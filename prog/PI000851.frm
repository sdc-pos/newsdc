...
Private Const ptxSHI_ZEI_KIN% = 22          '仕入税額


Private Const ptxURI_TANKA% = 23            '売上単価
Private Const ptxURI_KINGAKU% = 24          '売上金額

Private Const ptxURI_ZEI_KIN% = 25          '仕入税額
...
Private wkQTY               As String       '今回納品数量   2007.07.10
Private wkSHI_TANKA         As String       '仕入単価       2007.07.10
Private wkURI_TANKA         As String       '売上単価       2007.07.10

Private TOKUI_DELE          As Boolean      '得意先         2007.11.02


Private UKEIRE_DT       As Integer          '上下限設定 受入日　2017.11.17
Private KEIJYO_YM       As Integer          '上下限設定 計上月　2017.11.17


'Private Const LAST_UPDATE_DAY$ = "[PI00085] 2017.11.21 15:15"
'Private Const LAST_UPDATE_DAY$ = "[PI00085] 2018.01.31 13:15"
Private Const LAST_UPDATE_DAY$ = "[PI00085] 2019.10.02 16:00" '消費税率10%+1円を修正
    ...
    Select Case Mode
        ...
        Case ptxTanto_Code  '担当者
            ...
            Select Case sts
                ...
                Case BtErrKeyNotFound
                    ...
                    'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                    MsgBox "入力した項目はエラーです。(担当者未登録です)"   '2017.10.18
                    Text1(Mode).SetFocus
                    Exit Function
        ...
        Case ptxORDER_NO    '注文№
            ...
            Select Case sts
                ...
                Case BtErrKeyNotFound
                    'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                    MsgBox "入力した項目はエラーです。(注文№未登録です)"   '2017.10.18
                    Text1(Mode).SetFocus
                    Exit Function
                Case Else
                    Exit Function
        ...
        Case ptxG_SHIIRE_KBN    '仕入区分
            ...
            If i = -1 Then
                'MsgBox "入力した項目はエラーです。"                        '2017.10.18
                MsgBox "入力した項目はエラーです。(仕入区分未登録です)"     '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            End If
        ...
        Case ptxDELI_CODE   '納入先（直納先）
           ...
           If i > Combo1(pcmbDELI).ListCount - 1 Then
               'MsgBox "入力した項目はエラーです。"                     '2017.10.18
               MsgBox "入力した項目はエラーです。(直納先未登録です)"    '2017.10.18
               Text1(Mode).SetFocus
               Exit Function
           End If
            ...
            If Text1(ptxORDER_CODE).Text = Text1(ptxDELI_CODE).Text Then  '2017.11.21
               MsgBox "注文先と売上先が同一のため、登録できません"    '2017.10.18
               Text1(Mode).SetFocus
               Exit Function
        ...
        Case ptxUKEIRE_DT   '受入日
            ...
            If Not IsDate(Text1(ptxUKEIRE_DT).Text) Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(受入日エラー)"       '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
...
'>>>>>>>>>>>>>>>>>>>>>  上下限範囲ﾁｪｯｸ 2017.11.17
        ...
        Case ptxKEIJYO_YM       '処理年月
            ...
            If Not IsDate(wkDate) Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(処理年月エラー)"     '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
...
'>>>>>>>>>>>>>>>>>>>>>  上下限範囲ﾁｪｯｸ 2017.11.17
        ...
        Case ptxKONKAI_UKEIRE_QTY   '受入数
            ...
            If Not IsNumeric(Text1(ptxKONKAI_UKEIRE_QTY).Text) Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(受入数エラー) "      '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
...
''                    End If
        ...
        Case ptxZAN_QTY         '注文残
            ...
            If Not IsNumeric(Text1(ptxZAN_QTY).Text) Then
                'MsgBox "入力した項目はエラーです。"                '2017.10.18
                MsgBox "入力した項目はエラーです。(注文残エラー)"   '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
        ...
        Case ptxG_SYUSHI        '収支単位
            ...
            If i > Combo1(pcmbG_SYUSHI).ListCount - 1 Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(収支単位未登録です)" '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            End If
        ...
        Case ptxG_HANBAI_KBN    '販売区分
           ...
           If i > Combo1(pcmbG_HANBAI_KBN).ListCount - 1 Then
               'MsgBox "入力した項目はエラーです。"                     '2017.10.18
               MsgBox "入力した項目はエラーです。(販売区分未登録です)"  '2017.10.18
               Text1(Mode).SetFocus
               Exit Function
           End If
        ...
        Case ptxSHI_TANKA       '単価
            ...
            If Not IsNumeric(Text1(ptxSHI_TANKA).Text) Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(仕入単価エラー)"     '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
                '単価
        ...
        Case ptxURI_TANKA         '単価
            ...
            If Not IsNumeric(Text1(ptxURI_TANKA).Text) Then
                'MsgBox "入力した項目はエラーです。"                    '2017.10.18
                MsgBox "入力した項目はエラーです。(売上単価エラー)"     '2017.10.18
                Text1(Mode).SetFocus
                Exit Function
            Else
...
'                End If                     '2017.10.18
        ...
        Case P_CMD_DEL                      '削除       機能追加    2008.10.10
...
'        Beep                                       '2017.10.17
'        MsgBox "同一プログラム実行中です。"        '2017.10.17
'        End                                        '2017.10.17
'    End If                                         '2017.10.17
...
Private Sub Text1_GotFocus(Index As Integer)
    ...
    Select Case Index                       '2007.07.10
        Case ptxKONKAI_UKEIRE_QTY           '今回納品数量
            wkQTY = Trim(Text1(Index).Text)
        Case ptxSHI_TANKA                   '仕入単価
            wkSHI_TANKA = Trim(Text1(Index).Text)
        Case ptxURI_TANKA                   '売上単価
...
Dim sts As Integer
    ...
    If sts Then
        MsgBox "「表示件数」書き込みエラー PI00085.INI"
    End If
