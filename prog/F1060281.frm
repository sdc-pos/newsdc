...
Private SHIMUKE_CODE    As String * 2       '仕向け先コード 2008.11.17




Private Const LAST_UPDATE_DAY$ = "[F106028]2011.07.14 12:00"
...
'----------------------------------------------------------------------------
    ...
    F1060281.MousePointer = vbHourglass

    Call Ctrl_Lock(F1060281)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(F1060281)


    F1060281.MousePointer = vbDefault
...
Dim i   As Integer
    ...
    For i = 0 To UBound(JGYOBU_T) - 1
        ...
        If JGYOBU_T(i).CODE = Last_JGYOBU Then
            F1060281.Caption = "商品化計画支援アラームリスト(出荷ﾃﾞｰﾀ対応)印刷（" + RTrim(JGYOBU_T(i).NAME) + "）" & LAST_UPDATE_DAY
...
'    End If
    ...
    Next i
                                    '事業部切り替え
    F1060281.Caption = "商品化計画支援アラームリスト(出荷ﾃﾞｰﾀ対応)印刷（" + RTrim(JGYOBU_T(Index).NAME) + "）" & LAST_UPDATE_DAY
