...
'Private Const LAST_UPDATE_DAY$ = "[PI00025] 2017.08.05 13:45"
...
Dim j           As Integer
    ...
    Call UniCode_Conv(P_SSHIJI_O_REC.UKEIRE_QTY, Format(CLng(StrConv(P_SSHIJI_O_REC.UKEIRE_QTY, vbUnicode)) - _
                                                    CLng(StrConv(P_SUKEIRE_REC.UKEIRE_QTY, vbUnicode)), "00000000.00"))
