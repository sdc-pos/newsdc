...
'----------------------------------------------------------------------------
    ...
    PI999991.MousePointer = vbHourglass

    Call Ctrl_Lock(PI999991)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(PI999991)


    PI999991.MousePointer = vbDefault
...
Dim f               As New PI999992

Dim rpt2            As New PI99999F2
...
Dim sts As Integer
    ...
    End If
    Set PI999991 = Nothing
    Set PI999992 = Nothing
