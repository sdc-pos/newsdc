...
Begin VB.Form SEI00551 
   Caption         =   "[請求システム]輸送箱日別実績作成処理"
   ClientHeight    =   11145
   ClientLeft      =   2025
   ClientTop       =   2550
   ClientWidth     =   16020
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(0).Caption=   "出荷先"
      Columns(0).DataField=   ""
      Columns(0)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(1)._VlistStyle=   0
      Columns(1)._MaxComboItems=   5
      Columns(1).Caption=   "出荷先名"
      Columns(1).DataField=   ""
      ...
      Splits(0)._ColumnProps(5)=   "Column(1).Width=4154"
      Splits(0)._ColumnProps(6)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(7)=   "Column(1)._WidthInPix=4022"
      Splits(0)._ColumnProps(8)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(9)=   "Column(2).Width=2170"
      ...
      Splits(0)._ColumnProps(163)=   "Column(33).Width=4366"
      Splits(0)._ColumnProps(164)=   "Column(33).DividerColor=0"
      Splits(0)._ColumnProps(165)=   "Column(33)._WidthInPix=4233"
      Splits(0)._ColumnProps(166)=   "Column(33).Visible=0"
      Splits(0)._ColumnProps(167)=   "Column(33).Order=34"
      Splits(0)._ColumnProps(168)=   "Column(34).Width=4366"
      Splits(0)._ColumnProps(169)=   "Column(34).DividerColor=0"
      Splits(0)._ColumnProps(170)=   "Column(34)._WidthInPix=4233"
      Splits(0)._ColumnProps(171)=   "Column(34).Visible=0"
      ...
      _StyleDefs(44)  =   "Splits(0).Columns(2).Style:id=16,.parent=87,.alignment=1"
      _StyleDefs(45)  =   "Splits(0).Columns(2).HeadingStyle:id=13,.parent=88"
      _StyleDefs(46)  =   "Splits(0).Columns(2).FooterStyle:id=14,.parent=89"
      _StyleDefs(47)  =   "Splits(0).Columns(2).EditorStyle:id=15,.parent=91"
      ...
      _StyleDefs(56)  =   "Splits(0).Columns(5).Style:id=28,.parent=87,.alignment=1"
      ...
      _StyleDefs(60)  =   "Splits(0).Columns(6).Style:id=32,.parent=87,.alignment=1"
      ...
      _StyleDefs(64)  =   "Splits(0).Columns(7).Style:id=46,.parent=87,.alignment=1"
      _StyleDefs(65)  =   "Splits(0).Columns(7).HeadingStyle:id=43,.parent=88"
      _StyleDefs(66)  =   "Splits(0).Columns(7).FooterStyle:id=44,.parent=89"
      _StyleDefs(67)  =   "Splits(0).Columns(7).EditorStyle:id=45,.parent=91"
      _StyleDefs(68)  =   "Splits(0).Columns(8).Style:id=50,.parent=87,.alignment=1"
      _StyleDefs(69)  =   "Splits(0).Columns(8).HeadingStyle:id=47,.parent=88"
      _StyleDefs(70)  =   "Splits(0).Columns(8).FooterStyle:id=48,.parent=89"
      _StyleDefs(71)  =   "Splits(0).Columns(8).EditorStyle:id=49,.parent=91"
      _StyleDefs(72)  =   "Splits(0).Columns(9).Style:id=54,.parent=87,.alignment=1"
      _StyleDefs(73)  =   "Splits(0).Columns(9).HeadingStyle:id=51,.parent=88"
      _StyleDefs(74)  =   "Splits(0).Columns(9).FooterStyle:id=52,.parent=89"
      _StyleDefs(75)  =   "Splits(0).Columns(9).EditorStyle:id=53,.parent=91"
      _StyleDefs(76)  =   "Splits(0).Columns(10).Style:id=58,.parent=87,.alignment=1"
      _StyleDefs(77)  =   "Splits(0).Columns(10).HeadingStyle:id=55,.parent=88"
      _StyleDefs(78)  =   "Splits(0).Columns(10).FooterStyle:id=56,.parent=89"
      _StyleDefs(79)  =   "Splits(0).Columns(10).EditorStyle:id=57,.parent=91"
      _StyleDefs(80)  =   "Splits(0).Columns(11).Style:id=62,.parent=87,.alignment=1"
      _StyleDefs(81)  =   "Splits(0).Columns(11).HeadingStyle:id=59,.parent=88"
      _StyleDefs(82)  =   "Splits(0).Columns(11).FooterStyle:id=60,.parent=89"
      _StyleDefs(83)  =   "Splits(0).Columns(11).EditorStyle:id=61,.parent=91"
      _StyleDefs(84)  =   "Splits(0).Columns(12).Style:id=66,.parent=87,.alignment=1"
      _StyleDefs(85)  =   "Splits(0).Columns(12).HeadingStyle:id=63,.parent=88"
      _StyleDefs(86)  =   "Splits(0).Columns(12).FooterStyle:id=64,.parent=89"
      _StyleDefs(87)  =   "Splits(0).Columns(12).EditorStyle:id=65,.parent=91"
      _StyleDefs(88)  =   "Splits(0).Columns(13).Style:id=70,.parent=87,.alignment=1"
      _StyleDefs(89)  =   "Splits(0).Columns(13).HeadingStyle:id=67,.parent=88"
      _StyleDefs(90)  =   "Splits(0).Columns(13).FooterStyle:id=68,.parent=89"
      _StyleDefs(91)  =   "Splits(0).Columns(13).EditorStyle:id=69,.parent=91"
      _StyleDefs(92)  =   "Splits(0).Columns(14).Style:id=74,.parent=87,.alignment=1"
      _StyleDefs(93)  =   "Splits(0).Columns(14).HeadingStyle:id=71,.parent=88"
      _StyleDefs(94)  =   "Splits(0).Columns(14).FooterStyle:id=72,.parent=89"
      _StyleDefs(95)  =   "Splits(0).Columns(14).EditorStyle:id=73,.parent=91"
      _StyleDefs(96)  =   "Splits(0).Columns(15).Style:id=78,.parent=87,.alignment=1"
      _StyleDefs(97)  =   "Splits(0).Columns(15).HeadingStyle:id=75,.parent=88"
      _StyleDefs(98)  =   "Splits(0).Columns(15).FooterStyle:id=76,.parent=89"
      _StyleDefs(99)  =   "Splits(0).Columns(15).EditorStyle:id=77,.parent=91"
      _StyleDefs(100) =   "Splits(0).Columns(16).Style:id=82,.parent=87,.alignment=1"
      _StyleDefs(101) =   "Splits(0).Columns(16).HeadingStyle:id=79,.parent=88"
      _StyleDefs(102) =   "Splits(0).Columns(16).FooterStyle:id=80,.parent=89"
      _StyleDefs(103) =   "Splits(0).Columns(16).EditorStyle:id=81,.parent=91"
      _StyleDefs(104) =   "Splits(0).Columns(17).Style:id=86,.parent=87,.alignment=1"
      _StyleDefs(105) =   "Splits(0).Columns(17).HeadingStyle:id=83,.parent=88"
      _StyleDefs(106) =   "Splits(0).Columns(17).FooterStyle:id=84,.parent=89"
      _StyleDefs(107) =   "Splits(0).Columns(17).EditorStyle:id=85,.parent=91"
      _StyleDefs(108) =   "Splits(0).Columns(18).Style:id=118,.parent=87,.alignment=1"
      _StyleDefs(109) =   "Splits(0).Columns(18).HeadingStyle:id=115,.parent=88"
      _StyleDefs(110) =   "Splits(0).Columns(18).FooterStyle:id=116,.parent=89"
      _StyleDefs(111) =   "Splits(0).Columns(18).EditorStyle:id=117,.parent=91"
      _StyleDefs(112) =   "Splits(0).Columns(19).Style:id=122,.parent=87,.alignment=1"
      _StyleDefs(113) =   "Splits(0).Columns(19).HeadingStyle:id=119,.parent=88"
      _StyleDefs(114) =   "Splits(0).Columns(19).FooterStyle:id=120,.parent=89"
      _StyleDefs(115) =   "Splits(0).Columns(19).EditorStyle:id=121,.parent=91"
      _StyleDefs(116) =   "Splits(0).Columns(20).Style:id=126,.parent=87,.alignment=1"
      _StyleDefs(117) =   "Splits(0).Columns(20).HeadingStyle:id=123,.parent=88"
      _StyleDefs(118) =   "Splits(0).Columns(20).FooterStyle:id=124,.parent=89"
      _StyleDefs(119) =   "Splits(0).Columns(20).EditorStyle:id=125,.parent=91"
      _StyleDefs(120) =   "Splits(0).Columns(21).Style:id=130,.parent=87,.alignment=1"
      _StyleDefs(121) =   "Splits(0).Columns(21).HeadingStyle:id=127,.parent=88"
      _StyleDefs(122) =   "Splits(0).Columns(21).FooterStyle:id=128,.parent=89"
      _StyleDefs(123) =   "Splits(0).Columns(21).EditorStyle:id=129,.parent=91"
      _StyleDefs(124) =   "Splits(0).Columns(22).Style:id=134,.parent=87,.alignment=1"
      _StyleDefs(125) =   "Splits(0).Columns(22).HeadingStyle:id=131,.parent=88"
      _StyleDefs(126) =   "Splits(0).Columns(22).FooterStyle:id=132,.parent=89"
      _StyleDefs(127) =   "Splits(0).Columns(22).EditorStyle:id=133,.parent=91"
      _StyleDefs(128) =   "Splits(0).Columns(23).Style:id=138,.parent=87,.alignment=1"
      _StyleDefs(129) =   "Splits(0).Columns(23).HeadingStyle:id=135,.parent=88"
      _StyleDefs(130) =   "Splits(0).Columns(23).FooterStyle:id=136,.parent=89"
      _StyleDefs(131) =   "Splits(0).Columns(23).EditorStyle:id=137,.parent=91"
      _StyleDefs(132) =   "Splits(0).Columns(24).Style:id=142,.parent=87,.alignment=1"
      _StyleDefs(133) =   "Splits(0).Columns(24).HeadingStyle:id=139,.parent=88"
      _StyleDefs(134) =   "Splits(0).Columns(24).FooterStyle:id=140,.parent=89"
      _StyleDefs(135) =   "Splits(0).Columns(24).EditorStyle:id=141,.parent=91"
      _StyleDefs(136) =   "Splits(0).Columns(25).Style:id=146,.parent=87,.alignment=1"
      _StyleDefs(137) =   "Splits(0).Columns(25).HeadingStyle:id=143,.parent=88"
      _StyleDefs(138) =   "Splits(0).Columns(25).FooterStyle:id=144,.parent=89"
      _StyleDefs(139) =   "Splits(0).Columns(25).EditorStyle:id=145,.parent=91"
      _StyleDefs(140) =   "Splits(0).Columns(26).Style:id=150,.parent=87,.alignment=1"
      _StyleDefs(141) =   "Splits(0).Columns(26).HeadingStyle:id=147,.parent=88"
      _StyleDefs(142) =   "Splits(0).Columns(26).FooterStyle:id=148,.parent=89"
      _StyleDefs(143) =   "Splits(0).Columns(26).EditorStyle:id=149,.parent=91"
      _StyleDefs(144) =   "Splits(0).Columns(27).Style:id=154,.parent=87,.alignment=1"
      _StyleDefs(145) =   "Splits(0).Columns(27).HeadingStyle:id=151,.parent=88"
      _StyleDefs(146) =   "Splits(0).Columns(27).FooterStyle:id=152,.parent=89"
      _StyleDefs(147) =   "Splits(0).Columns(27).EditorStyle:id=153,.parent=91"
      _StyleDefs(148) =   "Splits(0).Columns(28).Style:id=158,.parent=87,.alignment=1"
      _StyleDefs(149) =   "Splits(0).Columns(28).HeadingStyle:id=155,.parent=88"
      _StyleDefs(150) =   "Splits(0).Columns(28).FooterStyle:id=156,.parent=89"
      _StyleDefs(151) =   "Splits(0).Columns(28).EditorStyle:id=157,.parent=91"
      _StyleDefs(152) =   "Splits(0).Columns(29).Style:id=162,.parent=87,.alignment=1"
      _StyleDefs(153) =   "Splits(0).Columns(29).HeadingStyle:id=159,.parent=88"
      _StyleDefs(154) =   "Splits(0).Columns(29).FooterStyle:id=160,.parent=89"
      _StyleDefs(155) =   "Splits(0).Columns(29).EditorStyle:id=161,.parent=91"
      _StyleDefs(156) =   "Splits(0).Columns(30).Style:id=166,.parent=87,.alignment=1"
      _StyleDefs(157) =   "Splits(0).Columns(30).HeadingStyle:id=163,.parent=88"
      _StyleDefs(158) =   "Splits(0).Columns(30).FooterStyle:id=164,.parent=89"
      _StyleDefs(159) =   "Splits(0).Columns(30).EditorStyle:id=165,.parent=91"
      _StyleDefs(160) =   "Splits(0).Columns(31).Style:id=170,.parent=87,.alignment=1"
      _StyleDefs(161) =   "Splits(0).Columns(31).HeadingStyle:id=167,.parent=88"
      _StyleDefs(162) =   "Splits(0).Columns(31).FooterStyle:id=168,.parent=89"
      _StyleDefs(163) =   "Splits(0).Columns(31).EditorStyle:id=169,.parent=91"
      _StyleDefs(164) =   "Splits(0).Columns(32).Style:id=174,.parent=87"
      _StyleDefs(165) =   "Splits(0).Columns(32).HeadingStyle:id=171,.parent=88"
      _StyleDefs(166) =   "Splits(0).Columns(32).FooterStyle:id=172,.parent=89"
      _StyleDefs(167) =   "Splits(0).Columns(32).EditorStyle:id=173,.parent=91"
      _StyleDefs(168) =   "Splits(0).Columns(33).Style:id=246,.parent=87"
      _StyleDefs(169) =   "Splits(0).Columns(33).HeadingStyle:id=243,.parent=88"
      _StyleDefs(170) =   "Splits(0).Columns(33).FooterStyle:id=244,.parent=89"
      _StyleDefs(171) =   "Splits(0).Columns(33).EditorStyle:id=245,.parent=91"
      _StyleDefs(172) =   "Splits(0).Columns(34).Style:id=254,.parent=87"
      _StyleDefs(173) =   "Splits(0).Columns(34).HeadingStyle:id=251,.parent=88"
      _StyleDefs(174) =   "Splits(0).Columns(34).FooterStyle:id=252,.parent=89"
      _StyleDefs(175) =   "Splits(0).Columns(34).EditorStyle:id=253,.parent=91"
      _StyleDefs(176) =   "Splits(0).Columns(35).Style:id=258,.parent=87"
      _StyleDefs(177) =   "Splits(0).Columns(35).HeadingStyle:id=255,.parent=88"
      _StyleDefs(178) =   "Splits(0).Columns(35).FooterStyle:id=256,.parent=89"
      _StyleDefs(179) =   "Splits(0).Columns(35).EditorStyle:id=257,.parent=91"
...
Private Const Max_Col% = 63             '最大列数

Private Const ColMTS_CODE% = 0          '出荷先コード
Private Const ColMUKE_NAME% = 1         '出荷先名称


Private Const ColDay_MAI% = 2           '日別　数量／才数 2～32

Private Const ColDay_SAI% = 33          '日別　数量／才数 33～63
...
Dim sts As Integer
    ...
    End If
                                            '向け先マスタＣＬＯＳＥ
    sts = BTRV(BtOpClose, MTS_POS, ITEMREC, Len(ITEMREC), K0_ITEM, Len(K0_ITEM), 0)
    If sts Then
        If sts <> BtErrNoOpen Then
            Call File_Error(sts, BtOpClose, "品目マスタ")
        End If
...
Dim Fast_Flg    As Boolean
    ...
    If IsDate(Text1(ptxS_JITU_DATE).Text) Then
        Call UniCode_Conv(K2_SE_USOU_HAKO.JITU_DATE, Format((Text1(ptxS_JITU_DATE).Text), "YYYYMMDD"))
    Else
        Call UniCode_Conv(K2_SE_USOU_HAKO.JITU_DATE, Text1(ptxS_JITU_DATE).Text)
    End If
    ...
    Call UniCode_Conv(K2_SE_USOU_HAKO.MTS_CODE, "")
    Call UniCode_Conv(K2_SE_USOU_HAKO.JGYOBU, "")
    Call UniCode_Conv(K2_SE_USOU_HAKO.NAIGAI, "")
    Call UniCode_Conv(K2_SE_USOU_HAKO.HIN_GAI, "")
    ...
    Do
        ...
        sts = BTRV(com, SE_USOU_HAKO_POS, SE_USOU_HAKOREC, Len(SE_USOU_HAKOREC), K2_SE_USOU_HAKO, Len(K2_SE_USOU_HAKO), 2)
        ...
        If Not Skip_Flg Then
            ...
            If Fast_Flg Then
                ...
                SE_USOU_HAKO(1, ColMTS_CODE) = Trim(StrConv(SE_USOU_HAKOREC.MTS_CODE, vbUnicode))
                
                
                
                
                
                If SE_USOU_HAKO(1, ColMTS_CODE) = "********" Then
                        
                    SE_USOU_HAKO(1, ColMUKE_NAME) = "その他"
                Else
                    ...
                    SE_USOU_HAKO(1, ColMUKE_NAME) = Trim(StrConv(MTSREC.MUKE_NAME, vbUnicode))
                End If
    ...
    For i = 1 To SE_USOU_HAKO.UpperBound(1)
        ...
        Do
            j = j + 1
            SE_USOU_HAKO(i, j) = Format(CLng(SE_USOU_HAKO(i, j)), "#,##0") & "/" & Format(CLng(SE_USOU_HAKO(i, j + 31)), "#,##0")
            End_Date = DateAdd("d", 1, End_Date)
            If End_Date > Text1(ptxE_JITU_DATE).Text Then
                Exit Do
            End If
...
Dim ParaM               As String
    ...
    excelSheet.Application.Range(excelSheet.Application.Cells(3, 3), excelSheet.Application.Cells(4, i)).Select
    With excelSheet.Application.Selection.Borders(xlEdgeLeft)
        .LineStyle = xlContinuous
        .Weight = xlThin
        .ColorIndex = xlAutomatic
    ...
    Do
        ...
        If Fast_Flg Then
            ...
            If SE_USOU_HAKO(1, ColMTS_CODE) = "********" Then
                SE_USOU_HAKO(1, ColMUKE_NAME) = "その他"
            Else
                Call UniCode_Conv(K0_MTS.MUKE_CODE, SE_USOU_HAKO(1, ColMTS_CODE))
                Call UniCode_Conv(K0_MTS.SS_CODE, "")
    ...
    For i = 1 To SE_USOU_HAKO.UpperBound(1)
        ...
        Row = Row + 2
        If Excel_Set_Proc(excelApplication, excelWorkBook, excelSheet, Row, i) Then
            Unload Me
        End If
    ...
    excelSheet.Application.Range(excelSheet.Application.Cells(Row, i), excelSheet.Application.Cells(Row, i)).Select
    excelSheet.Application.ActiveCell.FormulaR1C1 = "=SUM(RC[" & (-i + 3) & "]:RC[-1]"
    excelSheet.Application.Range(excelSheet.Application.Cells(Row + 1, i), excelSheet.Application.Cells(Row + 1, i)).Select
    excelSheet.Application.ActiveCell.FormulaR1C1 = "=SUM(RC[" & (-i + 3) & "]:RC[-1]"
    excelSheet.Application.Cells(Row, i).NumberFormatLocal = "#,###_ "
    excelSheet.Application.Cells(Row + 1, i).NumberFormatLocal = "#,###_ "
...
Private Function Excel_Set_Proc(excelApplication As excel.Application, excelWorkBook As excel.Workbook, excelSheet As excel.Worksheet, _
                                                excelRow As Integer, gridRow As Integer) As Integer
'----------------------------------------------------------------------------
'           輸送箱--＞EXCEL
'----------------------------------------------------------------------------
Dim sts         As Integer
...
Dim End_Date    As String
    ...
    '出荷先
    excelSheet.Application.Cells(excelRow, 1).Value = Trim(SE_USOU_HAKO(gridRow, ColMTS_CODE))
    '出荷先名称
    
    
    excelSheet.Application.Cells(excelRow, 2).Value = Trim(SE_USOU_HAKO(gridRow, ColMUKE_NAME))
    '『才数』
    ...
    Do
        ...
        excelSheet.Application.Cells(excelRow, i).Value = CDbl(SE_USOU_HAKO(gridRow, (i - 2) + 31))
        excelSheet.Application.Cells(excelRow + 1, i).NumberFormatLocal = "#,###_ "
        excelSheet.Application.Cells(excelRow + 1, i).Value = CLng(SE_USOU_HAKO(gridRow, (i - 2)))
...
'----------------------------------------------------------------------------
    ...
    SEI00551.MousePointer = vbHourglass


    Call Ctrl_Lock(SEI00551)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(SEI00551)
    
    TDBGrid1.Enabled = True


    SEI00551.MousePointer = vbDefault
...
Dim j       As Long
    ...
    For i = 1 To SE_USOU_HAKO.UpperBound(1)
        ...
        If Trim(StrConv(SE_USOU_HAKOREC.MTS_CODE, vbUnicode)) = Trim(SE_USOU_HAKO(i, ColMTS_CODE)) Then
            Exit For
        End If
    ...
    If i > SE_USOU_HAKO.UpperBound(1) Then
        ...
        SE_USOU_HAKO(i, ColMTS_CODE) = Trim(StrConv(SE_USOU_HAKOREC.MTS_CODE, vbUnicode))
    
    
    
        If SE_USOU_HAKO(i, ColMTS_CODE) = "********" Then
                
            SE_USOU_HAKO(i, ColMUKE_NAME) = "その他"
        Else
            ...
            SE_USOU_HAKO(i, ColMUKE_NAME) = Trim(StrConv(MTSREC.MUKE_NAME, vbUnicode))
        End If
    ...
    j = (DateDiff("D", Text1(ptxS_JITU_DATE).Text, Mid(StrConv(SE_USOU_HAKOREC.JITU_DATE, vbUnicode), 1, 4) & "/" & Mid(StrConv(SE_USOU_HAKOREC.JITU_DATE, vbUnicode), 5, 2) & "/" & Mid(StrConv(SE_USOU_HAKOREC.JITU_DATE, vbUnicode), 7, 2)) + 1) + ColMUKE_NAME
    ...
    Select Case sts
        Case BtNoErr
            ...
            If Not IsNumeric(StrConv(ITEMREC.SAI_SU, vbUnicode)) Then
    ...
    SE_USOU_HAKO(i, j + 31) = CLng(SE_USOU_HAKO(i, j + 31)) + CDbl(StrConv(ITEMREC.SAI_SU, vbUnicode)) * CDbl(StrConv(SE_USOU_HAKOREC.MAISU, vbUnicode))
