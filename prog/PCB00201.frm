...
Begin VB.Form PCB00201 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(26)=   "Column(5).Width=609"
      Splits(0)._ColumnProps(27)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(28)=   "Column(5)._WidthInPix=503"
      Splits(0)._ColumnProps(29)=   "Column(5)._ColStyle=516"
      Splits(0)._ColumnProps(30)=   "Column(5).Order=6"
      Splits(0)._ColumnProps(31)=   "Column(6).Width=2831"
      Splits(0)._ColumnProps(32)=   "Column(6).DividerColor=0"
      Splits(0)._ColumnProps(33)=   "Column(6)._WidthInPix=2725"
      ...
      Splits(0)._ColumnProps(41)=   "Column(8).Width=847"
      Splits(0)._ColumnProps(42)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(43)=   "Column(8)._WidthInPix=741"
      Splits(0)._ColumnProps(44)=   "Column(8)._ColStyle=516"
      Splits(0)._ColumnProps(45)=   "Column(8).Order=9"
      Splits(0)._ColumnProps(46)=   "Column(9).Width=1958"
      ...
      Splits(0)._ColumnProps(51)=   "Column(10).Width=3334"
      Splits(0)._ColumnProps(52)=   "Column(10).DividerColor=0"
      Splits(0)._ColumnProps(53)=   "Column(10)._WidthInPix=3228"
      Splits(0)._ColumnProps(54)=   "Column(10)._ColStyle=516"
      Splits(0)._ColumnProps(55)=   "Column(10).Order=11"
      Splits(0)._ColumnProps(56)=   "Column(11).Width=2593"
      Splits(0)._ColumnProps(57)=   "Column(11).DividerColor=0"
      Splits(0)._ColumnProps(58)=   "Column(11)._WidthInPix=2487"
      ...
      Splits(0)._ColumnProps(66)=   "Column(13).Width=12250"
      Splits(0)._ColumnProps(67)=   "Column(13).DividerColor=0"
      Splits(0)._ColumnProps(68)=   "Column(13)._WidthInPix=12144"
      ...
      Splits(0)._ColumnProps(76)=   "Column(15).Width=3281"
      Splits(0)._ColumnProps(77)=   "Column(15).DividerColor=0"
      Splits(0)._ColumnProps(78)=   "Column(15)._WidthInPix=3175"
      Splits(0)._ColumnProps(79)=   "Column(15)._ColStyle=516"
      Splits(0)._ColumnProps(80)=   "Column(15).Order=16"
      Splits(0)._ColumnProps(81)=   "Column(16).Width=3281"
      Splits(0)._ColumnProps(82)=   "Column(16).DividerColor=0"
      Splits(0)._ColumnProps(83)=   "Column(16)._WidthInPix=3175"
      ...
      _StyleDefs(10)  =   "HeadingStyle:id=2,.parent=1,.namedParent=34,.alignment=2,.bold=0,.fontsize=900"
   ...
   Begin VB.Label Label1 
      Appearance      =   0  'ﾌﾗｯﾄ
      AutoSize        =   -1  'True
      Caption         =   "0:非対象/1:対象/8:全数残し/9:生涯発注"
      ForeColor       =   &H80000008&
      Height          =   240
      Index           =   3
      Left            =   2760
...
Private Const ptxKANRI_NO% = 10         '管理№     2017.03.27

Private Const ptxSENDO% = 11            '鮮度管理   2017.03.27

Private Const ptxHITUYO_SU% = 12        '必要数　個
Private Const ptxHITUYO_TUKI% = 13      '必要数　月

Private Const ptxHITUYO_QTY% = 14       '必要数　個×月
Private Const ptxZAIKO_NOW% = 15        '現在庫
...
'Private Const LAST_UPDATE_DAY$ = "[PCB0020] 　2017.11.24 15:00"
Private Const LAST_UPDATE_DAY$ = "[PCB0020] 　2018.09.18 10:45"
...
'            End If                                                         2014.09.17
            ...
            If yn = vbYes Then
                ...
                Call Clear_Field_Proc(ptxHIN_GAI)
            
                Text1(ptxHIN_GAI).SetFocus
                Exit Sub
            Else
                Text1(ptxMODULE_UNIT_KBN).SetFocus
                Exit Sub
...
'-------------------------------------  <モジュール品目マスタ処理>
 ...
 '           Exit Function                                                                                      2014.09.17
    ...
    Call UniCode_Conv(M_ITEM_REC.KANRI_NO, Text1(ptxKANRI_NO).Text)                 '管理№ 2017.03.27
                ...
                Case BtNoErr
                    ...
                    Select Case sts
                        Case BtNoErr
                            ...
                            Text1(ptxKANRI_NO).Text = StrConv(M_ITEM_REC.KANRI_NO, vbUnicode)           '2017.03.27
...
'                            Text1(ptxHITUYO_SU).Text = Format(Val(StrConv(M_ITEM_REC.HITUYO_SU, vbUnicode)), "#")                      '2017.03.27
'                            Text1(ptxHITUYO_TUKI).Text = Format(Val(StrConv(M_ITEM_REC.HITUYO_TUKI, vbUnicode)), "#")                  '2017.03.27
'                            Text1(ptxHITUYO_QTY).Text = Format(Val(Text1(ptxHITUYO_SU).Text) * Val(Text1(ptxHITUYO_TUKI).Text), "#")   '2017.03.27
                            Text1(ptxHITUYO_SU).Text = Format(Val(StrConv(M_ITEM_REC.HITUYO_SU, vbUnicode)), "#0")                      '2017.03.27
                            Text1(ptxHITUYO_TUKI).Text = Format(Val(StrConv(M_ITEM_REC.HITUYO_TUKI, vbUnicode)), "#0")                  '2017.03.27
                            Text1(ptxHITUYO_QTY).Text = Format(Val(Text1(ptxHITUYO_SU).Text) * Val(Text1(ptxHITUYO_TUKI).Text), "#0")   '2017.03.27
                            ...
                            For i = 0 To UBound(Nara_Soko_T)
                                ...
                                'If SOKO_Zaiko_Syukei_Proc(Sumi_Qty, Mi_Qty, StrConv(ITEMREC.JGYOBU, vbUnicode), StrConv(ITEMREC.NAIGAI, vbUnicode), StrConv(ITEMREC.HIN_GAI, vbUnicode), Location) Then        '2018.09.18
                                If NEW_SOKO_Zaiko_Syukei_Proc(Sumi_Qty, Mi_Qty, StrConv(ITEMREC.JGYOBU, vbUnicode), StrConv(ITEMREC.NAIGAI, vbUnicode), StrConv(ITEMREC.HIN_GAI, vbUnicode), Location) Then     '2018.09.18
                                    Exit Function
                                End If
                                Zaiko_QTY = Zaiko_QTY + (Sumi_Qty + Mi_Qty)
                            Next i
'                            Text1(ptxZAIKO_NOW).Text = Format(Zaiko_QTY, "#")  '2017.03.27
                            Text1(ptxZAIKO_NOW).Text = Format(Zaiko_QTY, "#0")  '2017.03.27
                                                           
                            Call HANTEI_Proc(HANTEI_MARK)
                                                           
                                                           
'                            LblHantei_MARK.Caption = HANTEI_MARK           '2017.03.28
                            Text1(ptxSENDO).Text = HANTEI_MARK              '2017.03.28
                        ...
                        Case BtErrKeyNotFound
                            ...
                            Text1(ptxKANRI_NO).Text = ""        '2017.03.27
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>   2015.01.21
                            ...
                            'LblHantei_MARK.Caption = HANTEI_MARK   '2017.03.27
                            Text1(ptxSENDO).Text = HANTEI_MARK      '2017.03.27
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>   2015.01.21
...
'                            LblHantei_MARK.Caption = "ﾓｼﾞｭｰﾙ品目未登録"        '2014.09.17 2017.03.27 DELETE
                            Text1(ptxSENDO).Text = "ﾓｼﾞｭｰﾙ品目未登録"           '2017.03.27
...
'            If Text1(Mode).Text = "0" Or Text1(Mode).Text = "1" Then                               '2015.01.19
'            If Text1(Mode).Text = "0" Or Text1(Mode).Text = "1" Or Text1(Mode).Text = "9" Then      '2015.01.19 2017.11.24 DEL
             If Text1(Mode).Text = "0" Or Text1(Mode).Text = "1" Or Text1(Mode).Text = "8" Or Text1(Mode).Text = "9" Then      '2017.11.24
            Else
...
'2017.03.27                    Text1(Mode).Text = Format(Val(Text1(Mode).Text), "000")
                Else
                    MsgBox "入力した項目はエラーです。(管理№)数値を入力して下さい。"
                    Text1(Mode).SetFocus
                    Exit Function
                End If
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> 2017.03.27
        ...
        Case ptxHITUYO_SU               '必要数　個
            ...
            If Trim(Text1(Mode).Text) = "" Then         '2017.03.27
                Text1(Mode).Text = "0"                  '2017.03.27
            End If                                      '2107.03.27
...
Public Sub Clear_Field_Proc(Optional Mode = 0)
'----------------------------------------------------------------------------
'                   画面消去
'----------------------------------------------------------------------------
Dim i       As Integer
...
'    LblHantei_MARK = ""     '2015.01.20    2017.03.27 DELETE
...
Private Sub HANTEI_Proc(HANTEI_MARK As String)
'----------------------------------------------------------------------------
'                   判定
'       2014.07.03
'----------------------------------------------------------------------------
...
Dim i           As Integer
    ...
    If Text1(ptxMODULE_KBN).Text = "8" Then             '2017.11.24
        HANTEI_MARK = "全数残し"                        '2017.11.24
    End If                                              '2017.11.24
                                   
                                   
                                   
    If Text1(ptxMODULE_KBN).Text = "9" Then             '2015.02.19
        HANTEI_MARK = "生涯発注"                        '2015.02.19
    End If                                              '2015.02.19
