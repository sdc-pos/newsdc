...
Begin VB.Form F1060101 
   ...
   Begin TrueDBGrid60.TDBGrid TDBGrid1 
      Height          =   4095
      Left            =   1440
      OleObjectBlob   =   "F1060101.frx":0000
      TabIndex        =   23
      TabStop         =   0   'False
      Top             =   960
      Width           =   8295
...
'----------------------------------------------------------------------------
    ...
    F1060101.MousePointer = vbHourglass

    Call Ctrl_Lock(F1060101)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(F1060101)


    F1060101.MousePointer = vbDefault
...
Dim sts As Integer
    ...
    For i = 0 To UBound(JGYOBU_T) - 1
        ...
        If JGYOBU_T(i).Code = Last_JGYOBU Then
            F1060101.Caption = "作業監視モニター（" + RTrim(JGYOBU_T(i).NAME) + ")"
...
'    End If
    ...
    Next i
                                    '事業部切り替え
    F1060101.Caption = "作業監視モニター（" + RTrim(JGYOBU_T(Index).NAME) + ")"
