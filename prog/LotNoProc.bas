...
'2017.09.22
                            ...
                            Call Err_Send_Proc(ID_KANRI_TBL(ING_No).YOIN_LONG_DNAME, Trim(ID_KANRI_TBL(ING_No).Recv_text(i)), "バーコード異常", "", "")
...
'2017.09.22
                            ...
                            Call Err_Send_Proc(ID_KANRI_TBL(ING_No).YOIN_LONG_DNAME, RTrim(ID_KANRI_TBL(ING_No).Recv_text(i)), "送状№エラー", "数値のみ可", "")
                            Sendbuf = Text_Create_Proc()
                            ID_KANRI_TBL(ING_No).Step = ID_KANRI_TBL(ING_No).Step - 1
