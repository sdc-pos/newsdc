...
Begin VB.Form SEI00191 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(8).Caption=   "édì¸ã‡äzåv"
      Columns(8).DataField=   ""
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "îÃîÑã‡äzåv"
      Columns(9).DataField=   ""
      Columns(9)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(10)._VlistStyle=   0
      Columns(10)._MaxComboItems=   5
      Columns(10).Caption=   "çÏã∆éûä‘ÅiïbÅj"
      Columns(10).DataField=   ""
      Columns(10)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(11)._VlistStyle=   0
      Columns(11)._MaxComboItems=   5
      Columns(11).Caption=   "èWçáç´ïÔÅiïbÅj"
      Columns(11).DataField=   ""
      Columns(11)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(12)._VlistStyle=   0
      Columns(12)._MaxComboItems=   5
      Columns(12).Caption=   "îıçl"
      Columns(12).DataField=   ""
      Columns(12)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(13)._VlistStyle=   0
      Columns(13)._MaxComboItems=   5
      Columns(13).Caption=   "îÃîÑã‡äzÅ@ëêí√óp"
   ...
   Begin VB.Label Label1 
      Appearance      =   0  'Ã◊Øƒ
      BorderStyle     =   1  'é¿ê¸
      Caption         =   "ç›å…óLñ≥ämîFÅiìØç´ïîïiÅj"
      BeginProperty Font 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   9
         Charset         =   128
   ...
   Begin VB.Label Label1 
      Appearance      =   0  'Ã◊Øƒ
      BorderStyle     =   1  'é¿ê¸
      Caption         =   "ç›å…óLñ≥ämîFÅiïõéëçﬁÅj"
      BeginProperty Font 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   9
         Charset         =   128
   ...
   Begin VB.Label Label1 
      Appearance      =   0  'Ã◊Øƒ
      BorderStyle     =   1  'é¿ê¸
      Caption         =   "éñëOè§ïiâªïîïiÅ@êîó ëIíË"
      BeginProperty Font 
         Name            =   "ÇlÇr ÉSÉVÉbÉN"
         Size            =   9
         Charset         =   128
...
Private Const ptxBEF_KOUTEI_TANI01% = 54    'ëOçHíˆ01Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY01% = 55     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU01% = 56   '           çHêî
Private Const ptxBEF_KOUTEI_TANI02% = 57    'ëOçHíˆ02Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY02% = 58     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU02% = 59   '           çHêî
Private Const ptxBEF_KOUTEI_TANI03% = 60    'ëOçHíˆ03Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY03% = 61     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU03% = 62   '           çHêî
Private Const ptxBEF_KOUTEI_TANI04% = 63    'ëOçHíˆ04Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY04% = 64     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU04% = 65   '           çHêî
Private Const ptxBEF_KOUTEI_TANI05% = 66    'ëOçHíˆ05Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY05% = 67     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU05% = 68   '           çHêî
Private Const ptxBEF_KOUTEI_TANI06% = 69    'ëOçHíˆ06Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY06% = 70     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU06% = 71   '           çHêî
Private Const ptxBEF_KOUTEI_TANI07% = 72    'ëOçHíˆ07Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY07% = 73     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU07% = 74   '           çHêî
Private Const ptxBEF_KOUTEI_TANI08% = 75    'ëOçHíˆ08Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY08% = 76     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU08% = 77   '           çHêî
Private Const ptxBEF_KOUTEI_TANI09% = 78    'ëOçHíˆ09Å@ íPà 
Private Const ptxBEF_KOUTEI_QTY09% = 79     '           êîó 
Private Const ptxBEF_KOUTEI_KOUSU09% = 80   '           çHêî

Private Const ptxBEF_KOUTEI_KEI1% = 81      'ëOçHíˆåv   åv

Private Const ptxBEF_KOUTEI_R_RATE% = 82    'ëOçHíˆåv   ó]óTó¶

Private Const ptxBEF_KOUTEI_KEI2% = 83      'ëOçHíˆåv   (ïbÅ^å¬)
Private Const ptxBEF_KOUTEI_KEI3% = 84      'ëOçHíˆåv   (ï™Å^å¬)
Private Const ptxBEF_KOUTEI_KEI4% = 85      'ëOçHíˆåv   (â~Å^å¬)
...
Private Const ptxMAIN_KOUTEI_R_RATE% = 114  'çÏã∆çHíˆåv   ó]óTó¶


Private Const ptxMAIN_KOUTEI_KEI2% = 115    'çÏã∆çHíˆåv  (ïbÅ^å¬)
Private Const ptxMAIN_KOUTEI_KEI3% = 116    'çÏã∆çHíˆåv  (ï™Å^å¬)
Private Const ptxMAIN_KOUTEI_KEI4% = 117    'çÏã∆çHíˆåv  (â~Å^å¬)

Private Const ptxAFT_KOUTEI_TANI01% = 118   'å„çHíˆ01   íPà 
Private Const ptxAFT_KOUTEI_QTY01% = 119    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU01% = 120  '           çHêî
Private Const ptxAFT_KOUTEI_TANI02% = 121   'å„çHíˆ02   íPà 
Private Const ptxAFT_KOUTEI_QTY02% = 122    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU02% = 123  '           çHêî
Private Const ptxAFT_KOUTEI_TANI03% = 124   'å„çHíˆ03   íPà 
Private Const ptxAFT_KOUTEI_QTY03% = 125    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU03% = 126  '           çHêî
Private Const ptxAFT_KOUTEI_TANI04% = 127   'å„çHíˆ04   íPà 
Private Const ptxAFT_KOUTEI_QTY04% = 128    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU04% = 129  '           çHêî
Private Const ptxAFT_KOUTEI_TANI05% = 130   'å„çHíˆ05   íPà 
Private Const ptxAFT_KOUTEI_QTY05% = 131    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU05% = 132  '           çHêî
Private Const ptxAFT_KOUTEI_TANI06% = 133   'å„çHíˆ06   íPà 
Private Const ptxAFT_KOUTEI_QTY06% = 134    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU06% = 135  '           çHêî
Private Const ptxAFT_KOUTEI_TANI07% = 136   'å„çHíˆ07   íPà 
Private Const ptxAFT_KOUTEI_QTY07% = 137    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU07% = 138  '           çHêî
Private Const ptxAFT_KOUTEI_TANI08% = 139   'å„çHíˆ08   íPà 
Private Const ptxAFT_KOUTEI_QTY08% = 140    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU08% = 141  '           çHêî
Private Const ptxAFT_KOUTEI_TANI09% = 142   'å„çHíˆ09   íPà 
Private Const ptxAFT_KOUTEI_QTY09% = 143    '           êîó 
Private Const ptxAFT_KOUTEI_KOUSU09% = 144  '           çHêî

Private Const ptxAFT_KOUTEI_KEI1% = 145     'å„çHíˆåv   åv

Private Const ptxAFT_KOUTEI_R_RATE% = 146   'å„çHíˆåv   ó]óTó¶



Private Const ptxAFT_KOUTEI_KEI2% = 147     'å„çHíˆåv   (ïbÅ^å¬)
Private Const ptxAFT_KOUTEI_KEI3% = 148     'å„çHíˆåv   (ï™Å^å¬)
Private Const ptxAFT_KOUTEI_KEI4% = 149     'å„çHíˆåv   (â~Å^å¬)


Private Const ptxKOUTEI_KEI1% = 150         'çHíˆåv   åv

Private Const ptxKOUTEI_R_RATE% = 151       'çHíˆåv   ó]óTó¶


Private Const ptxKOUTEI_KEI2% = 152         'çHíˆåv   (ïbÅ^å¬)
Private Const ptxKOUTEI_KEI3% = 153         'çHíˆåv   (ï™Å^å¬)
Private Const ptxKOUTEI_KEI4% = 154         'çHíˆåv   (â~Å^å¬)
...
'Private Const ptxTANKA_KIRIKAE_DT% = 169    'íPâøêÿë÷ì˙ït   2009.06.02
...
'------2009.07.24
Private Const ptxPLUS_KOUSU% = 177              ' ÉvÉâÉXï™çHêî  2009.09.17
...
Private Const prchM_BIKOU% = 1          'å©êœèëîıçl         2009.06.02
...
Private Const Max_Col% = 13             'ç≈ëÂóÒêî
...
Private Const ColG_ST_SHIKIN% = 8       'édì¸ã‡äz
Private Const ColG_ST_URIKIN% = 9       'îÑè„ã‡äz
Private Const ColS_KOUSU% = 10          'çÏã∆éûä‘
Private Const ColSEI_SYU_KON% = 11      'èWçáç´ïÔ
Private Const ColKO_BIKOU% = 12         'îıçl
...
'            Exit Sub
        ...
        Case 5      'íPâøìoò^
            ...
            MESG = MESG & "Å@Åiå¥âøÅjçHóøÅF" & Text1(ptxAFT_S_SHIZAI_GENKA).Text & vbCrLf
            MESG = MESG & "Å@ (îÑâø) çHóøÅF" & Text1(ptxAFT_S_SHIZAI_BAIKA).Text & vbCrLf
    ...
    Select Case Index
        ...
        Case 1
            ...
            If ans = vbNo Then
                Exit Sub
            End If
Call LOG_OUT(SEI0019_LOG, "å©êœèëàÍäáçÏê¨Å@èàóùäJén[" & Now & "]")
...
Call LOG_OUT(SEI0019_LOG, "å©êœèëàÍäáçÏê¨Å@ê≥èÌèIóπ[" & Now & "]")
...
'    End If
    ...
    hStatusWnd = CreateStatusWindow(WS_VISIBLE Or WS_CHILD Or CCS_BOTTOM Or SBARS_SIZEGRIP, _
        "[êøãÅÉVÉXÉeÉÄ]å©êœèëàÍäáçÏê¨èàóù", Me.hwnd, 0)
...
Call LOG_OUT(SEI0019_LOG, "íSìñé“ÉGÉâÅ[= " & Text1(ptxTanto_Code).Text)
                    Exit Function
                Case Else
                    Call File_Error(sts, BtOpGetEqual, "íSìñé“É}ÉXÉ^")
                    Exit Function
...
Call LOG_OUT(SEI0019_LOG, "ïiî‘ñ¢ìoò^ÉGÉâÅ[= " & Text1(ptxHin_Gai).Text)
                    Exit Function
                Case Else
...
Call LOG_OUT(SEI0019_LOG, Text1(ptxHin_Gai).Text & " ÉçÉbÉgÉGÉâÅ[= " & Text1(ptxBEF_SEI_LOT).Text)
Exit Function
...
Exit Function
        ...
        Case ptxPLUS_KOUSU              '2009.09.17Å@PLUSçHêî
...
'>>>>>>>>>  2017.11.06
    ...
    excelSheet.Application.Cells(row, 9).Value = "çÏã∆îÔàÍéÆ"
...
'        Text1(ptxBEF_S_BU_KAKO_KOSU).Text = "0.00"
    ...
    '2011.03.29 ä«óùÉtÉ@ÉCÉãÇÃï™ÉåÅ[ÉgÇèÌÇ…égópÇ∑ÇÈ
''    If Trim(StrConv(ITEMREC.S_KOUSU_SET_DATE, vbUnicode)) = "" Then
''        'ï™⁄∞ƒ
...
Private Sub Estimate_Head_Proc(excelApplication As Object, excelWorkBook As Object, excelSheet As Object)                               '2013.09.30 EXCEL VerëŒâû
...
'''''
'''''        .TextFrame.Characters.Text = "è≥îFàÛ"
'''''        .TextFrame.Characters.Font.Size = 8              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
'''''        .TextFrame.Characters.Font.NAME = "ÇlÇr ÇoÉSÉVÉbÉN"              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
'''''        .TextFrame.HorizontalAlignment = xlHAlignCenter   ' íÜâõëµÇ¶
'''''        .TextFrame.VerticalAlignment = xlVAlignCenter     ' íÜâõëµÇ¶
'''''
...
''
''        .Characters.Text = "è≥îFàÛ"
''        .Characters.Font.Size = 8              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
''        .Characters.Font.NAME = "ÇlÇr ÇoÉSÉVÉbÉN"              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
''        .HorizontalAlignment = xlHAlignCenter   ' íÜâõëµÇ¶
''        .VerticalAlignment = xlVAlignCenter     ' íÜâõëµÇ¶
''    End With
...
'''''        .TextFrame.Characters.Text = "íSìñàÛ"
'''''        .TextFrame.Characters.Font.Size = 8              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
'''''        .TextFrame.Characters.Font.NAME = "ÇlÇr ÇoÉSÉVÉbÉN"              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
'''''        .TextFrame.HorizontalAlignment = xlHAlignCenter   ' íÜâõëµÇ¶
'''''        .TextFrame.VerticalAlignment = xlVAlignCenter     ' íÜâõëµÇ¶
...
''        .Characters.Text = "Allegy"             ' ÉIÅ[ÉgÉVÉFÉCÉvÇÃíÜÇ…ï∂éö
''        .Characters.Font.Size = 10              ' ÉtÉHÉìÉgÉTÉCÉYÇ10É|ÉCÉìÉgÇ…
''        .HorizontalAlignment = xlHAlignCenter   ' íÜâõëµÇ¶
''        .VerticalAlignment = xlVAlignCenter     ' íÜâõëµÇ¶
''    End With
...
''    Selection.Characters.Text = "íSìñàÛ"
''    With Selection.Characters.Font
''        .NAME = "ÇlÇr ÇoÉSÉVÉbÉN"
''        .FontStyle = "ïWèÄ"
''        .Size = 8
...
Private Function Estimate_SHIZAI_Proc(excelApplication As Object, excelWorkBook As Object, excelSheet As Object, row As Integer) As Integer                 '2013.09.30 EXCEL VerëŒâû
...
'            End If
 ...
 '                               Else
 '   '                                excelSheet.Application.Cells(row, 10).Value = "ñ¢íË"   2009.07.02
...
Call LOG_OUT(SEI0019_LOG, "á@ïõéëçﬁçáåvã‡äzÇ™ïõéëçﬁñæç◊ÇÃçáåvã‡äzÇ∆àŸÇ»ÇËÇ‹Ç∑ÅB" & Text1(ptxHin_Gai).Text & " " & wkNum1 & " " & wkNum2)
...
Private Function Estimate_DOUKON_Proc(excelApplication As Object, excelWorkBook As Object, excelSheet As Object, row As Integer) As Integer                 '2013.09.30 EXCEL VerëŒâû
...
Private Function Estimate_FUKA_Proc(excelApplication As Object, excelWorkBook As Object, excelSheet As Object, row As Integer, Fsw As Integer) As Integer  '2013.09.30 EXCEL VerëŒâû
...
'>>>>>>>>>> 2017.10.30
    ...
    '>>>>>>>>>>>> 2018.01.05
        ...
        excelSheet.Application.Cells(row, 8).Value = ""
        excelSheet.Application.Cells(row, 9).HorizontalAlignment = xlRight
        excelSheet.Application.Cells(row, 9).Value = "ïtâ¡çÏã∆îÔàÍéÆ"
...
Private Sub Estimate_Line12_13_Proc(excelApplication As Object, excelWorkBook As Object, excelSheet As Object)                  '2013.09.30 EXCEL VerëŒâû
...
'----------------------------------------------------------------------------
'                   ÇdÇwÇbÇdÇkÅiå‰å©êœèë 12-13çsñ⁄ÅjèoóÕ
'       2011.01.11
'----------------------------------------------------------------------------
...
Call LOG_OUT(SEI0019_LOG, "[NG]" & "KO_HIN_GAI_= " & MAIN_HIN_GAI & "HIN_GAI_= " & "äYìñÇ»Çµ" & " " & Now)
...
Call LOG_OUT(SEI0019_LOG, "[NG]" & "KO_HIN_GAI_= " & MAIN_HIN_GAI & "HIN_GAI_= " & StrConv(wP_COMPO_K_REC.HIN_GAI, vbUnicode) & " " & Now)
                    ...
                    If Not Errflg Then
                        ...
                        If TANKA_KEISAN_Proc() Then
Call LOG_OUT(SEI0019_LOG, "[NG]" & "KO_HIN_GAI_= " & MAIN_HIN_GAI & "HIN_GAI_= " & StrConv(wP_COMPO_K_REC.HIN_GAI, vbUnicode) & " " & Now)
Call LOG_OUT(SEI0019_LOG, "å©êœèëàÍäáçÏê¨Å@àŸèÌèIóπ[" & Now & "]")
