...
'Private Const LAST_UPDATE_DAY$ = "[F101051] 2015.12.15 16:00"
Private Const LAST_UPDATE_DAY$ = "[F101051] 2016.01.18 10:30"
...
Text1.Text = StrConv(ITEMREC.STAT, vbUnicode)
    ...
    Text(50).Text = Trim(StrConv(ITEMREC.GAI_BUHIN, vbUnicode))         '2016.01.30
...
'*------------------------------------------ 2008.08.26 新規追加項目一式 △
    ...
    Call UniCode_Conv(ITEMREC.GAI_BUHIN, Text(50).Text) '2016.01.30
...
''    JIGYOBU_BEF = RTrim(c)
    ...
    For i = 0 To UBound(JGYOBU_T)
        ...
        If JGYOBU_T(i).CODE = Last_JGYOBU Then
            F1010511.Caption = "品目マスタメンテナンス（削除機能付き）（" + RTrim(JGYOBU_T(i).NAME) + ") " & LAST_UPDATE_DAY
...
'2016.04.21 DEBUG
Write #FileNo, "D_SIZE=" & "W:" & Trim(StrConv(ITEMREC.D_SIZE_W, vbUnicode)) & " X D:"; Trim(StrConv(ITEMREC.D_SIZE_D, vbUnicode)) & " X h:"; Trim(StrConv(ITEMREC.D_SIZE_H, vbUnicode)),
Write #FileNo, "SAI_SU=" & Trim(StrConv(ITEMREC.SAI_SU, vbUnicode)),
'2016.04.21 DEBUG
