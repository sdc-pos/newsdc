VERSION 5.00
Begin VB.Form CONVY_NYUKA 
   BackColor       =   &H00C0C0C0&
   Caption         =   "入荷予定データコンバート処理"
   ClientHeight    =   7230
   ClientLeft      =   2325
   ClientTop       =   2625
   ClientWidth     =   10095
    ...
    Do
        ...
        Select Case sts
            ...
            Case BtErrEOF
                Exit Do
            Case Else
                Call File_Error(sts, com, "入荷予定ﾃﾞｰﾀ")
                Exit Function
        End Select
        ...
        Do
            sts = BTRV(BtOpUpdate, Y_NYU_POS, Y_NYUREC, Len(P_SSHIJI_O_REC), K0_P_SSHIJI_O, Len(K0_P_SSHIJI_O), 0)
            Select Case sts
                Case BtNoErr
                    Exit Do
