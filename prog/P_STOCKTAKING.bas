...
'    FullPath = Trim(c)
    ...
    P_STOCK_Speck.ks0.keyflag = BtKfExt + BtKfSeg       ' キーフラグ
    ...
    P_STOCK_Speck.ks1.keyflag = BtKfExt + BtKfSeg       ' キーフラグ
    ...
    P_STOCK_Speck.ks2.keyflag = BtKfExt + BtKfSeg       ' キーフラグ
    ...
    P_STOCK_Speck.ks3.keyflag = BtKfExt + BtKfSeg       ' キーフラグ
    ...
    P_STOCK_Speck.ks4.keyflag = BtKfExt                 ' キーフラグ
