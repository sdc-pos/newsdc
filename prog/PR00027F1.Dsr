VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} PR00027F1 
   ClientHeight    =   11010
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   15240
   ...
   _ExtentX        =   26882
   _ExtentY        =   19420
   SectionData     =   "PR00027F1.dsx":0000
End
Attribute VB_Name = "PR00027F1"
...
Dim YMD         As String * 8
    ...
    Label1.Caption = PR000271.Text1(ptxKEIJYO_YM).Text                  '計上年月
...
YMD = Mid(PR000271.Text1(ptxKEIJYO_YM).Text, 1, 4) & _
        Mid(PR000271.Text1(ptxKEIJYO_YM).Text, 6, 2) & _
        StrConv(P_KANRIREC.SHIME_DD, vbUnicode)
