...
Private Const LAST_UPDATE_DAY = "[F120010] 2016.07.13 14:30"
...
'            F1200101.Caption = "ホスト棚番設定データ作成（" + RTrim(JGYOBU_T(i).NAME) + ")"                    '2016.07.13
            F1200101.Caption = "ホスト棚番設定データ作成（" + RTrim(JGYOBU_T(i).NAME) + ")" & LAST_UPDATE_DAY   '2016.07.13
...
Dim i As Integer
    ...
    Next i
                                    '事業部切り替え
'    F1200101.Caption = "ホスト棚番設定データ作成（" + RTrim(JGYOBU_T(Index).NAME) + ")"                    '2016.07.13
    F1200101.Caption = "ホスト棚番設定データ作成（" + RTrim(JGYOBU_T(Index).NAME) + ")" & LAST_UPDATE_DAY   '2016.07.13
