VERSION 5.00
Begin {2AF752CD-B826-4828-B4C1-13BFC9CC90C1} PR00010F1 
   ClientHeight    =   10545
   ClientLeft      =   165
   ClientTop       =   555
   ClientWidth     =   15240
   ...
   _ExtentX        =   26882
   _ExtentY        =   18600
   SectionData     =   "PR00010F1.dsx":0000
End
Attribute VB_Name = "PR00010F1"
...
Dim i           As Integer
    ...
    Label1.Caption = PR000101.Text1(ptxKEIJYO_YM).Text                  '計上年月
