...
Begin VB.Form PM000402 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   360
      Index           =   4
      ItemData        =   "PM00040220130403.frx":0000
      Left            =   1800
      List            =   "PM00040220130403.frx":0002
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      _ExtentY        =   8070
      _Version        =   393217
      TextRTF         =   $"PM00040220130403.frx":0004
   End
   Begin VB.TextBox Text1 
      Height          =   375
      IMEMode         =   2  'ｵﾌ
   ...
   Begin RichTextLib.RichTextBox RichTextBox1 
      ...
      _ExtentY        =   8070
      _Version        =   393217
      TextRTF         =   $"PM00040220130403.frx":00C2
   End
   Begin RichTextLib.RichTextBox RichTextBox1 
      Height          =   1575
      Index           =   3
      ...
      _ExtentY        =   2778
      _Version        =   393217
      TextRTF         =   $"PM00040220130403.frx":0180
   End
   Begin RichTextLib.RichTextBox RichTextBox1 
      Height          =   735
      Index           =   1
      ...
      _ExtentY        =   1296
      _Version        =   393217
      TextRTF         =   $"PM00040220130403.frx":023E
   End
...
Private KISHU_CHECK     As Boolean          '2012.09.03 機種ﾁｪｯｸ
...
Private Const Last_Update_Day$ = "(PM00040 2013.06.26 15:00)"
...
'                    Exit Sub
                    ...
                    ans = MsgBox("会社名/事業部 が指定されていません。(ＯＫ＝発行、ｷｬﾝｾﾙ=発行しない)" & vbCrLf & vbCrLf & "会 社　名：" & Left(Trim(Combo1(pcmbL_KAISHA).Text), 30) & vbCrLf & "事業部名：" & Left(Trim(Combo1(pcmbL_JGYOBU).Text), 30), vbOKCancel + vbQuestion + vbDefaultButton2, "確認入力")
                    '2013.04.02 確認メッセージ変更
                    If ans = vbCancel Then
                        Text1(ptxHIN_GAI).SetFocus
                        Exit Sub
...
Dim wkTORI_GENSANKOKU   As String   '2013.03.27
    ...
    Do
        ...
        If Trim(StrConv(GENSANREC.UPD_DATETIME, vbUnicode)) = "" Then                                               '2013.02.19
            List2.AddItem StrConv(GENSANREC.Ins_DateTime, vbUnicode) & StrConv(GENSANREC.GENSANKOKU, vbUnicode)     '2013.02.19
        Else                                                                                                        '2013.02.19
            List2.AddItem StrConv(GENSANREC.UPD_DATETIME, vbUnicode) & StrConv(GENSANREC.GENSANKOKU, vbUnicode)     '2013.02.19
        End If                                                                                                      '2013.02.19
