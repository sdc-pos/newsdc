...
Begin VB.Form F1030621 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(1)=   "Column(0).Width=1461"
      Splits(0)._ColumnProps(2)=   "Column(0).DividerColor=0"
      Splits(0)._ColumnProps(3)=   "Column(0)._WidthInPix=1355"
      Splits(0)._ColumnProps(4)=   "Column(0).Order=1"
      Splits(0)._ColumnProps(5)=   "Column(1).Width=3196"
      Splits(0)._ColumnProps(6)=   "Column(1).DividerColor=0"
      Splits(0)._ColumnProps(7)=   "Column(1)._WidthInPix=3090"
      Splits(0)._ColumnProps(8)=   "Column(1).Order=2"
      Splits(0)._ColumnProps(9)=   "Column(2).Width=2413"
      Splits(0)._ColumnProps(10)=   "Column(2).DividerColor=0"
      Splits(0)._ColumnProps(11)=   "Column(2)._WidthInPix=2307"
      Splits(0)._ColumnProps(12)=   "Column(2).Order=3"
      Splits(0)._ColumnProps(13)=   "Column(3).Width=1355"
      Splits(0)._ColumnProps(14)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(15)=   "Column(3)._WidthInPix=1249"
      Splits(0)._ColumnProps(16)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(17)=   "Column(4).Width=1461"
      Splits(0)._ColumnProps(18)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(19)=   "Column(4)._WidthInPix=1355"
      ...
      Splits(0)._ColumnProps(54)=   "Column(12).Width=868"
      Splits(0)._ColumnProps(55)=   "Column(12).DividerColor=0"
      Splits(0)._ColumnProps(56)=   "Column(12)._WidthInPix=762"
      ...
      Splits(0)._ColumnProps(66)=   "Column(15).Width=3979"
      Splits(0)._ColumnProps(67)=   "Column(15).DividerColor=0"
      Splits(0)._ColumnProps(68)=   "Column(15)._WidthInPix=3874"
      ...
      PrintInfos(0).PageHeaderFont=   "Size=10.8,Charset=128,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=ＭＳ ゴシック"
      PrintInfos(0).PageFooterFont=   "Size=10.8,Charset=128,Weight=400,Underline=0,Italic=0,Strikethrough=0,Name=ＭＳ ゴシック"
      ...
      _StyleDefs(100) =   "Splits(0).Columns(16).Style:id=74,.parent=53"
      _StyleDefs(101) =   "Splits(0).Columns(16).HeadingStyle:id=71,.parent=54"
      _StyleDefs(102) =   "Splits(0).Columns(16).FooterStyle:id=72,.parent=55"
      _StyleDefs(103) =   "Splits(0).Columns(16).EditorStyle:id=73,.parent=57"
      _StyleDefs(104) =   "Named:id=29:Normal"
      _StyleDefs(105) =   ":id=29,.parent=0"
      _StyleDefs(106) =   "Named:id=30:Heading"
      _StyleDefs(107) =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(108) =   ":id=30,.wraptext=-1"
      _StyleDefs(109) =   "Named:id=31:Footing"
      _StyleDefs(110) =   ":id=31,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(111) =   "Named:id=32:Selected"
      _StyleDefs(112) =   ":id=32,.parent=29,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(113) =   "Named:id=33:Caption"
      _StyleDefs(114) =   ":id=33,.parent=30,.alignment=2"
      _StyleDefs(115) =   "Named:id=34:HighlightRow"
      _StyleDefs(116) =   ":id=34,.parent=29,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
      _StyleDefs(117) =   "Named:id=35:EvenRow"
      _StyleDefs(118) =   ":id=35,.parent=29,.bgcolor=&HFFFF00&"
      _StyleDefs(119) =   "Named:id=36:OddRow"
      _StyleDefs(120) =   ":id=36,.parent=29"
      _StyleDefs(121) =   "Named:id=89:RecordSelector"
      _StyleDefs(122) =   ":id=89,.parent=30"
      _StyleDefs(123) =   "Named:id=92:FilterBar"
      _StyleDefs(124) =   ":id=92,.parent=29"
   End
...
Private Const ptxMUKE_CODE% = 3         '向け先（コード入力用）
Private Const ptxDEN_MAISU_JI% = 4      '伝票枚数　実績
Private Const ptxDEN_MAISU_YO% = 5      '伝票枚数　予定
...
Private Const ColHIN_NAI% = 16           '品番（内部）
...
Dim sts As Integer
    ...
    For i = 0 To UBound(JGYOBU_T)
        ...
        If JGYOBU_T(i).CODE = Last_JGYOBU Then
            F1030621.Caption = "「過日分」出荷確認（" + RTrim(JGYOBU_T(i).NAME) + ")"
...
Dim i As Integer
    ...
    Next i
                                    '事業部切り替え
    F1030621.Caption = "「過日分」出荷確認（" + RTrim(JGYOBU_T(Index).NAME) + ")"
...
''com = BtOpGetFirst
    Do
        ...
        Else
            If (Text(ptxSyuka_YY).Text & Text(ptxSyuka_MM).Text & Text(ptxSyuka_DD).Text) <> StrConv(DEL_SYUREC.SYUKA_YMD, vbUnicode) Then
                Skip_Flg = True
            End If
        End If
...
'    Call Input_Lock
    ...
    Do
        ...
        If Not Skip_Flg Then
            Select Case StrConv(DEL_SYUREC.CYU_KBN, vbUnicode)
                Case CYU_KBN_TUK
...
If StrConv(DEL_SYUREC.SYUKA_YMD, vbUnicode) >= "20110401" And StrConv(DEL_SYUREC.SYUKA_YMD, vbUnicode) <= "20110630" Then
    If Trim(StrConv(DEL_SYUREC.HIN_NO, vbUnicode)) = "ABA83-159" Then
...
End If
            ...
            Write #FileNo, StrConv(DEL_SYUREC.JGYOBU, vbUnicode), StrConv(DEL_SYUREC.HIN_NO, vbUnicode), StrConv(DEL_SYUREC.SYUKA_YMD, vbUnicode), StrConv(DEL_SYUREC.CYU_KBN, vbUnicode), StrConv(DEL_SYUREC.MUKE_CODE, vbUnicode), StrConv(DEL_SYUREC.SS_CODE, vbUnicode), StrConv(DEL_SYUREC.JITU_SURYO, vbUnicode),
            Write #FileNo,
        End If
        com = BtOpGetNext
...
'----------------------------------------------------------------------------
    ...
    F1030621.MousePointer = vbHourglass

    Call Ctrl_Lock(F1030621)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(F1030621)


    F1030621.MousePointer = vbDefault
...
Dim sts As Integer
    ...
    SYUKA(Row, ColSYUKO_SYUSI) = StrConv(DEL_SYUREC.SYUKO_SYUSI, vbUnicode)   '出庫収支
