...
Begin VB.Form F1030631 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(68)=   "Column(13)._WidthInPix=1191"
      Splits(0)._ColumnProps(69)=   "Column(13)._ColStyle=514"
      Splits(0)._ColumnProps(70)=   "Column(13).Order=14"
      Splits(0)._ColumnProps(71)=   "Column(14).Width=2461"
      Splits(0)._ColumnProps(72)=   "Column(14).DividerColor=0"
      Splits(0)._ColumnProps(73)=   "Column(14)._WidthInPix=2355"
      Splits(0)._ColumnProps(74)=   "Column(14)._ColStyle=512"
      Splits(0)._ColumnProps(75)=   "Column(14).Order=15"
      Splits(0)._ColumnProps(76)=   "Column(15).Width=1640"
      Splits(0)._ColumnProps(77)=   "Column(15).DividerColor=0"
      Splits(0)._ColumnProps(78)=   "Column(15)._WidthInPix=1535"
      Splits(0)._ColumnProps(79)=   "Column(15)._ColStyle=1"
      Splits(0)._ColumnProps(80)=   "Column(15).Order=16"
      Splits(0)._ColumnProps(81)=   "Column(16).Width=2408"
      Splits(0)._ColumnProps(82)=   "Column(16).DividerColor=0"
      Splits(0)._ColumnProps(83)=   "Column(16)._WidthInPix=2302"
      Splits(0)._ColumnProps(84)=   "Column(16)._ColStyle=516"
      Splits(0)._ColumnProps(85)=   "Column(16).Order=17"
      Splits(0)._ColumnProps(86)=   "Column(17).Width=1931"
      Splits(0)._ColumnProps(87)=   "Column(17).DividerColor=0"
      Splits(0)._ColumnProps(88)=   "Column(17)._WidthInPix=1826"
      Splits(0)._ColumnProps(89)=   "Column(17)._ColStyle=516"
      Splits(0)._ColumnProps(90)=   "Column(17).Order=18"
      Splits(0)._ColumnProps(91)=   "Column(18).Width=1746"
      Splits(0)._ColumnProps(92)=   "Column(18).DividerColor=0"
      Splits(0)._ColumnProps(93)=   "Column(18)._WidthInPix=1640"
      Splits(0)._ColumnProps(94)=   "Column(18)._ColStyle=516"
      Splits(0)._ColumnProps(95)=   "Column(18).Order=19"
      Splits(0)._ColumnProps(96)=   "Column(19).Width=1931"
      Splits(0)._ColumnProps(97)=   "Column(19).DividerColor=0"
      Splits(0)._ColumnProps(98)=   "Column(19)._WidthInPix=1826"
      Splits(0)._ColumnProps(99)=   "Column(19)._ColStyle=516"
      Splits(0)._ColumnProps(100)=   "Column(19).Order=20"
      Splits(0)._ColumnProps(101)=   "Column(20).Width=2514"
      Splits(0)._ColumnProps(102)=   "Column(20).DividerColor=0"
      Splits(0)._ColumnProps(103)=   "Column(20)._WidthInPix=2408"
      Splits(0)._ColumnProps(104)=   "Column(20)._ColStyle=516"
      Splits(0)._ColumnProps(105)=   "Column(20).Order=21"
      Splits(0)._ColumnProps(106)=   "Column(21).Width=3810"
      Splits(0)._ColumnProps(107)=   "Column(21).DividerColor=0"
      Splits(0)._ColumnProps(108)=   "Column(21)._WidthInPix=3704"
      Splits(0)._ColumnProps(109)=   "Column(21)._ColStyle=516"
      Splits(0)._ColumnProps(110)=   "Column(21).Visible=0"
      Splits(0)._ColumnProps(111)=   "Column(21).Order=22"
      Splits(0)._ColumnProps(112)=   "Column(22).Width=4366"
      Splits(0)._ColumnProps(113)=   "Column(22).DividerColor=0"
      Splits(0)._ColumnProps(114)=   "Column(22)._WidthInPix=4260"
      Splits(0)._ColumnProps(115)=   "Column(22)._ColStyle=516"
      Splits(0)._ColumnProps(116)=   "Column(22).Order=23"
      Splits(0)._ColumnProps(117)=   "Column(23).Width=2170"
      Splits(0)._ColumnProps(118)=   "Column(23).DividerColor=0"
      Splits(0)._ColumnProps(119)=   "Column(23)._WidthInPix=2064"
      Splits(0)._ColumnProps(120)=   "Column(23)._ColStyle=513"
      Splits(0)._ColumnProps(121)=   "Column(23).Order=24"
      Splits(0)._ColumnProps(122)=   "Column(24).Width=1217"
      Splits(0)._ColumnProps(123)=   "Column(24).DividerColor=0"
      Splits(0)._ColumnProps(124)=   "Column(24)._WidthInPix=1111"
      Splits(0)._ColumnProps(125)=   "Column(24)._ColStyle=514"
      Splits(0)._ColumnProps(126)=   "Column(24).Order=25"
      Splits(0)._ColumnProps(127)=   "Column(25).Width=1217"
      Splits(0)._ColumnProps(128)=   "Column(25).DividerColor=0"
      Splits(0)._ColumnProps(129)=   "Column(25)._WidthInPix=1111"
      Splits(0)._ColumnProps(130)=   "Column(25)._ColStyle=516"
      Splits(0)._ColumnProps(131)=   "Column(25).Order=26"
      Splits(0)._ColumnProps(132)=   "Column(26).Width=2381"
      Splits(0)._ColumnProps(133)=   "Column(26).DividerColor=0"
      Splits(0)._ColumnProps(134)=   "Column(26)._WidthInPix=2275"
      Splits(0)._ColumnProps(135)=   "Column(26)._ColStyle=514"
      Splits(0)._ColumnProps(136)=   "Column(26).Order=27"
      Splits(0)._ColumnProps(137)=   "Column(27).Width=3810"
      Splits(0)._ColumnProps(138)=   "Column(27).DividerColor=0"
      Splits(0)._ColumnProps(139)=   "Column(27)._WidthInPix=3704"
      Splits(0)._ColumnProps(140)=   "Column(27)._ColStyle=516"
      Splits(0)._ColumnProps(141)=   "Column(27).Order=28"
      Splits(0)._ColumnProps(142)=   "Column(28).Width=1455"
      Splits(0)._ColumnProps(143)=   "Column(28).DividerColor=0"
      Splits(0)._ColumnProps(144)=   "Column(28)._WidthInPix=1349"
      Splits(0)._ColumnProps(145)=   "Column(28)._ColStyle=514"
      Splits(0)._ColumnProps(146)=   "Column(28).Order=29"
      Splits(0)._ColumnProps(147)=   "Column(29).Width=3810"
      Splits(0)._ColumnProps(148)=   "Column(29).DividerColor=0"
      Splits(0)._ColumnProps(149)=   "Column(29)._WidthInPix=3704"
      Splits(0)._ColumnProps(150)=   "Column(29)._ColStyle=516"
      Splits(0)._ColumnProps(151)=   "Column(29).Order=30"
      Splits(0)._ColumnProps(152)=   "Column(30).Width=3810"
      Splits(0)._ColumnProps(153)=   "Column(30).DividerColor=0"
      Splits(0)._ColumnProps(154)=   "Column(30)._WidthInPix=3704"
      Splits(0)._ColumnProps(155)=   "Column(30)._ColStyle=516"
      Splits(0)._ColumnProps(156)=   "Column(30).Order=31"
      Splits(0)._ColumnProps(157)=   "Column(31).Width=3810"
      Splits(0)._ColumnProps(158)=   "Column(31).DividerColor=0"
      Splits(0)._ColumnProps(159)=   "Column(31)._WidthInPix=3704"
      Splits(0)._ColumnProps(160)=   "Column(31)._ColStyle=516"
      Splits(0)._ColumnProps(161)=   "Column(31).Order=32"
      Splits(0)._ColumnProps(162)=   "Column(32).Width=1746"
      Splits(0)._ColumnProps(163)=   "Column(32).DividerColor=0"
      Splits(0)._ColumnProps(164)=   "Column(32)._WidthInPix=1640"
      Splits(0)._ColumnProps(165)=   "Column(32)._ColStyle=516"
      Splits(0)._ColumnProps(166)=   "Column(32).Order=33"
      Splits(0)._ColumnProps(167)=   "Column(33).Width=2328"
      Splits(0)._ColumnProps(168)=   "Column(33).DividerColor=0"
      Splits(0)._ColumnProps(169)=   "Column(33)._WidthInPix=2223"
      Splits(0)._ColumnProps(170)=   "Column(33)._ColStyle=516"
      Splits(0)._ColumnProps(171)=   "Column(33).Order=34"
      Splits(0)._ColumnProps(172)=   "Column(34).Width=2037"
      Splits(0)._ColumnProps(173)=   "Column(34).DividerColor=0"
      Splits(0)._ColumnProps(174)=   "Column(34)._WidthInPix=1931"
      Splits(0)._ColumnProps(175)=   "Column(34)._ColStyle=516"
      Splits(0)._ColumnProps(176)=   "Column(34).Order=35"
      Splits(0)._ColumnProps(177)=   "Column(35).Width=3810"
      Splits(0)._ColumnProps(178)=   "Column(35).DividerColor=0"
      Splits(0)._ColumnProps(179)=   "Column(35)._WidthInPix=3704"
      Splits(0)._ColumnProps(180)=   "Column(35)._ColStyle=516"
      Splits(0)._ColumnProps(181)=   "Column(35).Visible=0"
      Splits(0)._ColumnProps(182)=   "Column(35).Order=36"
      Splits(0)._ColumnProps(183)=   "Column(36).Width=3810"
      Splits(0)._ColumnProps(184)=   "Column(36).DividerColor=0"
      Splits(0)._ColumnProps(185)=   "Column(36)._WidthInPix=3704"
      Splits(0)._ColumnProps(186)=   "Column(36)._ColStyle=516"
      Splits(0)._ColumnProps(187)=   "Column(36).Visible=0"
      Splits(0)._ColumnProps(188)=   "Column(36).Order=37"
      Splits(0)._ColumnProps(189)=   "Column(37).Width=3810"
      Splits(0)._ColumnProps(190)=   "Column(37).DividerColor=0"
      Splits(0)._ColumnProps(191)=   "Column(37)._WidthInPix=3704"
      Splits(0)._ColumnProps(192)=   "Column(37)._ColStyle=516"
      Splits(0)._ColumnProps(193)=   "Column(37).Order=38"
      Splits.Count    =   1
      ...
      _StyleDefs(84)  =   "Splits(0).Columns(12).Style:id=86,.parent=53,.alignment=1"
      _StyleDefs(85)  =   "Splits(0).Columns(12).HeadingStyle:id=83,.parent=54"
      _StyleDefs(86)  =   "Splits(0).Columns(12).FooterStyle:id=84,.parent=55"
      ...
      _StyleDefs(96)  =   "Splits(0).Columns(15).Style:id=24,.parent=53,.alignment=2,.locked=0"
      ...
      _StyleDefs(184) =   "Splits(0).Columns(37).Style:id=186,.parent=53"
      _StyleDefs(185) =   "Splits(0).Columns(37).HeadingStyle:id=183,.parent=54"
      _StyleDefs(186) =   "Splits(0).Columns(37).FooterStyle:id=184,.parent=55"
      _StyleDefs(187) =   "Splits(0).Columns(37).EditorStyle:id=185,.parent=57"
      _StyleDefs(188) =   "Named:id=29:Normal"
      _StyleDefs(189) =   ":id=29,.parent=0"
      _StyleDefs(190) =   "Named:id=30:Heading"
      _StyleDefs(191) =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(192) =   ":id=30,.wraptext=-1"
      _StyleDefs(193) =   "Named:id=31:Footing"
      _StyleDefs(194) =   ":id=31,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(195) =   "Named:id=32:Selected"
      _StyleDefs(196) =   ":id=32,.parent=29,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(197) =   "Named:id=33:Caption"
      _StyleDefs(198) =   ":id=33,.parent=30,.alignment=2"
      _StyleDefs(199) =   "Named:id=34:HighlightRow"
      _StyleDefs(200) =   ":id=34,.parent=29,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
      _StyleDefs(201) =   "Named:id=35:EvenRow"
      _StyleDefs(202) =   ":id=35,.parent=29,.bgcolor=&HFFFF00&"
      _StyleDefs(203) =   "Named:id=36:OddRow"
      _StyleDefs(204) =   ":id=36,.parent=29"
      _StyleDefs(205) =   "Named:id=89:RecordSelector"
      _StyleDefs(206) =   ":id=89,.parent=30"
      _StyleDefs(207) =   "Named:id=92:FilterBar"
      _StyleDefs(208) =   ":id=92,.parent=29"
   End
...
Private Const Max_Col% = 37                 '最大列数       2011.04.23  -->2014.05.19 37
...
Private Const ColINS_NOW% = 37              'データ取込み日時   2014.05.19
...
'2010.08.31
Private Sort_Tbl(ColOKURI_NO To ColINS_NOW) _
...
'Private Const LAST_UPDATE_DAY$ = "[F103063] 2018.01.12 10:00"
Private Const LAST_UPDATE_DAY$ = "[F103063] 2018.01.16 16:30"
...
'>>>>>> 2018.01.16
'                If Not IsDate(Text(ptxSEL_SYUKA_YY).Text & "/" & Text(ptxSEL_SYUKA_MM).Text & "/" & Text(ptxSEL_SYUKA_DD).Text) Then
'                    MsgBox "出荷日を正しく入力して下さい。"
'                    Text(ptxSEL_SYUKA_YY).SetFocus
'                    Exit Sub
'                End If
'>>>>>> 2018.01.16
...
'            If SDC_FLD_GET("SYS", App.EXEName, GW_PATH) Then           '2016.01.20
            If SDC_FLD_GET(App.EXEName, App.EXEName, GW_PATH) Then      '2016.01.20
'                Unload Me                                              '2016.01.20
            End If
...
Dim wkUNSOU_KAISHA  As Variant      '2014.05.15
    ...
    'ステータスウィンドウを作成する     2015.01.20
    hStatusWnd = CreateStatusWindow(WS_VISIBLE Or WS_CHILD Or CCS_BOTTOM Or SBARS_SIZEGRIP, _
        "出荷問い合わせ(問合せ№)", Me.hwnd, 0)
    '最後の要素を-1にすると
    '親ウィンドウの全体の幅の残りの幅を
    '自動的に割り当てる
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>    2016.01.20 SYS.INI--> F103063.INI
...
Call LOG_OUT(LOG_F, F1030631.Caption & "START")           '2014.07.22
...
'    If GetIni(App.EXEName, "KEN_LOGISTIC", "SYS", c) Then
    If GetIni(App.EXEName, "KEN_LOGISTIC", App.EXEName, c) Then
        KEN_LOGISTIC_CD = "*"
    Else
...
Call LOG_OUT(LOG_F, F1030631.Caption & "END")           '2014.07.22
...
Dim Seq_No_To   As String
    ...
    Select Case sts
        ...
        Case Else
            ...
            Exit Function
    End Select
'    SYUKA(Row, ColHIN_NO) = Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 12) & " " & Trim(StrConv(ITEMREC.HIN_NAME, vbUnicode))     '2014.10.17
    SYUKA(Row, ColHIN_NO) = Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 13) & " " & Trim(StrConv(ITEMREC.HIN_NAME, vbUnicode))      '2014.10.17
    '数量
    ...
    '2014.05.19
    SYUKA(Row, ColINS_NOW) = StrConv(Y_SYU_HREC.INS_NOW, vbUnicode)
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  2014.05.15
    ...
    Set TDBGrid1.Array = SYUKA      '2017.11.22
    TDBGrid1.Refresh                '2017.11.22
    TDBGrid1.Update                 '2017.11.22
...
Dim com         As Integer
    ...
    Select Case sts
        ...
        Case Else
            ...
            Exit Function
    End Select
'    Write #FileNo, "*" & Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 12) & "*";        '2014.10.17
'    Write #FileNo, "*" & Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 13) & "*";         '2014.10.17
    Write #FileNo, Trim(Left(StrConv(Y_SYU_HREC.HIN_NO, vbUnicode), 13)),                '2018.01.04
...
hStatusWnd = CreateStatusWindow(WS_VISIBLE Or WS_CHILD Or CCS_BOTTOM Or SBARS_SIZEGRIP, _
    "出荷問い合わせ(問合せ№)　[検索]処理終了！！" & "  検索結果..." & Row & "件", Me.hwnd, 0)
...
Dim yn      As Integer      '2107.11.22
Dim mesg    As String       '2017.11.22
    
Dim SKIP_F  As Boolean  '2014.05.19
...
'                        MsgBox "他端末で内容が変更されています。最新表示を行ってください。"
                        MsgBox "他端末で内容が変更されたか、もしくは過去データを指定しています。キャンセル出来ません。"
                        Update_Proc = False
                        GoTo Abort_Tran
...
'2014.05.19                            Exit Do
                ...
                If sts = BtNoErr Then
                    ...
                    '>>>>>>>>>>>>   2016.10.28
'                    If Trim(SYUKA(i, ColUNSOU_KAISHA)) <> Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) Or _       '2017.11.22
'                        Trim(SYUKA(i, ColINPUT_BIKOU)) <> Trim(StrConv(Y_SYU_HREC.INPUT_BIKOU, vbUnicode)) Then        '2017.11.22
                    If Trim(SYUKA(i, ColINPUT_BIKOU)) <> Trim(StrConv(Y_SYU_HREC.INPUT_BIKOU, vbUnicode)) Then          '2017.11.22
...
'                    '問合せ№   2014.05.15-->204.05.19 DEL
'                    Call UniCode_Conv(Y_SYU_HREC.OKURI_NO, SYUKA(i, ColOKURI_NO))
                    '運送会社   2014.05.15
                    
'>>>>>>>>>>>>>>>>>  2017.11.22
                    If Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) = "福山通運" Then
                        If Trim(SYUKA(i, ColUNSOU_KAISHA)) <> Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) Then
                        ...
                        End If
                    Else
                        If Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) <> Trim(SYUKA(i, ColUNSOU_KAISHA)) Then
                            
                            mesg = "伝票№:[" & Trim(SYUKA(i, ColDEN_NO)) & "]" & Chr(13) & Chr(10) & Chr(13) & Chr(10)
                            mesg = mesg & "運送会社変更：" & Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) & "→" & Trim(SYUKA(i, ColUNSOU_KAISHA)) & Chr(13) & Chr(10) & Chr(13) & Chr(10)
                            mesg = mesg & "更新しますか？" & Chr(13) & Chr(10) & Chr(13) & Chr(10)
                            
                            
                            
                            'mesg = mesg & "データ(Y_SYUKA_H):[" & Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) & "]" & Chr(13) & Chr(10)
                            'mesg = mesg & "画面:[" & Trim(SYUKA(i, ColUNSOU_KAISHA)) & "]" & Chr(13) & Chr(10)
                            'mesg = mesg & "[" & i & "]行目　運送会社がデータ(Y_SYUKA_H)と画面上で違いますか更新しますか？"
...
'>>>>>>>>>>>>>>>>>  2017.11.22
                ...
                End If
            Next i
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   過去データの更新追加    2014.05.19
            If List_Update_Proc Then
                GoTo Abort_Tran
            End If
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>   過去データの更新追加    2014.05.19
    End Select
...
End Function
Private Function List_Update_Proc() As Integer
'----------------------------------------------------------------------------
'                   出荷予定(過日分)更新処理    2014.05.19
'----------------------------------------------------------------------------
Dim sts As Integer
Dim ans As Integer
Dim i   As Integer
...
Dim SKIP_FLG    As Boolean
    ...
    List_Update_Proc = True
                                        
    For i = 1 To SYUKA.UpperBound(1)
        '出荷予定の読み込み
        Call UniCode_Conv(K4_DEL_SYU_H.ID_NO, SYUKA(i, ColID_NO))     'ID№
                
                
If SYUKA(i, ColID_NO) = "075977901" Then
Debug.Print
End If
        ...
        Do
            ...
            Do
                DoEvents
                sts = BTRV(com + BtSNoWait, DEL_SYU_H_POS, Y_SYU_HREC, Len(Y_SYU_HREC), K4_DEL_SYU_H, Len(K4_DEL_SYU_H), 4)
                Select Case sts
                    Case BtNoErr
                        
                        
                        
                        If Trim(StrConv(Y_SYU_HREC.ID_NO, vbUnicode)) <> Trim(SYUKA(i, ColID_NO)) Then
                            
                            
                            sts = BTRV(BtOpUnlock, DEL_SYU_H_POS, Y_SYU_HREC, Len(Y_SYU_HREC), K4_DEL_SYU_H, Len(K4_DEL_SYU_H), 4)
                            Select Case sts
                                Case BtNoErr
                                Case Else
                                    Call File_Error(sts, BtOpUnlock, "出荷予定(ﾎｽﾄｲﾒｰｼﾞ)")
                                    Exit Function
                            End Select
                            EOF_FLG = True
                        ...
                        If SKIP_FLG Then
                        Else
                            If Trim(StrConv(Y_SYU_HREC.INS_NOW, vbUnicode)) = Trim(SYUKA(i, ColINS_NOW)) Then
                                Exit Do
                            End If
                        End If
                    Case BtErrEOF
            ...
            '>>>>>>>>>>>>   2016.10.28
            If Trim(SYUKA(i, ColUNSOU_KAISHA)) <> Trim(StrConv(Y_SYU_HREC.UNSOU_KAISHA, vbUnicode)) Or _
                Trim(SYUKA(i, ColINPUT_BIKOU)) <> Trim(StrConv(Y_SYU_HREC.INPUT_BIKOU, vbUnicode)) Then
            ...
            '出荷予定書込み
            Do
                sts = BTRV(BtOpUpdate, DEL_SYU_H_POS, Y_SYU_HREC, Len(Y_SYU_HREC), K4_DEL_SYU_H, Len(K4_DEL_SYU_H), 4)
                Select Case sts
                    Case BtNoErr
                        Exit Do
                    Case BtErrFILE_INUSE, BtErrRECORD_INUSE
...
Private Function DEL_SYU_Update_Proc() As Integer
'----------------------------------------------------------------------------
'                   データ検索単位の更新    2014.05.19
'----------------------------------------------------------------------------
...
Private Sub Text_LostFocus(Index As Integer)
    If Index = 0 Or Index = ptxSEL_HIN_NO Then
