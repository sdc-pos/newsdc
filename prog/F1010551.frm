...
Begin VB.Form F1010551 
   Caption         =   "[美的品番管理]美的品番データメンテナンス([F101055] 2013.12.09 15:30"
   ClientHeight    =   12345
   ClientLeft      =   2025
   ClientTop       =   2325
   ClientWidth     =   16875
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Columns(6).Caption=   "追加担当者"
      Columns(6).DataField=   ""
      Columns(6)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(7)._VlistStyle=   0
      Columns(7)._MaxComboItems=   5
      Columns(7).Caption=   "追加日時"
      Columns(7).DataField=   ""
      Columns(7)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(8)._VlistStyle=   0
      Columns(8)._MaxComboItems=   5
      Columns(8).Caption=   "更新担当者"
      Columns(8).DataField=   ""
      Columns(8)._PropDict=   "_MaxComboItems,516,2;_VlistStyle,514,3"
      Columns(9)._VlistStyle=   0
      Columns(9)._MaxComboItems=   5
      Columns(9).Caption=   "更新日時"
      Columns(9).DataField=   ""
      ...
      Splits(0)._ColumnProps(16)=   "Column(3).Width=4366"
      Splits(0)._ColumnProps(17)=   "Column(3).DividerColor=0"
      Splits(0)._ColumnProps(18)=   "Column(3)._WidthInPix=4233"
      Splits(0)._ColumnProps(19)=   "Column(3).Order=4"
      Splits(0)._ColumnProps(20)=   "Column(4).Width=6535"
      Splits(0)._ColumnProps(21)=   "Column(4).DividerColor=0"
      Splits(0)._ColumnProps(22)=   "Column(4)._WidthInPix=6403"
      Splits(0)._ColumnProps(23)=   "Column(4).Order=5"
      Splits(0)._ColumnProps(24)=   "Column(5).Width=15187"
      Splits(0)._ColumnProps(25)=   "Column(5).DividerColor=0"
      Splits(0)._ColumnProps(26)=   "Column(5)._WidthInPix=15055"
      ...
      Splits(0)._ColumnProps(32)=   "Column(6)._ColStyle=8196"
      Splits(0)._ColumnProps(33)=   "Column(6).AllowFocus=0"
      Splits(0)._ColumnProps(34)=   "Column(6).Order=7"
      Splits(0)._ColumnProps(35)=   "Column(7).Width=2910"
      Splits(0)._ColumnProps(36)=   "Column(7).DividerColor=0"
      Splits(0)._ColumnProps(37)=   "Column(7)._WidthInPix=2778"
      Splits(0)._ColumnProps(38)=   "Column(7)._ColStyle=8196"
      Splits(0)._ColumnProps(39)=   "Column(7).AllowFocus=0"
      Splits(0)._ColumnProps(40)=   "Column(7).Order=8"
      Splits(0)._ColumnProps(41)=   "Column(8).Width=2910"
      Splits(0)._ColumnProps(42)=   "Column(8).DividerColor=0"
      Splits(0)._ColumnProps(43)=   "Column(8)._WidthInPix=2778"
      Splits(0)._ColumnProps(44)=   "Column(8)._ColStyle=8196"
      ...
      Splits(0)._ColumnProps(50)=   "Column(9)._ColStyle=8196"
      Splits(0)._ColumnProps(51)=   "Column(9).AllowFocus=0"
      ...
      _StyleDefs(40)  =   ":id=28,.fontname=ＭＳ ゴシック"
      ...
      _StyleDefs(52)  =   "Splits(0).Columns(3).Style:id=62,.parent=43"
      _StyleDefs(53)  =   "Splits(0).Columns(3).HeadingStyle:id=59,.parent=44"
      _StyleDefs(54)  =   "Splits(0).Columns(3).FooterStyle:id=60,.parent=45"
      _StyleDefs(55)  =   "Splits(0).Columns(3).EditorStyle:id=61,.parent=47"
      _StyleDefs(56)  =   "Splits(0).Columns(4).Style:id=66,.parent=43"
      _StyleDefs(57)  =   "Splits(0).Columns(4).HeadingStyle:id=63,.parent=44"
      _StyleDefs(58)  =   "Splits(0).Columns(4).FooterStyle:id=64,.parent=45"
      _StyleDefs(59)  =   "Splits(0).Columns(4).EditorStyle:id=65,.parent=47"
      _StyleDefs(60)  =   "Splits(0).Columns(5).Style:id=20,.parent=43,.alignment=0"
      _StyleDefs(61)  =   "Splits(0).Columns(5).HeadingStyle:id=17,.parent=44"
      _StyleDefs(62)  =   "Splits(0).Columns(5).FooterStyle:id=18,.parent=45"
      _StyleDefs(63)  =   "Splits(0).Columns(5).EditorStyle:id=19,.parent=47"
      _StyleDefs(64)  =   "Splits(0).Columns(6).Style:id=32,.parent=43,.bgcolor=&HC0C0C0&,.locked=-1"
      _StyleDefs(65)  =   "Splits(0).Columns(6).HeadingStyle:id=29,.parent=44"
      _StyleDefs(66)  =   "Splits(0).Columns(6).FooterStyle:id=30,.parent=45"
      _StyleDefs(67)  =   "Splits(0).Columns(6).EditorStyle:id=31,.parent=47"
      _StyleDefs(68)  =   "Splits(0).Columns(7).Style:id=78,.parent=43,.bgcolor=&HC0C0C0&,.locked=-1"
      _StyleDefs(69)  =   "Splits(0).Columns(7).HeadingStyle:id=75,.parent=44"
      _StyleDefs(70)  =   "Splits(0).Columns(7).FooterStyle:id=76,.parent=45"
      _StyleDefs(71)  =   "Splits(0).Columns(7).EditorStyle:id=77,.parent=47"
      _StyleDefs(72)  =   "Splits(0).Columns(8).Style:id=86,.parent=43,.bgcolor=&HC0C0C0&,.locked=-1"
      _StyleDefs(73)  =   "Splits(0).Columns(8).HeadingStyle:id=83,.parent=44"
      _StyleDefs(74)  =   "Splits(0).Columns(8).FooterStyle:id=84,.parent=45"
      _StyleDefs(75)  =   "Splits(0).Columns(8).EditorStyle:id=85,.parent=47"
      _StyleDefs(76)  =   "Splits(0).Columns(9).Style:id=16,.parent=43,.bgcolor=&HC0C0C0&,.locked=-1"
      _StyleDefs(77)  =   "Splits(0).Columns(9).HeadingStyle:id=13,.parent=44"
      _StyleDefs(78)  =   "Splits(0).Columns(9).FooterStyle:id=14,.parent=45"
      _StyleDefs(79)  =   "Splits(0).Columns(9).EditorStyle:id=15,.parent=47"
...
Private Const ptxDisp_Cnt% = 4          '最大表示件数
...
Private Const ColINS_TANTO% = 6         '追加担当
Private Const ColINS_DateTime% = 7      '追加日時

Private Const ColUPD_TANTO% = 8         '更新担当
Private Const ColUPD_DateTime% = 9      '更新日時


Private DEF_NAIGAI  As String * 1       'ﾃﾞﾌｫﾙﾄ国内外

Private Disp_Set_Flg    As Boolean
...
'2013.12.09    If Error_Check_Proc(Index) Then     'エラーチェック
'2013.12.09        Exit Sub
'2013.12.09    End If
        
'2013.12.09    Command1(2).Value = True
    Call Tab_Ctrl(Shift)        '移動           '2013.12.09
...
Dim yn  As Integer
Dim i   As Integer
Dim saveBookMark    As Long         '2013.12.09
    ...
    Select Case Index
        ...
        Case 0
            ...
            If Trim(Text1(ptxHin_Gai).Text) = "" And _
                Trim(Text1(ptxB_Hin_Code).Text) = "" Then
                
                If List_Disp_Proc_Hin_Gai() Then
                    Unload Me
                End If
            Else
        
                If Text1(ptxHin_Gai).Text <> "" Then
                    If List_Disp_Proc_Hin_Gai() Then
                        Unload Me
                    End If
                Else
                    If List_Disp_Proc_B_Hin_Code() Then
                        Unload Me
                    End If
                End If
            End If
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "編集書き込み処理　開始")
       ...
       '         saveBookMark = TDBGrid1.Bookmark        '2013.12.09
       ...
       '         If saveBookMark >= 0 Then               '2013.12.09
       '              TDBGrid1.Bookmark = saveBookMark   '2013.12.09
       '         End If                                  '2013.12.09
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "画面印刷　開始")            '2013.12.09
            
            Call Input_Lock                                                 '2013.12.09
            
            
            Call Form_HCopy_Win7(Picture1, vbPRPSA4, vbPRORLandscape)       '2013.12.09

            Call Input_UnLock                                               '2013.12.09

Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "画面印刷　終了")            '2013.12.09
...
'    cc.dwICC = ICC_BAR_CLASSES
    ...
    hStatusWnd = CreateStatusWindow(WS_VISIBLE Or WS_CHILD Or CCS_BOTTOM Or SBARS_SIZEGRIP, _
        "[美的品番管理]美的品番データメンテナンス", Me.hwnd, 0)
    '最後の要素を-1にすると
    '親ウィンドウの全体の幅の残りの幅を
    '自動的に割り当てる
    ...
    Else
        Text1(ptxDisp_Cnt).Text = Val(Trim(c))
    End If
                                
                                
    If Val(Trim(Text1(ptxDisp_Cnt).Text)) <= 0 Then
        MsgBox "最大表示件数を確認して下さい。"
    End If
...
Dim yn  As Integer
    ...
    If WriteIni(App.EXEName, "LISTMAX", App.EXEName, Format(Val(Text1(ptxDisp_Cnt).Text), 0)) Then
        Beep
        MsgBox ("INIファイルの書き込みに失敗しました。" & "LISTMAX")
        Unload Me
    End If
    ...
    End
End Sub
Private Function List_Disp_Proc_Hin_Gai() As Integer
'----------------------------------------------------------------------------
'                   データ内容の表示
'----------------------------------------------------------------------------
...
Dim Disp_Cnt    As Long
    
    
    List_Disp_Proc_Hin_Gai = True
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "検索処理　開始")
    ...
    Do
        ...
        Select Case sts
            Case BtNoErr
                If Last_JGYOBU <> StrConv(ITEMREC.JGYOBU, vbUnicode) Then
                    Exit Do
                End If
            
                If Trim(Text1(ptxHin_Gai).Text) <> "" Then
                    If Trim(Text1(ptxHin_Gai).Text) <> Mid(StrConv(ITEMREC.HIN_GAI, vbUnicode), 1, Len(Text1(ptxHin_Gai).Text)) Then
                        Exit Do
                    End If
                End If
                ...
                If Disp_Cnt > Val(Text1(ptxDisp_Cnt).Text) Then
                    Exit Do
                End If
            ...
            Case Else
                ...
                List_Disp_Proc_Hin_Gai = SYS_ERR
                Exit Function
        End Select
        ...
        Select Case sts
            ...
            Case BtErrKeyNotFound
                ...
                Call UniCode_Conv(B_ITEMREC.INS_TANTO, "")
                Call UniCode_Conv(B_ITEMREC.Ins_DateTime, "")
                Call UniCode_Conv(B_ITEMREC.UPD_TANTO, "")
                Call UniCode_Conv(B_ITEMREC.UPD_DATETIME, "")
            
            Case Else
                Call File_Error(sts, BtOpGetEqual, "美的品番管理ﾃﾞｰﾀ")
                List_Disp_Proc_Hin_Gai = SYS_ERR
                Exit Function
        End Select
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "検索処理　終了")
    ...
    List_Disp_Proc_Hin_Gai = False

    
End Function


Private Function List_Disp_Proc_B_Hin_Code() As Integer
'----------------------------------------------------------------------------
'                   データ内容の表示
'----------------------------------------------------------------------------
...
Dim Disp_Cnt    As Long
    ...
    List_Disp_Proc_B_Hin_Code = True
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "検索処理　開始")
    ...
    Last_JGYOBU = Right(Combo1(pcmbJGYOBU).Text, 1)
                        '美的品番管理ﾃﾞｰﾀ読み込み開始
    Call UniCode_Conv(K1_B_ITEM.B_HIN_CODE, Text1(ptxB_Hin_Code).Text)
    ...
    Do
        ...
        sts = BTRV(com, B_ITEM_POS, B_ITEMREC, Len(B_ITEMREC), K1_B_ITEM, Len(K1_B_ITEM), 1)
        Select Case sts
            Case BtNoErr
            
                If Trim(Text1(ptxB_Hin_Code).Text) <> "" Then
                    If Trim(Text1(ptxB_Hin_Code).Text) <> Mid(StrConv(B_ITEMREC.B_HIN_CODE, vbUnicode), 1, Len(Text1(ptxB_Hin_Code).Text)) Then
                        Exit Do
                    End If
                End If
            ...
            Case Else
                ...
                List_Disp_Proc_B_Hin_Code = SYS_ERR
                Exit Function
        End Select
...
Call SendMessageStr(hStatusWnd, SB_SETTEXT, 0, "検索処理　終了")
    ...
    List_Disp_Proc_B_Hin_Code = False
...
Dim wkDateTime  As String * 14
    ...
    '事業部
    B_ITEM(Row, ColJGYOBU) = StrConv(ITEMREC.JGYOBU, vbUnicode)
    '国内外
    B_ITEM(Row, ColNAIGAI) = StrConv(ITEMREC.NAIGAI, vbUnicode)
    '対外品番
    B_ITEM(Row, ColHIN_GAI) = RTrim(StrConv(ITEMREC.HIN_GAI, vbUnicode))
    '品名
    ...
    If Trim(B_ITEM(Row, ColINS_DateTime)) <> "" Then
        wkDateTime = StrConv(B_ITEMREC.Ins_DateTime, vbUnicode)
        B_ITEM(Row, ColINS_DateTime) = Mid(wkDateTime, 1, 4) & "/" & Mid(wkDateTime, 5, 2) & "/" & Mid(wkDateTime, 7, 2) & " " & Mid(wkDateTime, 9, 2) & ":" & Mid(wkDateTime, 11, 2) & ":" & Mid(wkDateTime, 13, 2)
    End If
    ...
    If Trim(B_ITEM(Row, ColUPD_DateTime)) <> "" Then
        wkDateTime = StrConv(B_ITEMREC.UPD_DATETIME, vbUnicode)
        B_ITEM(Row, ColUPD_DateTime) = Mid(wkDateTime, 1, 4) & "/" & Mid(wkDateTime, 5, 2) & "/" & Mid(wkDateTime, 7, 2) & " " & Mid(wkDateTime, 9, 2) & ":" & Mid(wkDateTime, 11, 2) & ":" & Mid(wkDateTime, 13, 2)
    End If
...
'2013.12.09    TDBGrid1.Refresh
    ...
    For i = 1 To B_ITEM.Count(1)
        ...
        If RTrim(B_ITEM(i, ColHIN_GAI)) = "" Then
        Else
            ...
            Select Case sts
                Case BtNoErr
                    ...
                    '>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>    2013.12.09 品名変更を行う
                    If Trim(StrConv(ITEMREC.HIN_NAME, vbUnicode)) <> Trim(B_ITEM(i, ColHIN_NAME)) Then
                        Call UniCode_Conv(ITEMREC.HIN_NAME, B_ITEM(i, ColHIN_NAME))
                        ...
                        Select Case sts
                            ...
                            Case Else
                                ...
                                Call File_Error(sts, BtOpInsert, "品番ﾏｽﾀ")
                                Exit Function
                ...
                Case BtErrKeyNotFound
                    ...
                    Call UniCode_Conv(ITEMREC.NAIGAI, DEF_NAIGAI)
                    
                    Call UniCode_Conv(ITEMREC.HIN_GAI, B_ITEM(i, ColHIN_GAI))
                    Call UniCode_Conv(ITEMREC.HIN_NAME, B_ITEM(i, ColHIN_NAME))
                    ...
                    Call UniCode_Conv(ITEMREC.INS_TANTO, Text1(ptxTanto_Code).Text)
                    Call UniCode_Conv(ITEMREC.Ins_DateTime, Format(Now, "YYYYMMDDHHMMSS"))
                ...
                Case Else
                    Call File_Error(sts, BtOpGetEqual, "品番ﾏｽﾀ")
                    Exit Function
            End Select
...
'2013.12.09    TDBGrid1.Refresh
    ...
    Select Case ColIndex
        ...
        Case ColHIN_GAI               '対外品番
            ...
            B_ITEM(TDBGrid1.Bookmark, ColHIN_GAI) = StrConv(B_ITEM(TDBGrid1.Bookmark, ColHIN_GAI), vbUpperCase)
...
'                    Exit Sub
                    ...
                    B_ITEM(TDBGrid1.Bookmark, ColHIN_NAME) = "※注意　品目未登録"
        ...
        Case ColB_HIN_CODE          '美的品番
            B_ITEM(TDBGrid1.Bookmark, ColB_HIN_CODE) = StrConv(B_ITEM(TDBGrid1.Bookmark, ColB_HIN_CODE), vbUpperCase)
    
    End Select


    Set TDBGrid1.Array = B_ITEM
'2013.12.09    TDBGrid1.ReBind
'    TDBGrid1.Refresh                '2013.12.09
    TDBGrid1.Update
    '2013.12.09TDBGrid1.ScrollBars = dbgAutomatic
    TDBGrid1.SetFocus
