...
Begin VB.Form F1030611 
   ...
   Begin TrueDBGrid80.TDBGrid TDBGrid1 
      ...
      Splits(0)._ColumnProps(74)=   "Column(17).Width=3810"
      Splits(0)._ColumnProps(75)=   "Column(17).DividerColor=0"
      Splits(0)._ColumnProps(76)=   "Column(17)._WidthInPix=3704"
      Splits(0)._ColumnProps(77)=   "Column(17).Order=18"
      Splits(0)._ColumnProps(78)=   "Column(18).Width=3810"
      Splits(0)._ColumnProps(79)=   "Column(18).DividerColor=0"
      Splits(0)._ColumnProps(80)=   "Column(18)._WidthInPix=3704"
      ...
      _StyleDefs(6)   =   "Style:id=1,.parent=0,.namedParent=29,.bold=0,.fontsize=1080,.italic=0"
      _StyleDefs(7)   =   ":id=1,.underline=0,.strikethrough=0,.charset=128"
      _StyleDefs(8)   =   ":id=1,.fontname=ＭＳ ゴシック"
      _StyleDefs(9)   =   "CaptionStyle:id=4,.parent=2,.namedParent=33"
      _StyleDefs(10)  =   "HeadingStyle:id=2,.parent=1,.namedParent=30,.bold=0,.fontsize=1080,.italic=0"
      _StyleDefs(11)  =   ":id=2,.underline=0,.strikethrough=0,.charset=128"
      _StyleDefs(12)  =   ":id=2,.fontname=ＭＳ ゴシック"
      _StyleDefs(13)  =   "FooterStyle:id=3,.parent=1,.namedParent=31,.bold=0,.fontsize=1080,.italic=0"
      ...
      _StyleDefs(104) =   "Splits(0).Columns(17).Style:id=106,.parent=53"
      _StyleDefs(105) =   "Splits(0).Columns(17).HeadingStyle:id=103,.parent=54"
      _StyleDefs(106) =   "Splits(0).Columns(17).FooterStyle:id=104,.parent=55"
      _StyleDefs(107) =   "Splits(0).Columns(17).EditorStyle:id=105,.parent=57"
      _StyleDefs(108) =   "Splits(0).Columns(18).Style:id=110,.parent=53"
      _StyleDefs(109) =   "Splits(0).Columns(18).HeadingStyle:id=107,.parent=54"
      _StyleDefs(110) =   "Splits(0).Columns(18).FooterStyle:id=108,.parent=55"
      _StyleDefs(111) =   "Splits(0).Columns(18).EditorStyle:id=109,.parent=57"
      _StyleDefs(112) =   "Named:id=29:Normal"
      _StyleDefs(113) =   ":id=29,.parent=0"
      _StyleDefs(114) =   "Named:id=30:Heading"
      _StyleDefs(115) =   ":id=30,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(116) =   ":id=30,.wraptext=-1"
      _StyleDefs(117) =   "Named:id=31:Footing"
      _StyleDefs(118) =   ":id=31,.parent=29,.valignment=2,.bgcolor=&H8000000F&,.fgcolor=&H80000012&"
      _StyleDefs(119) =   "Named:id=32:Selected"
      _StyleDefs(120) =   ":id=32,.parent=29,.bgcolor=&H8000000D&,.fgcolor=&H8000000E&"
      _StyleDefs(121) =   "Named:id=33:Caption"
      _StyleDefs(122) =   ":id=33,.parent=30,.alignment=2"
      _StyleDefs(123) =   "Named:id=34:HighlightRow"
      _StyleDefs(124) =   ":id=34,.parent=29,.bgcolor=&H80000008&,.fgcolor=&H80000005&"
      _StyleDefs(125) =   "Named:id=35:EvenRow"
      _StyleDefs(126) =   ":id=35,.parent=29,.bgcolor=&HFFFF00&"
      _StyleDefs(127) =   "Named:id=36:OddRow"
      _StyleDefs(128) =   ":id=36,.parent=29"
      _StyleDefs(129) =   "Named:id=89:RecordSelector"
      _StyleDefs(130) =   ":id=89,.parent=30"
      _StyleDefs(131) =   "Named:id=92:FilterBar"
      _StyleDefs(132) =   ":id=92,.parent=29"
   End
...
Private Const ColKAN_YMD% = 18          '完了日時 2011.03.30
...
Private Const Last_Update_Day$ = "[F103061] 2011.03.31 09:00「完了日時表示追加」"
