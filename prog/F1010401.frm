VERSION 5.00
Begin VB.Form F1010401 
   BackColor       =   &H00FFFFFF&
   Caption         =   "初期設定在庫登録（小野用）"
   ClientHeight    =   6312
   ClientLeft      =   1920
   ClientTop       =   2436
   ClientWidth     =   11220
...
Dim Cp_To As String
    ...
    If Data_Load = False Then       '便別取込みワークにﾃﾞｰﾀﾛｰﾄﾞ
        ...
        End If
                            '印刷フォント設定
        Printer.Font.NAME = F1010401.Font.NAME
        Printer.Font.Size = F1010401.Font.Size
...
Dim i As Integer
    ...
    F1010401.MousePointer = vbHourglass

    Call Ctrl_Lock(F1010401)
...
Dim i As Integer
    ...
    Call Ctrl_UnLock(F1010401)


    F1010401.MousePointer = vbDefault
