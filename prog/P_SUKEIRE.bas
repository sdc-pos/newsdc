...
Public Type P_SUKEIRE_REC_Tag
    ...
    BIKOU(0 To 39)          As Byte         '備考       2010.09.21
    
    
    FILLER(0 To 46)         As Byte         'Filler     2010.09.21
...
Type KEY3_P_SUKEIRE                         'ＫＥＹ３   2011.11.11
...
Public K3_P_SUKEIRE         As KEY3_P_SUKEIRE       '2011.11.11
...
Type P_SUKEIRE_FSpeck
    ...
    ks6                     As BtKeySpeck   ' ｷｰ ｽﾍﾟｯｸ構造体    2011.11.11
    ks7                     As BtKeySpeck   ' ｷｰ ｽﾍﾟｯｸ構造体    2011.11.11
...
Dim c               As String * 128
    ...
    P_SUKEIRE_Speck.fs.idexnumb = 4                     ' インデックス数    2011.11.11 3-->4
...
'2007.11.28    P_SUKEIRE_Speck.ks0.keyleng = 5                     ' キー長
    ...
    '--------------------------------------------------- キー３  ▽
    P_SUKEIRE_Speck.ks6.keypos = 184                    ' キーポジション
    P_SUKEIRE_Speck.ks6.keyleng = 8                     ' キー長
                                                        ' キーフラグ
    P_SUKEIRE_Speck.ks6.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_SUKEIRE_Speck.ks6.keytype = Chr(BtKtString)       ' キータイプ
    P_SUKEIRE_Speck.ks6.reserve = &H0                   ' 予約済み
    
    
    P_SUKEIRE_Speck.ks7.keypos = 11                     ' キーポジション
    P_SUKEIRE_Speck.ks7.keyleng = 8                     ' キー長
                                                        ' キーフラグ
    P_SUKEIRE_Speck.ks7.keyflag = BtKfExt + BtKfDup + BtKfChg
    P_SUKEIRE_Speck.ks7.keytype = Chr(BtKtString)       ' キータイプ
    P_SUKEIRE_Speck.ks7.reserve = &H0                   ' 予約済み
    '--------------------------------------------------- キー３ △
