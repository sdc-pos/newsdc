...
'Private Const LAST_UPDATE_DAY$ = "[PCB0020] 2015.01.20 09:00"
Private Const LAST_UPDATE_DAY$ = "[PCB0020] 2015.01.20 11:00"
...
Dim ZAIKO_QTY   As Long     '2014.07.03
...
'>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>  移動 2015.01.20
    ...
    If RTrim(StrConv(ITEMREC.JGYOBU, vbUnicode)) = RTrim(Text1(ptxHIN_GAI).Text) Then
