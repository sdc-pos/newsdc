...
Begin VB.Form PR000251 
   Caption         =   "仕入実績検索・仕入集計表発行(2009.08.26 16:00)"
   ClientHeight    =   10305
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   17130
...
Private Const Max_Col% = 9                  '最大列数           '2007.06.29
...
'----------------------------------------------------------------------------
    ...
    PR000251.MousePointer = vbHourglass

    Call Ctrl_Lock(PR000251)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(PR000251)


    PR000251.MousePointer = vbDefault
...
Dim rpt             As New PR00025F2
Dim f               As New PR000252
...
Dim sts As Integer
    ...
    End If
    Set PR000251 = Nothing
    Set PR000252 = Nothing
