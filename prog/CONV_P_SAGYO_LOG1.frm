VERSION 5.00
Begin VB.Form CONV_P_SAGYO_LOG1 
   BackColor       =   &H00C0C0C0&
   Caption         =   "データコンバート処理"
   ClientHeight    =   7230
   ClientLeft      =   2325
   ...
   End
End
Attribute VB_Name = "CONV_P_SAGYO_LOG1"
...
'---------------------------------------------  受入履歴データのコンバート
    ...
    Do
        ...
        sts = BTRV(com, P_SAGYO_LOG_POS, P_SAGYO_LOG_REC, Len(P_SAGYO_LOG_REC), K0_P_SAGYO_LOG, Len(K0_P_SAGYO_LOG), 0)
        Select Case sts
            Case BtNoErr
            
                If StrConv(P_SAGYO_LOG_REC.JITU_DT, vbUnicode) >= "20120927" Then
                    Exit Do
                End If
        ...
        Do
            sts = BTRV(BtOpDelete, P_SAGYO_LOG_POS, P_SAGYO_LOG_REC, Len(P_SAGYO_LOG_REC), K0_P_SAGYO_LOG, Len(K0_P_SAGYO_LOG), 0)
'                sts = BtNoErr
            Select Case sts
                Case BtNoErr
                    Exit Do
...
Dim ans As Integer
    ...
    Text1(0).Text = "20120927"
    Text1(1).Text = "99991231"
...
Dim sts As Integer
    ...
    sts = BTRV(BtOpReset, P_SAGYO_LOG_POS, P_SAGYO_LOG_REC, Len(P_SAGYO_LOG_REC), K0_P_SAGYO_LOG, Len(K0_P_SAGYO_LOG), 0)
    If sts Then
        Call File_Error(sts, BtOpReset, "")
    End If
    
    Set CONV_P_SAGYO_LOG1 = Nothing
