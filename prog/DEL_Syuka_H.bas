...
Type DEL_SYU_HREC_Tag
    ...
    CNT_BARA_SU(0 To 6)         As Byte     '検品実績　バラ     2012.06.27
    CNT_HAKO_SU(0 To 6)         As Byte     '検品実績　箱       2012.06.27
    
    GAISO_IRI_QTY(0 To 7)       As Byte     '外装入り数         2012.06.27
    
    
    Y_HIN_CHK_CNT(0 To 6)       As Byte     '品番読込み回数     2012.06.27
    J_HIN_CHK_CNT(0 To 6)       As Byte     '品番読込み済み回数 2012.06.27
    
    
    
    FILLER(0 To 179)            As Byte     'FILLER             2012.06.27 (179
