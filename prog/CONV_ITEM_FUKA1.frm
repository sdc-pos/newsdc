...
Begin VB.Form CONV_ITEM_FUKA1 
   ...
   End
End
Attribute VB_Name = "CONV_ITEM_FUKA1"
...
'---------------------------------------------  受入履歴データのコンバート
    ...
    Do
        ...
        Call UniCode_Conv(ITEMREC.CATE_AD_FUKA, StrConv(ITEMREC.PLUS_KOUSU, vbUnicode))
        Call UniCode_Conv(ITEMREC.CATE_ST_FUKA, StrConv(ITEMREC.PLUS_KOUSU, vbUnicode))
