...
Dim NG_QTY7 As Long                     '無効データ件数（炊飯機器）
                                    '画面初期表示（処理済「便」表示など）
...
Dim Cp_To As String
    ...
    If Data_Load = False Then       '便別取込みワークにﾃﾞｰﾀﾛｰﾄﾞ
        ...
        End If
                            '印刷フォント設定
        Printer.Font.NAME = F1010461.Font.NAME
        Printer.Font.Size = F1010461.Font.Size
...
Dim i As Integer
    ...
    F1010461.MousePointer = vbHourglass

    Call Ctrl_Lock(F1010461)
...
Dim i As Integer
    ...
    Call Ctrl_UnLock(F1010461)


    F1010461.MousePointer = vbDefault
