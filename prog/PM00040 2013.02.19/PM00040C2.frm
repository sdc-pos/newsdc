...
Begin VB.Form PM00040C2 
   ...
   Begin VB.ComboBox Combo1 
      Height          =   360
      Index           =   4
      ItemData        =   "PM00040C2.frx":0000
      Left            =   1800
      List            =   "PM00040C2.frx":0002
...
'----------------------------------------------------------------------------
    ...
    PM00040C2.MousePointer = vbHourglass

    Call Ctrl_Lock(PM00040C2)
...
'----------------------------------------------------------------------------
    ...
    Call Ctrl_UnLock(PM00040C2)


    PM00040C2.MousePointer = vbDefault
...
Dim k       As Integer
    ...
    Select Case Mode
        ...
        Case ptxHIN_GAI      '品番
            ...
            If Last_JGYOBU = StrConv(ITEM_CREC.JGYOBU, vbUnicode) And _
                Right(Combo1(pcmbNAIGAI), 1) = StrConv(ITEM_CREC.NAIGAI, vbUnicode) And _
                Trim(Text1(ptxHIN_GAI).Text) = Trim(StrConv(ITEM_CREC.HIN_GAI, vbUnicode)) Then
            Else
                Call UniCode_Conv(K0_ITEM_C.JGYOBU, Last_JGYOBU)
                Call UniCode_Conv(K0_ITEM_C.NAIGAI, Right(Combo1(pcmbNAIGAI), 1))
                Call UniCode_Conv(K0_ITEM_C.HIN_GAI, Text1(ptxHIN_GAI).Text)
                    ...
                    Case BtErrKeyNotFound
                        ...
                        For i = 0 To UBound(JGYOBU_T)
                            For j = 0 To Combo1(pcmbNAIGAI).ListCount - 1
                                Call UniCode_Conv(K0_ITEM_C.JGYOBU, JGYOBU_T(i).CODE)
                                Call UniCode_Conv(K0_ITEM_C.NAIGAI, Right(Combo1(pcmbNAIGAI).List(j), 1))
                                Call UniCode_Conv(K0_ITEM_C.HIN_GAI, Text1(ptxHIN_GAI).Text)
                                ...
                                Select Case sts
                                    Case BtNoErr
                                        ...
                                        For k = 0 To Combo1(pcmbNAIGAI).ListCount - 1
                                            ...
                                            If Right(Combo1(pcmbNAIGAI).List(k), 1) = StrConv(ITEM_CREC.NAIGAI, vbUnicode) Then
...
Dim L_CODE  As String
    ...
    '品目ﾏｽﾀ読み込み
    Call UniCode_Conv(K0_ITEM_C.JGYOBU, Right(Combo1(pcmbJGYOBU).Text, 1))
    Call UniCode_Conv(K0_ITEM_C.NAIGAI, Right(Combo1(pcmbNAIGAI).Text, 1))
    Call UniCode_Conv(K0_ITEM_C.HIN_GAI, Text1(ptxHIN_GAI).Text)
    ...
    Select Case sts
        Case BtNoErr
            'ﾚｺｰﾄﾞ内容の表示
                                            '品目ｺｰﾄﾞ
            Text1(ptxHIN_GAI).Text = Trim(StrConv(ITEM_CREC.HIN_GAI, vbUnicode))
                                            '品名
            Text1(ptxHIN_NAME).Text = Trim(StrConv(ITEM_CREC.HIN_NAME, vbUnicode))
                                            '品名E
            Text1(ptxL_HIN_NAME_E).Text = Trim(StrConv(ITEM_CREC.L_HIN_NAME_E, vbUnicode))
                                            '会社名
            If Trim(StrConv(ITEM_CREC.L_KAISHA_CODE, vbUnicode)) = "" Then
            ...
            Else
                ...
                For i = 0 To Combo1(pcmbL_KAISHA).ListCount - 1
                    ...
                    If StrConv(ITEM_CREC.L_KAISHA_CODE, vbUnicode) = L_CODE Then
            ...
            End If
                                            '事業部
            If Trim(StrConv(ITEM_CREC.L_JGYOBU_CODE, vbUnicode)) = "" Then
            ...
            Else
                For i = 0 To Combo1(pcmbL_JGYOBU).ListCount - 1
                    ...
                    If StrConv(ITEM_CREC.L_JGYOBU_CODE, vbUnicode) = L_CODE Then
            ...
            End If
                                            '備考
            Text1(ptxL_BIKOU).Text = Trim(StrConv(ITEM_CREC.L_BIKOU, vbUnicode))
                                            '備考3
            Text1(ptxL_BIKOU3).Text = Trim(StrConv(ITEM_CREC.L_BIKOU3, vbUnicode))
                                            '入り数
            If Not IsNumeric(Trim(StrConv(ITEM_CREC.L_IRI_QTY, vbUnicode))) Then
                Text1(ptxL_IRI_QTY).Text = ""
            Else
                Text1(ptxL_IRI_QTY).Text = CLng(StrConv(ITEM_CREC.L_IRI_QTY, vbUnicode))
            End If
                                            '棚番(1)
            Text1(ptxL_TANA1).Text = Trim(StrConv(ITEM_CREC.L_TANA1, vbUnicode))
                                            '棚番(2)
            Text1(ptxL_TANA2).Text = Trim(StrConv(ITEM_CREC.L_TANA2, vbUnicode))
                                            '紙
'            If StrConv(ITEM_CREC.L_PAPER, vbUnicode) = L_PAPER_OFF Then
...
'            End If
            ...
            If StrConv(ITEM_CREC.L_PAPER, vbUnicode) = L_PAPER_ON Then
                Check1(pchkL_PAPER).Value = vbChecked
            Else
                Check1(pchkL_PAPER).Value = vbUnchecked
            End If
                                            ...
                                            'プラ
'            If StrConv(ITEM_CREC.L_PLASTIC, vbUnicode) = L_PLASTIC_OFF Or StrConv(ITEM_CREC.L_PLASTIC, vbUnicode) <= " " Then
...
'            End If
            ...
            If StrConv(ITEM_CREC.L_PLASTIC, vbUnicode) = L_PLASTIC_ON Then
                Check1(pchkL_PLASTIC).Value = vbChecked
            Else
                Check1(pchkL_PLASTIC).Value = vbUnchecked
            End If
                                            ...
                                            '適用機種ラベル
'            If StrConv(ITEM_CREC.L_LABEL, vbUnicode) = L_LABEL_OFF Or StrConv(ITEM_CREC.L_LABEL, vbUnicode) <= " " Then
...
'            End If
            ...
            If StrConv(ITEM_CREC.L_LABEL, vbUnicode) = L_LABEL_ON Then
                Check1(pchkL_LABEL).Value = vbChecked
            Else
                Check1(pchkL_LABEL).Value = vbUnchecked
            ...
            End If
                                            ...
                                            '枚数ラベル
'            If StrConv(ITEM_CREC.L_MAISU, vbUnicode) = L_MAISU_OFF Or StrConv(ITEM_CREC.L_MAISU, vbUnicode) <= " " Then
'                Check1(pchkL_MAISU).Value = vbUnchecked
'            Else
'                Check1(pchkL_MAISU).Value = vbChecked
'            End If
                                            
            If StrConv(ITEM_CREC.L_MAISU, vbUnicode) = L_MAISU_ON Then
                Check1(pchkL_MAISU).Value = vbChecked
            Else
                Check1(pchkL_MAISU).Value = vbUnchecked
            End If
                                            ...
                                            '価格(1)
            If Not IsNumeric(Trim(StrConv(ITEM_CREC.L_URIKIN1, vbUnicode))) Then
                Text1(ptxL_URIKIN1).Text = ""
            Else
                Text1(ptxL_URIKIN1).Text = Format(CDbl(StrConv(ITEM_CREC.L_URIKIN1, vbUnicode)), "#0")
            End If
                                            '価格(2)
            If Not IsNumeric(Trim(StrConv(ITEM_CREC.L_URIKIN2, vbUnicode))) Then
                Text1(ptxL_URIKIN2).Text = ""
            Else
                Text1(ptxL_URIKIN2).Text = Format(CDbl(StrConv(ITEM_CREC.L_URIKIN2, vbUnicode)), "#0")
            End If
                                            '価格(3)
            If Not IsNumeric(Trim(StrConv(ITEM_CREC.L_URIKIN3, vbUnicode))) Then
                Text1(ptxL_URIKIN3).Text = ""
            Else
                Text1(ptxL_URIKIN3).Text = Format(CDbl(StrConv(ITEM_CREC.L_URIKIN3, vbUnicode)), "#0")
            End If
                                            
                                            
                                            
            '原産国     2008.06.12
            Text1(ptxGENSANKOKU).Text = Trim(StrConv(ITEM_CREC.GENSANKOKU, vbUnicode))
            ...
            End If
                                            ...
                                            '作業指示
            RichTextBox1(prchL_SAGYO_SHIJI).Text = IIf(Len(RTrim(StrConv(ITEM_CREC.L_SAGYO_SHIJI, vbUnicode))) = 450, "", Trim(StrConv(ITEM_CREC.L_SAGYO_SHIJI, vbUnicode)))
                                            '機種(1)
            Text1(ptxL_KISHU1).Text = Trim(StrConv(ITEM_CREC.L_KISHU1, vbUnicode))
                                            '機種(2)
'            Text1(ptxL_KISHU2).Text = Trim(StrConv(ITEM_CREC.L_KISHU2, vbUnicode))
            ' 2006.02.06 KUBOTA IIFでメモリ不足エラーを回避
            RichTextBox1(prchL_KISHU2).Text = IIf(Len(RTrim(StrConv(ITEM_CREC.L_KISHU2, vbUnicode))) = 52, "", RTrim(StrConv(ITEM_CREC.L_KISHU2, vbUnicode)))
                                            '機種(3)
'            RichTextBox1(prchL_KISHU3).Text = Trim(StrConv(ITEM_CREC.L_KISHU3, vbUnicode))
            RichTextBox1(prchL_KISHU3).Text = IIf(Len(RTrim(StrConv(ITEM_CREC.L_KISHU_BIKOU, vbUnicode))) = 450, "", Trim(StrConv(ITEM_CREC.L_KISHU_BIKOU, vbUnicode)))
                                            '適用機種備考
'            RichTextBox1(prchL_KISHU_BIKOU).Text = Trim(StrConv(ITEM_CREC.L_KISHU_BIKOU, vbUnicode))
            RichTextBox1(prchL_KISHU_BIKOU).Text = IIf(Len(RTrim(StrConv(ITEM_CREC.L_KISHU3, vbUnicode))) = 150, "", Trim(StrConv(ITEM_CREC.L_KISHU3, vbUnicode)))
            '印刷日付
            Text1(ptxL_PRI_DATE).Text = Format(Now, "YYYY/mm/DD")
        
        
        
            lblUpd_Tanto.Caption = StrConv(ITEM_CREC.UPD_TANTO, vbUnicode)
            lblUpd_DateTime.Caption = StrConv(ITEM_CREC.UPD_DATETIME, vbUnicode)
        
        
        Case BtErrKeyNotFound
        
            MsgBox "他端末で変更されています。前画面に戻ります。"
            PM00040C2.Visible = False
            INIT_FLG = False
...
Dim L_CODE  As String
    ...
    Do
        sts = BTRV(BtOpGetEqual + BtSNoWait, ITEM_C_POS, ITEM_CREC, Len(ITEM_CREC), K0_ITEM_C, Len(K0_ITEM_C), 0)
        Select Case sts
            Case BtNoErr
                com = BtOpUpdate
                Exit Do
    ...
    If com = BtOpInsert Then
        Call UniCode_Conv(ITEM_CREC.JGYOBU, Last_JGYOBU)                              '事業部
        Call UniCode_Conv(ITEM_CREC.NAIGAI, Right(Combo1(pcmbNAIGAI).Text, 1))        '国内外
        Call UniCode_Conv(ITEM_CREC.HIN_GAI, Text1(ptxHIN_GAI).Text)                  '品目ｺｰﾄﾞ
        
        Call UniCode_Conv(ITEM_CREC.ST_SET_DT, "")                                    '標準棚番設定日付
        Call UniCode_Conv(ITEM_CREC.ST_SOKO, "")                                      '標準入庫　倉庫
        Call UniCode_Conv(ITEM_CREC.ST_RETU, "")                                      '標準入庫　列
        Call UniCode_Conv(ITEM_CREC.ST_REN, "")                                       '標準入庫　連
        Call UniCode_Conv(ITEM_CREC.ST_DAN, "")                                       '標準入庫　段
        Call UniCode_Conv(ITEM_CREC.BEF_SOKO, "")                                     '前回入庫　倉庫
        Call UniCode_Conv(ITEM_CREC.BEF_RETU, "")                                     '前回入庫　列
        Call UniCode_Conv(ITEM_CREC.BEF_REN, "")                                      '前回入庫　連
        Call UniCode_Conv(ITEM_CREC.BEF_DAN, "")                                      '前回入庫　段
        Call UniCode_Conv(ITEM_CREC.LAST_NYU_DT, "")                                  '最終入庫日
        Call UniCode_Conv(ITEM_CREC.LAST_SYU_DT, "")                                  '最終出庫日
        Call UniCode_Conv(ITEM_CREC.HIN_NAI, "")                                      '品番（内）
        Call UniCode_Conv(ITEM_CREC.BIKOU_SOKO, "")                                   'ﾎｽﾄ倉庫
        Call UniCode_Conv(ITEM_CREC.BIKOU_TANA, "")                                   'ﾎｽﾄ棚番
        Call UniCode_Conv(ITEM_CREC.HOJYU_P, "00000000")                              '補充点
        Call UniCode_Conv(ITEM_CREC.AVE_SYUKA, "00000000")                            '月平均出荷数
        Call UniCode_Conv(ITEM_CREC.SAMPLE_QTY, "0")                                  'ｻﾝﾌﾟﾙ数
        Call UniCode_Conv(ITEM_CREC.SAMPLE_QTY, "0")                                  'ｻﾝﾌﾟﾙ数
        Call UniCode_Conv(ITEM_CREC.LAST_INP_DT, "")                                  '最終入荷日付
        Call UniCode_Conv(ITEM_CREC.LAST_CHK_DT, "")                                  '最終照合日付
        Call UniCode_Conv(ITEM_CREC.LAST_CHK_QTY, "00000000")                         '照合時在庫数
        Call UniCode_Conv(ITEM_CREC.BIKOU, "")                                        '印刷備考
        Call UniCode_Conv(ITEM_CREC.IRI_QTY, "")                                      '印刷入り数
        Call UniCode_Conv(ITEM_CREC.JAN_CODE, "")                                     'JANｺｰﾄﾞ
        Call UniCode_Conv(ITEM_CREC.HIN_CHANGE, "")                                   '品番読み替えｺｰﾄﾞ
        Call UniCode_Conv(ITEM_CREC.GOODS_KBN, "1")                                   '商品化有無
        Call UniCode_Conv(ITEM_CREC.PACKING_NO, "")                                   '個装箱№
        Call UniCode_Conv(ITEM_CREC.RANK, "")                                         '現在ﾗﾝｸ
        Call UniCode_Conv(ITEM_CREC.NEW_RANK, "")                                     '新ﾗﾝｸ
        Call UniCode_Conv(ITEM_CREC.GLICS1_TANA, "")                                  'ｸﾞﾘｯｸｽ棚番1
        Call UniCode_Conv(ITEM_CREC.GLICS2_TANA, "")                                  'ｸﾞﾘｯｸｽ棚番2
        Call UniCode_Conv(ITEM_CREC.GLICS3_TANA, "")                                  'ｸﾞﾘｯｸｽ棚番3
        ...
        Call UniCode_Conv(ITEM_CREC.G_ST_URITAN, "")                                  '           標準粗利売価単価　9(8)V99
        Call UniCode_Conv(ITEM_CREC.G_ST_URITAN_DT, "")                               '           標準粗利売価設定日
        Call UniCode_Conv(ITEM_CREC.G_ST_SHITAN, "")                                  '           標準粗利原価単価  9(8)V99
        Call UniCode_Conv(ITEM_CREC.G_ST_SHITAN_DT, "")                               '           標準粗利原価設定日
        
        For i = 0 To 2                                                              '仕入先情報
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).CODE, "")                     '           仕入先コード
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).TANKA, "")                    '           単価
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).TANKA_DT, "")                 '           単価設定日
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).LOT, "")                      '           単価設定日
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).LEAD_TIME, "")                '           リードタイム
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).LAST_ORDER_DT, "")            '           最終発注日
            Call UniCode_Conv(ITEM_CREC.G_SHIIRE_TBL(i).LAST_ORDER_QTY, "")           '           最終発注数
        
        Next i
    
        Call UniCode_Conv(ITEM_CREC.G_ZEN_ZAIKO_KIN, "")                              '           前月在庫金額
        Call UniCode_Conv(ITEM_CREC.G_SHIIRE_KBN, "")                                 '           資材区分
        Call UniCode_Conv(ITEM_CREC.G_LABEL_NON, P_G_LABEL_ON)                        '           ﾗﾍﾞﾙ貼り付け
        Call UniCode_Conv(ITEM_CREC.S_TANTO, "")                                      '収単／担当者
        
        Call UniCode_Conv(ITEM_CREC.FILLER, "")                                       'Filler
    
    End If
    
    Call UniCode_Conv(ITEM_CREC.HIN_NAME, Text1(ptxHIN_NAME).Text)                    '品名
        
    Call UniCode_Conv(ITEM_CREC.L_HIN_NAME_E, Text1(ptxL_HIN_NAME_E).Text)            '品名E
                                                                                        
                                                                                    '会社名
'    Call UniCode_Conv(ITEM_CREC.L_KAISHA_CODE, Left(Right(Combo1(pcmbL_KAISHA).Text, 4), 2))
                                                                                    '事業部名
'    Call UniCode_Conv(ITEM_CREC.L_JGYOBU_CODE, Left(Right(Combo1(pcmbL_JGYOBU).Text, 4), 2))
     ...
     End If
     Call UniCode_Conv(ITEM_CREC.L_KAISHA_CODE, L_CODE)
    
     L_CODE = Left(Right(Combo1(pcmbL_JGYOBU).Text, 4), 2)
     If Trim(L_CODE) = "" Then
         L_CODE = Right(Combo1(pcmbL_JGYOBU).Text, 2)
     End If
     Call UniCode_Conv(ITEM_CREC.L_JGYOBU_CODE, L_CODE)
    
    
    
    
    Call UniCode_Conv(ITEM_CREC.L_BIKOU, Text1(ptxL_BIKOU).Text)                      '備考
    Call UniCode_Conv(ITEM_CREC.L_BIKOU3, Text1(ptxL_BIKOU3).Text)                    '備考3
    
    If Trim(Text1(ptxL_IRI_QTY).Text) = "" Then                                     '入り数
        Call UniCode_Conv(ITEM_CREC.L_IRI_QTY, "")
    Else
        Call UniCode_Conv(ITEM_CREC.L_IRI_QTY, Format(CLng((Text1(ptxL_IRI_QTY).Text)), "00000000"))
    End If
    
    Call UniCode_Conv(ITEM_CREC.L_TANA1, Text1(ptxL_TANA1).Text)                      '棚番(1)
    Call UniCode_Conv(ITEM_CREC.L_TANA2, Text1(ptxL_TANA2).Text)                      '棚番(2)
    
    If Check1(pchkL_PAPER).Value = vbChecked Then                                   '紙
        Call UniCode_Conv(ITEM_CREC.L_PAPER, L_PAPER_ON)
    Else
        Call UniCode_Conv(ITEM_CREC.L_PAPER, L_PAPER_OFF)
    End If
    
    If Check1(pchkL_PLASTIC).Value = vbChecked Then                                 'プラスチック
        Call UniCode_Conv(ITEM_CREC.L_PLASTIC, L_PLASTIC_ON)
    Else
        Call UniCode_Conv(ITEM_CREC.L_PLASTIC, L_PLASTIC_OFF)
    End If
    
    If Check1(pchkL_LABEL).Value = vbChecked Then                                   '適用機種ラベル
        Call UniCode_Conv(ITEM_CREC.L_LABEL, L_LABEL_ON)
    Else
        Call UniCode_Conv(ITEM_CREC.L_LABEL, L_LABEL_OFF)
    End If
    
    If Check1(pchkL_MAISU).Value = vbChecked Then                                   '枚数ラベル
        Call UniCode_Conv(ITEM_CREC.L_MAISU, L_MAISU_ON)
    Else
        Call UniCode_Conv(ITEM_CREC.L_MAISU, L_MAISU_OFF)
    End If
    
    If Trim(Text1(ptxL_URIKIN1).Text) = "" Then                                     '価格(1)
        Call UniCode_Conv(ITEM_CREC.L_URIKIN1, "")
    Else
        Call UniCode_Conv(ITEM_CREC.L_URIKIN1, Format(CDbl((Text1(ptxL_URIKIN1).Text)), "0000000000"))
    End If
    
    If Trim(Text1(ptxL_URIKIN2).Text) = "" Then                                     '価格(2)
        Call UniCode_Conv(ITEM_CREC.L_URIKIN2, "")
    Else
        Call UniCode_Conv(ITEM_CREC.L_URIKIN2, Format(CDbl((Text1(ptxL_URIKIN2).Text)), "0000000000"))
    End If
    
    If Trim(Text1(ptxL_URIKIN3).Text) = "" Then                                     '価格(3)
        Call UniCode_Conv(ITEM_CREC.L_URIKIN3, "")
    Else
        Call UniCode_Conv(ITEM_CREC.L_URIKIN3, Format(CDbl((Text1(ptxL_URIKIN3).Text)), "0000000000"))
    End If
    
    '原産国 2008.06.12
    Call UniCode_Conv(ITEM_CREC.GENSANKOKU, Text1(ptxGENSANKOKU).Text)
        
    
    Call UniCode_Conv(ITEM_CREC.L_SAGYO_SHIJI, RichTextBox1(prchL_SAGYO_SHIJI).Text)         '作業指示
    Call UniCode_Conv(ITEM_CREC.L_KISHU1, Text1(ptxL_KISHU1).Text)                    '機種(1)
    Call UniCode_Conv(ITEM_CREC.xL_KISHU2, "")                                        '旧機種(2)
    Call UniCode_Conv(ITEM_CREC.L_KISHU2, RichTextBox1(prchL_KISHU2).Text)            '機種(2)
 '   Call UniCode_Conv(ITEM_CREC.L_KISHU3, RichTextBox1(prchL_KISHU3).Text)           '機種(3)
    Call UniCode_Conv(ITEM_CREC.L_KISHU3, RichTextBox1(prchL_KISHU_BIKOU).Text)       '機種(3)
'    Call UniCode_Conv(ITEM_CREC.L_KISHU_BIKOU, RichTextBox1(prchL_KISHU_BIKOU).Text)  '適用機種
    Call UniCode_Conv(ITEM_CREC.L_KISHU_BIKOU, RichTextBox1(prchL_KISHU3).Text)  '適用機種
    
    Call UniCode_Conv(ITEM_CREC.UPD_TANTO, "")                                        '更新担当者ｺｰﾄﾞ
                                                                                    '更新日時
    Call UniCode_Conv(ITEM_CREC.UPD_DATETIME, Format(Now, "YYYYMMDD") & Format(Now, "HHMMSS"))
    ...
    Do
        ...
        sts = BTRV(com, ITEM_C_POS, ITEM_CREC, Len(ITEM_CREC), K0_ITEM_C, Len(K0_ITEM_C), 0)
        Select Case sts
            Case BtNoErr
                Exit Do
            Case BtErrRECORD_INUSE, BtErrFILE_INUSE
                ...
                ans = MsgBox("他端末でデータ使用中です。<ITEM.DAT>", vbRetryCancel + vbQuestion, "確認入力")
                If ans = vbCancel Then
                    sts = BTRV(BtOpUnlock, ITEM_C_POS, ITEM_CREC, Len(ITEM_CREC), K0_ITEM_C, Len(K0_ITEM_C), 0)
                    Update_Proc = False
                    Exit Do
                End If
            Case Else
...
Dim ans     As Integer
    ...
    Do
        ...
        sts = BTRV(BtOpDelete, ITEM_C_POS, ITEM_CREC, Len(ITEM_CREC), K0_ITEM_C, Len(K0_ITEM_C), 0)
        Select Case sts
            Case BtNoErr
                Exit Do
            Case BtErrRECORD_INUSE, BtErrFILE_INUSE
...
'-----------------  ﾚｺｰﾄﾞの中身入れ替え
                ...
                Call UniCode_Conv(ITEM_CREC.L_TANA1, StrConv(ITEM_CREC.ST_SOKO, vbUnicode) & "-" & _
                                                    StrConv(ITEM_CREC.ST_RETU, vbUnicode) & "-" & _
                                                    StrConv(ITEM_CREC.ST_REN, vbUnicode) & "-" & _
                                                    StrConv(ITEM_CREC.ST_DAN, vbUnicode))
                ...
                If Check1(pchkGENSANKOKU).Value = vbChecked Then
                    ...
                    Else
                        ...
                        If Combo1(pcmbGENSAN).Enabled Then
                            Call UniCode_Conv(ITEM_CREC.GENSANKOKU, Trim(Left(Combo1(pcmbGENSAN).Text, 20)))
                        End If
                    End If
                Else
                    Call UniCode_Conv(ITEM_CREC.GENSANKOKU, "")
                End If
...
'                        MsgBox Err.Number
                    ...
                    '再梱包ﾏｰｸ追加  2007.11.08
                    Call UniCode_Conv(ITEM_CREC.L_MARK, Text1(ptxL_MARK).Text)
                        
                        
                    sts = BTRV(BtOpInsert, L_ITEM_POS, ITEM_CREC, Len(ITEM_CREC), K0_L_ITEM, Len(K0_L_ITEM), 0)
                    Select Case sts
                        Case BtNoErr
...
'    Unload SubMenu(i)
    ...
    PM00040C2.Caption = PM00040C2.Caption & " " & Last_Update_Day
                                '品目マスタＯＰＥＮ
...
Dim sts As Integer
    ...
    '<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                                            ...
                                            '品目マスタＣＬＯＳＥ
    sts = BTRV(BtOpClose, ITEM_C_POS, ITEM_CREC, Len(ITEM_CREC), K0_ITEM_C, Len(K0_ITEM_C), 0)
    If sts Then
        If sts <> BtErrNoOpen Then
...
Dim i   As Integer
    ...
    Call UniCode_Conv(ITEM_CREC.HIN_GAI, "")
...
Dim i       As Integer
    ...
    Call UniCode_Conv(K0_GENSAN.JGYOBU, StrConv(ITEM_CREC.JGYOBU, vbUnicode))
    Call UniCode_Conv(K0_GENSAN.NAIGAI, StrConv(ITEM_CREC.NAIGAI, vbUnicode))
    Call UniCode_Conv(K0_GENSAN.HIN_GAI, StrConv(ITEM_CREC.HIN_GAI, vbUnicode))
    ...
    Do
        ...
        Select Case sts
            Case BtNoErr
                If StrConv(ITEM_CREC.JGYOBU, vbUnicode) <> StrConv(GENSANREC.JGYOBU, vbUnicode) Or _
                    StrConv(ITEM_CREC.NAIGAI, vbUnicode) <> StrConv(GENSANREC.NAIGAI, vbUnicode) Or _
                    StrConv(ITEM_CREC.HIN_GAI, vbUnicode) <> StrConv(GENSANREC.HIN_GAI, vbUnicode) Then
                    Exit Do
                End If
            Case BtErrEOF
                Exit Do
