...
'********************************************************************
'ファイルＩＤ
Global Const HS_ZAI_ID4 = "HS_ZAI4"         '炊飯機器事業部
Global Const HS_ZAI_IDD = "HS_ZAID"         '電化調理機器事業部
'ファイル№
...
Function HS_ZAI_Open4(Mode As Integer, FPass As String) As Integer
'********************************************************************
'*                                                                  *
'*       炊飯機器事業部  在庫設定データ  ＯＰＥＮ                    　*
'*                                                                  *
...
Dim FullPath As String
    ...
    HS_ZAI_Open4 = False
                            'ホスト受信データフルパス取込み
    sts = GetIni("FILE", HS_ZAI_ID4, "SYS", c)
    If sts <> False Then
...
Const ErrDiskNotReady = 71, ErrDeviceUnavailable = 68, ErrNotFound = 53
    ...
    Exit Function
End Function
Function HS_ZAI_OpenD(Mode As Integer, FPass As String) As Integer
'********************************************************************
'*                                                                  *
'*       電化調理機器事業部  在庫設定データ  ＯＰＥＮ         　       *
'*                                                                  *
'*      引数　:OPENモード（0:参照　1:更新）                           *
'*                                                                  *
'*      戻り値:false 正常                                            *
...
Dim FullPath As String
    ...
    HS_ZAI_OpenD = False
                            'ホスト受信データフルパス取込み
    sts = GetIni("FILE", HS_ZAI_IDD, "SYS", c)
    If sts <> False Then
        Call Log_Out(LOG_F, "SYS.INI 読み込みエラー")
        HS_ZAI_OpenD = True
        Exit Function
...
Const ErrDiskNotReady = 71, ErrDeviceUnavailable = 68, ErrNotFound = 53
    ...
    Exit Function
End Function
Function HS_ZAI_Get() As Integer
'********************************************************************
'*                                                                  *
'*              在庫設定データ  ＧＥＴ　                            *
'*                                                                  *
