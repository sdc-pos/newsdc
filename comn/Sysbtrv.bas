...
'Declare Function BTRV Lib "w3btrv7.dll" Alias "BTRCALL" (ByVal OP, Pb As POSBLK, Db As Any, DL As Integer, ByRef Kb As Any, ByVal Kl, ByVal Kn) As Integer
...
Sub Bt_Error(sts As Integer, Opretion As Integer, file As String, Optional FileName As String = "")

    Dim mess As String

    Dim c   As String * 128                     '2016.06.23
    
    Dim ret As Integer                          '2017.12.08
    
    ret = GetIni("FILE", FileName, "SYS", c)    '2016.06.23 2017.12.09 sts --> ret
    If ret <> False Then                        '2016.06.23 2017.12.09 sts --> ret
        c = ""                                  '2016.06.23
    End If                                      '2016.06.23
    FileName = Trim(c) & Chr(13) & Chr(10)      '2016.06.23
    
    mess = GetMsg_Japanese(sts)
    
    mess = FileName & file & " ERROR Operation = " & Opretion & " " & "sts= " & sts & " : " & mess
...
Private Function GetMsg_Japanese(ByVal sts As Integer) As String
    ...
    Select Case sts
        ...
        Case Else
'            GetMsg_Japanese = "ファイル異常が発生しました！！"     '2015.04.20
            GetMsg_Japanese = "ファイル異常が発生しました！！"      '2015.04.20
    End Select
