...
Public Type KEY1_P_COMPO                    'ＫＥＹ１   '2014.06.23
    KO_HIN_GAI(0 To 19)        As Byte         '親品番
End Type
    
Public Type KEY2_P_COMPO                    'ＫＥＹ２   '2018.02.20
    SHIMUKE_CODE(0 To 1)    As Byte         '仕向け先
    KO_JGYOBU(0 To 0)       As Byte         '子　事業部
    KO_NAIGAI(0 To 0)       As Byte         '子　国内外
    KO_HIN_GAI(0 To 19)     As Byte         '子　品番
...
'    P_COMPO_Speck.fs.idexnumb = 1                      ' インデックス数    2014.06.24
'    P_COMPO_Speck.fs.idexnumb = 2                       ' インデックス数    2014.06.24
    P_COMPO_Speck.fs.idexnumb = 3                       ' インデックス数    2014.06.24
    ...
    '--------------------------------------------------- キー１ ▽  2014.06.23
    P_COMPO_Speck.ks6.keypos = 33                       ' キーポジション
    P_COMPO_Speck.ks6.keyleng = 20                      ' キー長
    P_COMPO_Speck.ks6.keyflag = BtKfExt + BtKfDup + BtKfChg ' キーフラグ
    P_COMPO_Speck.ks6.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks6.reserve = &H0                     ' 予約済み
    
    '--------------------------------------------------- キー０ △
    
    '--------------------------------------------------- キー２ ▽  2018.02.20
    P_COMPO_Speck.ks7.keypos = 1                        ' キーポジション
    P_COMPO_Speck.ks7.keyleng = 2                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks7.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_COMPO_Speck.ks7.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks7.reserve = &H0                     ' 予約済み
    
    P_COMPO_Speck.ks8.keypos = 31                       ' キーポジション
    P_COMPO_Speck.ks8.keyleng = 1                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks8.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_COMPO_Speck.ks8.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks8.reserve = &H0                     ' 予約済み
    
    P_COMPO_Speck.ks9.keypos = 32                       ' キーポジション
    P_COMPO_Speck.ks9.keyleng = 1                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks9.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_COMPO_Speck.ks9.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks9.reserve = &H0                     ' 予約済み
    
    P_COMPO_Speck.ks10.keypos = 33                       ' キーポジション
    P_COMPO_Speck.ks10.keyleng = 20                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks10.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_COMPO_Speck.ks10.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks10.reserve = &H0                     ' 予約済み
    
    P_COMPO_Speck.ks11.keypos = 25                       ' キーポジション
    P_COMPO_Speck.ks11.keyleng = 1                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks11.keyflag = BtKfExt + BtKfDup + BtKfChg + BtKfSeg
    P_COMPO_Speck.ks11.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks11.reserve = &H0                     ' 予約済み
    
    P_COMPO_Speck.ks12.keypos = 26                       ' キーポジション
    P_COMPO_Speck.ks12.keyleng = 3                       ' キー長
                                                        ' キーフラグ
    P_COMPO_Speck.ks12.keyflag = BtKfExt + BtKfDup + BtKfChg
    P_COMPO_Speck.ks12.keytype = Chr(BtKtString)         ' キータイプ
    P_COMPO_Speck.ks12.reserve = &H0                     ' 予約済み
