Attribute VB_Name = "DEL_SYU20060524"
Option Explicit
'********************************************************************
'*
'*              削除済み出荷予定データ  ファイル定義
...
'ページサイズ
Public Const DEL_SYU_PG_SIZ% = 2048
...
'---------------------------------------------------        キー０
    ...
    DEL_SYU_Speck.ks2.keypos = 45                           ' キーポジション
    ...
    DEL_SYU_Speck.ks3.keypos = 53                           ' キーポジション
    ...
    DEL_SYU_Speck.ks4.keypos = 25                           ' キーポジション
    ...
    DEL_SYU_Speck.ks5.keypos = 61                           ' キーポジション
...
'---------------------------------------------------        キー１
    ...
    DEL_SYU_Speck.ks6.keypos = 61                           ' キーポジション
...
'---------------------------------------------------        キー２
    ...
    DEL_SYU_Speck.ks8.keypos = 45                           ' キーポジション
    ...
    DEL_SYU_Speck.ks9.keypos = 53                           ' キーポジション
    ...
    DEL_SYU_Speck.ks11.keypos = 24                          ' キーポジション
    ...
    DEL_SYU_Speck.ks12.keypos = 25                          ' キーポジション
    ...
    DEL_SYU_Speck.ks13.keyleng = 8                          ' キー長
