...
Type KEY1_ITEM_A            'ＫＥＹ１
    LAST_SYU_DT(0 To 7) As Byte     '最終出庫日付
End Type

Type KEY2_ITEM_A            'ＫＥＹ２
    JGYOBU(0 To 0)      As Byte     '事業部区分
    NAIGAI(0 To 0)      As Byte     '国内外
    '2005.11.15 桁数変更 13---> 20
    HIN_NAI(0 To 19)    As Byte     '品番（内部）
...
Type KEY3_ITEM_A            'ＫＥＹ３
    JGYOBU(0 To 0)      As Byte     '事業部区分
    ST_SET_DT(0 To 7)   As Byte     '標準倉庫設定日付
End Type


Type KEY4_ITEM_A            'ＫＥＹ４ 2004.02
    JGYOBU(0 To 0)      As Byte     '事業部区分
    NAIGAI(0 To 0)      As Byte     '国内外
    '2005.11.15 桁数変更 13---> 20
...
Dim c           As String * 128
    ...
    ITEM_A_Speck.fs.recoleng = Len(ITEM_AREC)       ' レコード長
    ITEM_A_Speck.fs.PageSize = ITEM_A_PG_SIZ        ' ページサイズ
    ITEM_A_Speck.fs.idexnumb = 7                  ' インデックス数
    ITEM_A_Speck.fs.fileflag = 0                  ' ファイルフラグ
    ITEM_A_Speck.fs.reserve = &H0                 ' 予約済み
'-----------------------------------------------
                                                ' キー０
    ITEM_A_Speck.ks0.keypos = 1                   ' キーポジション
    ITEM_A_Speck.ks0.keyleng = 1                  ' キー長
    ITEM_A_Speck.ks0.keyflag = BtKfExt + BtKfSeg  ' キーフラグ
    ITEM_A_Speck.ks0.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks0.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks1.keypos = 2                   ' キーポジション
    ITEM_A_Speck.ks1.keyleng = 1                  ' キー長
    ITEM_A_Speck.ks1.keyflag = BtKfExt + BtKfSeg  ' キーフラグ
    ITEM_A_Speck.ks1.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks1.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks2.keypos = 3                   ' キーポジション
    ITEM_A_Speck.ks2.keyleng = 20                 ' キー長
    ITEM_A_Speck.ks2.keyflag = BtKfExt            ' キーフラグ
    ITEM_A_Speck.ks2.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks2.reserve = &H0                ' 予約済み
'-----------------------------------------------
                                                ' キー１
    ITEM_A_Speck.ks3.keypos = 95                  ' キーポジション
    ITEM_A_Speck.ks3.keyleng = 8                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks3.keyflag = BtKfExt + BtKfDup + BtKfChg
    ITEM_A_Speck.ks3.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks3.reserve = &H0                ' 予約済み
'-----------------------------------------------
                                                ' キー２
    ITEM_A_Speck.ks4.keypos = 1                   ' キーポジション
    ITEM_A_Speck.ks4.keyleng = 1                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks4.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks4.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks4.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks5.keypos = 2                   ' キーポジション
    ITEM_A_Speck.ks5.keyleng = 1                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks5.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks5.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks5.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks6.keypos = 103                 ' キーポジション
    ITEM_A_Speck.ks6.keyleng = 20                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks6.keyflag = BtKfExt + BtKfDup + BtKfChg
    ITEM_A_Speck.ks6.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks6.reserve = &H0                ' 予約済み
'-----------------------------------------------
                                                ' キー３
    ITEM_A_Speck.ks7.keypos = 1                   ' キーポジション
    ITEM_A_Speck.ks7.keyleng = 1                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks7.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks7.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks7.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks8.keypos = 63                  ' キーポジション
    ITEM_A_Speck.ks8.keyleng = 8                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks8.keyflag = BtKfExt + BtKfDup + BtKfChg
    ITEM_A_Speck.ks8.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks8.reserve = &H0                ' 予約済み
'-----------------------------------------------
                                                ' キー４
    ITEM_A_Speck.ks9.keypos = 1                   ' キーポジション
    ITEM_A_Speck.ks9.keyleng = 1                  ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks9.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks9.keytype = Chr(BtKtString)    ' キータイプ
    ITEM_A_Speck.ks9.reserve = &H0                ' 予約済み

    ITEM_A_Speck.ks10.keypos = 2                  ' キーポジション
    ITEM_A_Speck.ks10.keyleng = 1                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks10.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks10.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks10.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks11.keypos = 197                ' キーポジション
    ITEM_A_Speck.ks11.keyleng = 20                ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks11.keyflag = BtKfExt + BtKfDup + BtKfChg
    ITEM_A_Speck.ks11.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks11.reserve = &H0               ' 予約済み
'-----------------------------------------------
                                                ' キー５
    ITEM_A_Speck.ks12.keypos = 1                  ' キーポジション
    ITEM_A_Speck.ks12.keyleng = 1                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks12.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks12.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks12.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks13.keypos = 2                  ' キーポジション
    ITEM_A_Speck.ks13.keyleng = 1                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks13.keyflag = BtKfExt + BtKfSeg + BtKfDup + BtKfChg
    ITEM_A_Speck.ks13.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks13.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks14.keypos = 217                ' キーポジション
    ITEM_A_Speck.ks14.keyleng = 20                ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks14.keyflag = BtKfExt + BtKfDup + BtKfChg
    ITEM_A_Speck.ks14.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks14.reserve = &H0               ' 予約済み
'-----------------------------------------------
                                                ' キー６
    ITEM_A_Speck.ks15.keypos = 1                  ' キーポジション
    ITEM_A_Speck.ks15.keyleng = 1                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks15.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks15.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks15.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks16.keypos = 2                  ' キーポジション
    ITEM_A_Speck.ks16.keyleng = 1                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks16.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks16.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks16.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks17.keypos = 71                  ' キーポジション
    ITEM_A_Speck.ks17.keyleng = 2                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks17.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks17.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks17.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks18.keypos = 73                 ' キーポジション
    ITEM_A_Speck.ks18.keyleng = 2                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks18.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks18.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks18.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks19.keypos = 75                 ' キーポジション
    ITEM_A_Speck.ks19.keyleng = 2                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks19.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks19.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks19.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks20.keypos = 77                 ' キーポジション
    ITEM_A_Speck.ks20.keyleng = 2                 ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks20.keyflag = BtKfExt + BtKfSeg + BtKfChg
    ITEM_A_Speck.ks20.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks20.reserve = &H0               ' 予約済み

    ITEM_A_Speck.ks21.keypos = 3                  ' キーポジション
    ITEM_A_Speck.ks21.keyleng = 20                ' キー長
                                                ' キーフラグ
    ITEM_A_Speck.ks21.keyflag = BtKfExt + BtKfChg
    ITEM_A_Speck.ks21.keytype = Chr(BtKtString)   ' キータイプ
    ITEM_A_Speck.ks21.reserve = &H0               ' 予約済み
'-----------------------------------------------
...
Dim i       As Long
    ...
    Call UniCode_Conv(ITEM_AREC.JGYOBU, "")           '事業部区分
    Call UniCode_Conv(ITEM_AREC.NAIGAI, "")           '国内外
    Call UniCode_Conv(ITEM_AREC.HIN_GAI, "")          '品番（外部）
    Call UniCode_Conv(ITEM_AREC.HIN_NAME, "")         '品名
    Call UniCode_Conv(ITEM_AREC.ST_SET_DT, "")        '標準倉庫設定日付
    Call UniCode_Conv(ITEM_AREC.ST_SOKO, "")          '標準入庫倉庫 倉庫
    Call UniCode_Conv(ITEM_AREC.ST_RETU, "")          '             列
    Call UniCode_Conv(ITEM_AREC.ST_REN, "")           '             連
    Call UniCode_Conv(ITEM_AREC.ST_DAN, "")           '             段
    Call UniCode_Conv(ITEM_AREC.BEF_SOKO, "")         '前回入庫倉庫 倉庫
    
    Call UniCode_Conv(ITEM_AREC.BEF_RETU, "")         '             列
    Call UniCode_Conv(ITEM_AREC.BEF_REN, "")          '             連
    Call UniCode_Conv(ITEM_AREC.BEF_DAN, "")          '             段
    Call UniCode_Conv(ITEM_AREC.LAST_NYU_DT, "")      '最終入庫日付
    Call UniCode_Conv(ITEM_AREC.LAST_SYU_DT, "")      '最終出庫日付
    Call UniCode_Conv(ITEM_AREC.HIN_NAI, "")          '品番（内部）
    Call UniCode_Conv(ITEM_AREC.BIKOU_SOKO, "")       '備考 ホスト倉庫
    Call UniCode_Conv(ITEM_AREC.BIKOU_TANA, "")       '備考 ホスト棚番
    Call UniCode_Conv(ITEM_AREC.LAST_INP_DT, "")      '最終入荷日付
    Call UniCode_Conv(ITEM_AREC.LAST_CHK_DT, "")      '最終照合日付       2001.06.12
    
    Call UniCode_Conv(ITEM_AREC.BIKOU, "")            '印刷備考
    Call UniCode_Conv(ITEM_AREC.JAN_CODE, "")         'Janコード      2004.02
    Call UniCode_Conv(ITEM_AREC.HIN_CHANGE, "")       '品番読み替え   2004.02
    Call UniCode_Conv(ITEM_AREC.GOODS_KBN, GOODS_ON)  '商品化有無     2004.02
    Call UniCode_Conv(ITEM_AREC.PACKING_NO, "")       '個装箱№       2004.02
    Call UniCode_Conv(ITEM_AREC.RANK, "")             '現在ランク     2004.06
    Call UniCode_Conv(ITEM_AREC.NEW_RANK, "")         '現在ランク     2004.06
    Call UniCode_Conv(ITEM_AREC.GLICS1_TANA, "")      'グリックス棚番１   2005.05
    Call UniCode_Conv(ITEM_AREC.GLICS2_TANA, "")      'グリックス棚番２   2005.05
    Call UniCode_Conv(ITEM_AREC.GLICS3_TANA, "")      'グリックス棚番３   2005.05
    
    Call UniCode_Conv(ITEM_AREC.G_SHIIRE_KBN, "")     '業務管理　 仕入区分
    Call UniCode_Conv(ITEM_AREC.G_HANBAI_KBN, "")     '           販売区分
    Call UniCode_Conv(ITEM_AREC.G_SYUSHI, "")         '           収支単位
    Call UniCode_Conv(ITEM_AREC.G_KUMITATE, "")       '           組立製品
    Call UniCode_Conv(ITEM_AREC.G_ST_URITAN_DT, "")   '           標準粗利売価設定日
    Call UniCode_Conv(ITEM_AREC.G_ST_SHITAN_DT, "")   '           標準粗利原価設定日
                                                    '           仕入先情報
    For i = 0 To UBound(ITEM_AREC.G_SHIIRE_TBL)
        Call UniCode_Conv(ITEM_AREC.G_SHIIRE_TBL(i).CODE, "")             'ｺｰﾄﾞ
        Call UniCode_Conv(ITEM_AREC.G_SHIIRE_TBL(i).TANKA_DT, "")         '単価設定日
        Call UniCode_Conv(ITEM_AREC.G_SHIIRE_TBL(i).LEAD_TIME, "")        'ﾘｰﾄﾞﾀｲﾑ
        Call UniCode_Conv(ITEM_AREC.G_SHIIRE_TBL(i).LAST_ORDER_DT, "")    '前回注文日
    Next i
    
    Call UniCode_Conv(ITEM_AREC.G_SHIZAI_KBN, "")     '           資材区分
    Call UniCode_Conv(ITEM_AREC.G_LABEL_NON, "")      '           ﾗﾍﾞﾙ貼り付け計上なし
    
    Call UniCode_Conv(ITEM_AREC.L_HIN_NAME_E, "")     '商品ﾗﾍﾞﾙ   品名
    Call UniCode_Conv(ITEM_AREC.L_BIKOU, "")          '           備考
    Call UniCode_Conv(ITEM_AREC.L_KAISHA_CODE, "")    '           会社コード
    Call UniCode_Conv(ITEM_AREC.L_KISHU1, "")         '           機種(1)
    Call UniCode_Conv(ITEM_AREC.xL_KISHU2, "")        '           機種(2) 未使用 2006.01.24
    Call UniCode_Conv(ITEM_AREC.L_KISHU3, "")         '           機種(3)(→適用機種備考)
    Call UniCode_Conv(ITEM_AREC.L_PAPER, "0")         '           紙
    Call UniCode_Conv(ITEM_AREC.L_PLASTIC, "0")       '           プラスチック
    Call UniCode_Conv(ITEM_AREC.L_LABEL, "0")         '           適用機種ﾗﾍﾞﾙ
    Call UniCode_Conv(ITEM_AREC.L_MAISU, "0")         '           枚数ﾗﾍﾞﾙ
    Call UniCode_Conv(ITEM_AREC.L_KISHU_BIKOU, "")    '           適用機種備考(→機種（３）)
    Call UniCode_Conv(ITEM_AREC.L_SAGYO_SHIJI, "")    '           作業指示
    Call UniCode_Conv(ITEM_AREC.L_BIKOU3, "")         '           備考３
    Call UniCode_Conv(ITEM_AREC.L_JGYOBU_CODE, "")    '           事業部コード
    Call UniCode_Conv(ITEM_AREC.L_TANA1, "")          '           棚番(1)
    Call UniCode_Conv(ITEM_AREC.L_TANA2, "")          '           棚番(2)
    
    Call UniCode_Conv(ITEM_AREC.S_TANTO, "")          '収単／担当者コード
    Call UniCode_Conv(ITEM_AREC.ZAIKO_F, "")          '在庫管理対象有無 1:対象 0:対象外
    Call UniCode_Conv(ITEM_AREC.L_KISHU2, "")         '           機種(2)
    Call UniCode_Conv(ITEM_AREC.K_KEITAI, "")         '個装形態
    Call UniCode_Conv(ITEM_AREC.UNIT_BUHIN, "")       'ﾕﾆｯﾄ部品区分       2006.07.28
    Call UniCode_Conv(ITEM_AREC.NAI_BUHIN, "")        '国内供給部品区分   2006.07.28
    Call UniCode_Conv(ITEM_AREC.GAI_BUHIN, "")        '海外供給部品区分   2006.07.28
    Call UniCode_Conv(ITEM_AREC.LAST_CODE, "")        '最終仕入先コード   2007.05.29
    Call UniCode_Conv(ITEM_AREC.MAKER_CODE, "")       'ﾒｰｶｰｺｰﾄﾞ           2007.06.06
    Call UniCode_Conv(ITEM_AREC.MAKER_NAME, "")       'ﾒｰｶｰ名称           2007.06.06
    
    Call UniCode_Conv(ITEM_AREC.L_MARK, "")           '再梱包ﾏｰｸ          2007.11.08
    Call UniCode_Conv(ITEM_AREC.SAI_SU, "")           '才数               2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_KEISHIKI, "")       '形式               2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_MATERIAL, "")       '材質               2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_THICKNESS, "")      'ﾀﾞﾝﾎﾞｰﾙ　厚さ      2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_SIZE_W, "")         'ﾀﾞﾝﾎﾞｰﾙｻｲｽﾞ（W）   2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_SIZE_D, "")         'ﾀﾞﾝﾎﾞｰﾙｻｲｽﾞ（D）   2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_SIZE_H, "")         'ﾀﾞﾝﾎﾞｰﾙｻｲｽﾞ（H）   2008.02.14
    Call UniCode_Conv(ITEM_AREC.D_PRINT, "")          '印刷する／しない    2008.02.14
    Call UniCode_Conv(ITEM_AREC.S_KOUSU_SET_DATE, "") '商品化　単価設定日 2008.02.14
    
    Call UniCode_Conv(ITEM_AREC.S_SHIZAI_SET_DATE, "") '商品化　単価設定日 2008.02.14
    Call UniCode_Conv(ITEM_AREC.SE_USOU_F, "")        '輸送箱　出力ﾌﾗｸﾞ   2008.02.14
    Call UniCode_Conv(ITEM_AREC.USE_TAPE_KIND, "")    '使用テープ種類     2008.02.14
    Call UniCode_Conv(ITEM_AREC.USE_TAPE_LNG, "")     '使用テープ長       2008.02.14
    Call UniCode_Conv(ITEM_AREC.H_TANA_MAKE, "")      '棚番マーク         2008.04.02
    Call UniCode_Conv(ITEM_AREC.SE_TANKA_MEMO, "")    '請求単価　メモ     2008.04.15
    Call UniCode_Conv(ITEM_AREC.GENSANKOKU, "")       '原産国             2008.06.11
    Call UniCode_Conv(ITEM_AREC.SEI_LOT, "")          '生産ロット         2008.07.07
    Call UniCode_Conv(ITEM_AREC.SEI_SYU_KON, "")      '集合梱包           2008.07.07
    Call UniCode_Conv(ITEM_AREC.SEI_TANKA_TANTO, "")  '単価設定担当者     2008.07.09
    Call UniCode_Conv(ITEM_AREC.SHIMUKE_CODE, "")     '仕向け先           2008.07.09
    Call UniCode_Conv(ITEM_AREC.SEI_KBN, "")          '請求区分           2008.07.16
                                            '前工程             2008.09.19
    For i = 0 To UBound(ITEM_AREC.BEF_KOUTEI)
        Call UniCode_Conv(ITEM_AREC.BEF_KOUTEI(i).BEF_KOUTEI, "")     '前工程 2008.09.19
    Next i
                                            '作業工程           2008.09.19
    For i = 0 To UBound(ITEM_AREC.MAIN_KOUTEI)
        Call UniCode_Conv(ITEM_AREC.MAIN_KOUTEI(i).MAIN_KOUTEI, "")   '作業工程 2008.09.19
    Next i
                                            '後工程             2008.09.19
    For i = 0 To UBound(ITEM_AREC.AFT_KOUTEI)
        Call UniCode_Conv(ITEM_AREC.AFT_KOUTEI(i).AFT_KOUTEI, "")     '後工程 2008.09.19
    Next i

    Call UniCode_Conv(ITEM_AREC.SE_IO_TANKA_No, "")   '棚区分             200.09.19
    Call UniCode_Conv(ITEM_AREC.STAT, "")             '状態区分           2009.01.21
    Call UniCode_Conv(ITEM_AREC.INSP_MESSAGE, "")     '出荷検品ﾒｯｾｰｼﾞ     2009.04.17
    Call UniCode_Conv(ITEM_AREC.S_SEIKYU_F, "")       '商品化請求ﾌﾗｸﾞ     2009.04.28
    Call UniCode_Conv(ITEM_AREC.FILLER, "")           'FILLER             2009.04.28サイズ変更
    
    Call UniCode_Conv(ITEM_AREC.INS_TANTO, "")        '追加　担当者　     2009.01.21
    Call UniCode_Conv(ITEM_AREC.Ins_DateTime, "")     '追加　日時         2009.01.21
    Call UniCode_Conv(ITEM_AREC.UPD_TANTO, "")        '更新　担当者　     2005.11.15
    Call UniCode_Conv(ITEM_AREC.UPD_DATETIME, "")     '更新　日時         2005.11.15
...
'               2009.06.02
    ...
    Call UniCode_Conv(ITEM_AREC.M_BIKOU, "")              '見積書備考
    
    Call UniCode_Conv(ITEM_AREC.SHIYOU_NO, "")            '仕様書№
    
    Call UniCode_Conv(ITEM_AREC.MITSUMORI_KBN, "")        '見積り区分
    
    Call UniCode_Conv(ITEM_AREC.TANKA_KIRIKAE_DT, "")    '単価切替日付
    
    Call UniCode_Conv(ITEM_AREC.KIRIKAE_KBN, "")          '切替区分
