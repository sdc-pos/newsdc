...
'********************************************************************
'ファイルＩＤ
Global Const HS_ZAI_ID7 = "HS_ZAI7"         '掃除機事業部
'ファイル№
...
Function HS_ZAI_Open7(Mode As Integer, FPass As String) As Integer
'********************************************************************
'*
'*       掃除機事業部  在庫設定データ  ＯＰＥＮ
'*
...
Dim FullPath As String
    ...
    HS_ZAI_Open7 = False
                            'ホスト受信データフルパス取込み
    sts = GetIni("FILE", HS_ZAI_ID7, "SYS", c)
    If sts <> False Then
...
Const ErrDiskNotReady = 71, ErrDeviceUnavailable = 68, ErrNotFound = 53
    ...
    Exit Function
End Function
Function HS_ZAI_Get7() As Integer
'********************************************************************
'*
'*              在庫設定データ  ＧＥＴ
'*
