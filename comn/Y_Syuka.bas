...
'---------------------------------------------------' キー０
    ...
    Y_SYU_Speck.ks0.keyleng = 1                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks0.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks1.keyflag = BtKfExt + BtKfChg + BtKfDup    ' キーフラグ
...
'---------------------------------------------------' キー１
    ...
    Y_SYU_Speck.ks2.keyleng = 1                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks2.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks3.keyleng = 1                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks3.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks4.keyleng = 8                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks4.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks5.keyleng = 8                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks5.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks6.keyleng = 1                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks6.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks7.keyleng = 12                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks7.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks8.keyleng = 1                     ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks8.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks9.keyleng = 20                   ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks9.keyflag = BtKfExt + BtKfChg + BtKfDup
...
'---------------------------------------------------' キー３
    ...
    Y_SYU_Speck.ks14.keyleng = 1                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks14.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks15.keyleng = 1                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks15.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks16.keyleng = 8                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks16.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks17.keyleng = 8                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks17.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks18.keyleng = 1                    ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks18.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks19.keyleng = 20                   ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks19.keyflag = BtKfExt + BtKfChg + BtKfSeg + BtKfDup
    ...
    Y_SYU_Speck.ks20.keyleng = 12                   ' キー長
                                                    ' キーフラグ
    Y_SYU_Speck.ks20.keyflag = BtKfExt + BtKfChg + BtKfDup
